<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ServiceFileCheck.aspx.cs" Inherits="ServiceFileCheck" %>
                  ...
                  <div class="wizard">
                        <div class="wizard-inner margin-top15">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="backactive"><a href="javasxript:void(0)" data-toggle="tab" aria-controls="Profile Creation"
                ...
                <div class="form-sec">
                    ...
                    <div class="form-body ">
                        <div class="">
                            ...
                            <div class="form-group " runat="server" id="diveSine">
                                <div class="row">
                                  
                                        <div class="col-sm-3">
                                          <asp:Button ID="btneSign"  CssClass="btn btn-success filebtn"  Text="Make eSign" 
                                                runat="server" OnClientClick="return valid();" onclick="btneSign_Click"  />
                                        </div>
                                    <div class="col-sm-2">
                                ...
                                <table style="width:100%"><tr><td align="center"> <asp:Button ID="btnApply" runat="server" Text="Pay Now" CssClass="btn btn-success" 
                                                Width="80" onclick="btnApply_Click"  />&nbsp;<asp:Button 
                                        ID="hrfPaymentConfrim" runat="server"
                                                    Text="Confrim Payment"  CssClass="btn btn-success"  onclick="Button1_Click" />
                                                </td><td style="padding:10px">
                                                   &nbsp;</td></tr><tr><td colspan="2" style="font-weight: bold; color: #FF0000"> 
                                        N.B-<br />
                                        1. Your payment is being submitted. Please do not close this window or click the 
                                        Back button on your browser. 
                                        <br />
                                        2. Payment details are updated on the portal in 3 working days. If payment is 
                                        not reflected against your application after 3 working days, kindly contact 
                                        support@investodiaha.gov.in</td></tr></table></div>
                                </div>--%>
                            </div>
