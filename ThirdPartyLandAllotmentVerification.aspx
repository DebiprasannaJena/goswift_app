<%--'*******************************************************************************************************************
' File Name         : ThirdPartyLandAllotmentVerification.aspx
...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ThirdPartyLandAllotmentVerification.aspx.cs"
    Inherits="ThirdPartyLandAllotmentVerification" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript'>
        ...
        function ValidateApp() {
            ...
            if (blankFieldValidation('txtProposalNo', 'Proposal (PEAL) no', projname) == false) {
                return false;
            }
            ...
            <div class="col-sm-12">
                <div class="aboutcontent-sec">
                    ...
                    <h2 class=" margin-bottom15">
                        Third Party Land Allotment Verification
                    </h2>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtProposalNo" runat="server" autocomplete="off"
                                            ToolTip="Enter proposal (PEAL) number here !" MaxLength="15"></asp:TextBox>
                                        <span class="mandetory">*</span>
                                        <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" Enabled="True"
                                            TargetControlID="txtProposalNo" FilterMode="ValidChars" FilterType="Custom,LowercaseLetters,UppercaseLetters,Numbers"
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="grdPEAL" class="table table-bordered table-hover" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="vchProposalNo" HeaderText="Proposal (PEAL) No" />
                                <asp:BoundField DataField="vchCompName" HeaderText="Industry Name" />
                                <asp:TemplateField HeaderText="Created On">
                                    <ItemTemplate>
                                        <asp:Label ID="Lbl_Created_On" runat="server" Text='<%# Eval("dtm_Payment_date" ,"{0:dd-MMM-yyyy HH:mm tt}") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="vchStatusName" HeaderText="GOSWIFT Status" />
                                <asp:BoundField DataField="vchCAFNo" HeaderText="CAF No" />
                                <asp:BoundField DataField="PIDCOStatus" HeaderText="Idco Status" />
                            </Columns>
                        </asp:GridView>
                    </div>
                </div>
