...
public partial class CSRInvestorGrid : SessionCheck
{
        ...
        try
        {
            ...
            using (HttpWebResponse httpResponse = (HttpWebResponse)httpRequest.GetResponse())
            {
                using (Stream stream = httpResponse.GetResponseStream())
                {
                    ...
                    string query = "DELETE FROM T_CSR_CategoryWiseAmountDtls";
                    cmd = new SqlCommand(query, con);
                    cmd.ExecuteNonQuery();

                    DataTable DynamicForm = new DataTable();
                    DynamicForm.TableName = "MyCSRInvTable";
                    ...
                    cmd.Parameters.AddWithValue("@P_ACTION", "CSGINV");
                    cmd.ExecuteNonQuery();
                    con.Close();
                }
            }
