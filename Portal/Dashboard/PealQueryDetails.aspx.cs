...
public partial class Portal_Dashboard_PealQueryDetails : SessionCheck
{
    int intRecCount = 0;
    ...
    private void BindQueryPeal()
    {
        ...
        try
        {
            ...
            if (objServiceStatus.Rows.Count > 0)
            {
                ...
                if (PealQueryStatus == 3 || PealQueryStatus == 4)
                {
