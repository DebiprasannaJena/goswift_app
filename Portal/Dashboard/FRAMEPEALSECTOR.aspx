<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FRAMEPEALSECTOR.aspx.cs" Inherits="Portal_Dashboard_FRAMEPEALSECTOR" EnableEventValidation="false" %>
            ...
            <div class="table-responsive">
                <asp:GridView ID="gvPeal" runat="server" CssClass="table table-bordered" AllowPaging="true"
                    ...
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />--%>
                        ...
                        <asp:TemplateField HeaderText="Days since the PEAL form was received" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
