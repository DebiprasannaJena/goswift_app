<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnergyApprovalTimelineDashboard.aspx.cs"
    Inherits="Portal_Dashboard_EnergyApprovalTimelineDashboard" EnableEventValidation="false" %>
...
<body>
    ...
    <div class="form-sec">
        ...
        <%-- <div class="form-group" >
                    <div class="row" id="dvDayDiff" runat="server">
        ...
        <div class="table-responsive" id="viewTable1" runat="server">
            <asp:GridView ID="gvService" CssClass="table table-bordered" runat="server" AutoGenerateColumns="false"
                Width="100%" EmptyDataText="No Record(s) Found..." AllowPaging="true" PageSize="10"
