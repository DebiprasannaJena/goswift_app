<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnergyApprovalTimeline.aspx.cs"
    Inherits="Portal_Dashboard_EnergyApprovalTimeline" EnableEventValidation="false" %>
    ...
    <div class="form-sec">
        ...
        <div class="table-responsive" id="viewTable1" runat="server">
            <asp:GridView ID="gvService" CssClass="table table-bordered" runat="server" AutoGenerateColumns="false"
                AllowPaging="true" Width="100%" EmptyDataText="No Record(s) Found..." PageSize="10"
