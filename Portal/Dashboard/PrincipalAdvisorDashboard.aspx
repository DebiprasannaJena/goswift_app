<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master" AutoEventWireup="true" CodeFile="PrincipalAdvisorDashboard.aspx.cs" Inherits="Portal_Dashboard_PrincipalAdvisorDashboard" %>
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td>Application pending since last 30 days
                                                            </td>
                                                            <td align="right">
                                        ...
                                        <div class="investordashboard-sec incentive-sec ">
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                <ul>
                                                    ...
                                                    <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('PK');" title="Query In Progress">Query In Progress<span id="hdnqueryRaised" runat="server"><asp:Literal ID="Literal1" runat="server"></asp:Literal></span></a></li>
                                                    ...
                                                    <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('RJ');" title="Total Rejected ">Total Rejected <span id="hdReject" runat="server">
