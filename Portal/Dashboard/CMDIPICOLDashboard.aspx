<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="CMDIPICOLDashboard.aspx.cs" Inherits="Portal_Dashboard_CMDIPICOLDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        <h1>CMD (IPICOL) Dashboard</h1>
                        <ul class="breadcrumb">
                            <li><a href="javscript:void(0)"><i class="fa fa-home"></i></a></li>
                            <li><a>CMD (IPICOL) Dashboard</a></li>
                        </ul>
                    </div>
                </section>
                <!-- Main content -->
    ...
    <script>
        ...
        //        if($('#ContentPlaceHolder1_ddlspmgyear').val() =="2017-18")
        //        {
        //            var Year = "2017";
        //            }
        //            else {
