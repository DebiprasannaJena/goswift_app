...
public partial class Portal_Dashboard_SPMGGridStatus :SessionCheck
{
    ...
    private void InsertSPMGGRIDStatus()
    {
        try
        {
           //Random number generate
            ...
            string serviceUrl = "https://164.100.58.41//odisha/restservices/RestServer.php?view=issuedetails";
                            ...
                            using (SqlConnection con = new SqlConnection(connectionString))
                            {
                                try
                                {
                                    using (SqlCommand cmd = new SqlCommand("USP_GRID_XML"))
                                    {
                                        ...
                                        cmd.Parameters.Add("@P_ACTION", SqlDbType.VarChar).Value = "SPMGSTATUS";
                                        cmd.Connection = con;
                                        con.Open();
    ...
    private void SPMGGridSatus()
    {
        ...
        try
        {
            if (Request.QueryString["Level"].ToString() == "1")
            {
                objSWP.strAction = "SPD";
            }
            else if (Request.QueryString["Level"].ToString() == "2")
            {
                objSWP.strAction = "SPDDIC";
            }
    ...
    protected void lnkExport_Click(object sender, EventArgs e)
    {
        SPMGGridSatus11();
        tbldv.Visible = true;
        lblCaption.Text = "State Project Monitoring Group Details in  " + Request.QueryString["Year"];
