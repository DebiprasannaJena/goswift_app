...
public partial class Portal_Dashboard_EnergyDepartmentDashboard : SessionCheck
{
    ...
    private void ViewServiceStatus()
    {
        ...
        {           
            ...
            objDashboard.strAction = "EUCD";
            objDashboard.intDeptId = Convert.ToInt32(Session["DeptId"].ToString());
            //if (objDashboard.intServiceId == 17)
            //{
            ...
            //    objDashboard.intDeptId = Convert.ToInt32(Session["DeptId"].ToString());
            //}
            hdnsrvc1.Value = objDashboard.intDeptId.ToString();
    ...
    private void InsertViewStatelevelSPMGData(string recived, string resolved, string pending, string pendinglast,string strdeptid)
    {
