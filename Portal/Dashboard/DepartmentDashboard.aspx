<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="DepartmentDashboard.aspx.cs" Inherits="Portal_Dashboard_DepartmentDashboard" %>
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li><a>Department DashBoard</a></li>
                        </ul>
                    </div>
                </section>
                <!-- Main content -->
                 ...
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="Button7" CssClass="btn btn-success" runat="server" Text="Submit"></asp:Button>
                                    ...
                                    <div class="col-sm-6  col-md-4" id="dvapaa" runat="server" style="display: none">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>IDCO POST ALLOTMENT APPLICATIONS<a class="pull-right spmgfilter" data-toggle="tooltip"
                ...
                <asp:ListItem>--Select--</asp:ListItem> 
                 ...
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="Button2" CssClass="btn btn-success" runat="server" Text="Submit"></asp:Button>
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Department Wise Approvals<a class="pull-right spmgfilter" data-toggle="tooltip"
                ...
                <asp:ListItem Value="0">--Select--</asp:ListItem>
                 ...
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="btnCSRStatus" CssClass="btn btn-success" runat="server" Text="Submit"></asp:Button>
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Query Monitoring (<asp:Label ID="lbl10" runat="server" Text=""></asp:Label>)<a class="pull-right spmgfilter" id="Queryfilter"><i class="fa fa-search"></i>
                                            </a>
                                            </h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                <ul>
                                                    ...
                                                    <li><a href="#QueryModal" data-toggle="modal" data-target="#QueryModal" onclick="ShowQuery(4);"
                                                        title="Response not received within Timeline" style="color:dodgerblue;font-weight:bold;">Response not received within Timeline<span class="bgdisbursed"
                                                            id="spResponseTimeline" style="color:dodgerblue;font-weight:bold;" runat="server"></span></a></li>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">Year wise investment Details</h4>
                            </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">Year wise employment Details</h4>
                            </div>
                            <div style="width: 885px; height: 500px; overflow: auto;">
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">IDCO POST ALLOTMENT APPLICATIONS Details</h4>
                            </div>
                            <div class="modal-body">
