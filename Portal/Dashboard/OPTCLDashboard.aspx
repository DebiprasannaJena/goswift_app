<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master" AutoEventWireup="true" CodeFile="OPTCLDashboard.aspx.cs" Inherits="Portal_Dashboard_OPTCLDashboard" %>
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                    <div class="singlevaluecintainer">
                                                        ...
                                                        <a href="#investmentModal" data-toggle="modal" data-target="#investmentModal" onclick="ShowWiseInv();" title="Search">
                                                            <h3><i class="fa fa-inr"></i><span>
                                                                <asp:Label ID="lblEmpInvestment" runat="server" Text=""></asp:Label></span><small>Cr.</small>
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                              <div class="scroll-prtlet">
                                                <ul>
                                                    ...
                                                    <li><a href="#DsModal1" data-toggle="modal" data-target="#DsModal1" onclick="ShowService1();" title="Applications past ORTPSA timelines" style="color:orange;font-weight:bold;">Applications past ORTPSA timelines<span class="bgdisbursed" id="hdExceed" style="color:orange;font-weight:bold;" runat="server"></span></a></li>
                                                </ul>
                                                  </div>
                                            </div>
                                        ...
                                        <div class="investordashboard-sec incentive-sec ">
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="proposals sent to IDCO for Land Allotment" onclick="ShowLandDetails(2);">No. of proposals sent to
                                                        <br />
                                                        IDCO for Land Allotment<span id="spPropIDCO" runat="server"></span></a></li>
                                                    <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="No. of proposal for which land allotted by IDCO" onclick="ShowLandDetails(5);">No. of proposal for
                                                        <br />
                                                        which land allotted by IDCO<span id="spLandAllotByIDCO" runat="server"></span></a></li>
                                                    <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="Land allotted by IDCO (in Acres)" onclick="ShowLandDetails(3);">Area of Land allotted
                                                        <br />
                                                        by IDCO (in Acres)<span id="spLandAllot" runat="server"></span></a></li>

                                                    <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="No. of Applications where ORTPSA Timelines have exceeded" onclick="ShowLandDetails(4);">No. of Applications where ORTPSA
                                                        <br />
