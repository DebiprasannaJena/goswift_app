<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="PSIndustriesDashboard.aspx.cs" Inherits="Portal_Dashboard_PSIndustriesDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script>
        function pageLoad() {
            ...
            $('#ContentPlaceHolder1_lblPealYear').html(yr1);
            ...
            $('#ContentPlaceHolder1_lblSPMGYear').html(yr4);
            ...
            var yr5 = $('#ContentPlaceHolder1_ddlAppaYear').val();
            $('#ContentPlaceHolder1_lbl5').html(yr5);
            $('#ContentPlaceHolder1_lblAPAAYear').html(yr5);

            $('#btnAPAASubmit').click(function () {
                yr5 = $('#ContentPlaceHolder1_ddlAppaYear').val();
                $('#ContentPlaceHolder1_lbl5').html(yr5);
                $('#ContentPlaceHolder1_lblAPAAYear').html(yr5);
            });

            var yr6 = $('#ContentPlaceHolder1_ddlCSRYear').val();
            $('#ContentPlaceHolder1_lbl6').html(yr6);
            $('#ContentPlaceHolder1_lblCSRYear').html(yr6);

            $('#btnAPAASubmit').click(function () {
                yr6 = $('#ContentPlaceHolder1_ddlCSRYear').val();
                $('#ContentPlaceHolder1_lbl6').html(yr6);
                $('#ContentPlaceHolder1_lblCSRYear').html(yr6);
            });

            var yr7 = $('#ContentPlaceHolder1_ddlIncentiveYear').val();
            $('#ContentPlaceHolder1_lbl7').html(yr7);

            $('#btnAPAASubmit').click(function () {
                yr7 = $('#ContentPlaceHolder1_ddlIncentiveYear').val();
                $('#ContentPlaceHolder1_lbl7').html(yr7);
            });

            var yr8 = $('#ContentPlaceHolder1_ddlIncentiveYear option:selected').text();
            $('#ContentPlaceHolder1_lbl8').html(yr8);
            $('#ContentPlaceHolder1_lbl12').html(yr8);
            ...
            $('#ContentPlaceHolder1_lbl11').html(yr9);
            ...
            $('#ContentPlaceHolder1_lblQueryYear').html(yr10);
            ...
            var yr11 = $('#ContentPlaceHolder1_ddlYearCICG option:selected').text();
            $('#ContentPlaceHolder1_lblCIFYEAR').html(yr11);
            $('#ContentPlaceHolder1_lblCIFYear1').html(yr11);
            $('#ContentPlaceHolder1_lblCIFYr').html(yr11);

            $('#btnCICGStatus').click(function () {
                yr10 = $('#ContentPlaceHolder1_ddlYearCICG option:selected').text();
                $('#ContentPlaceHolder1_lblCIFYEAR').html(yr11);
                $('#ContentPlaceHolder1_lblCIFYear1').html(yr11);
                $('#ContentPlaceHolder1_lblCIFYr').html(yr11);
            });
        ...
        function openpoupwin(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "PSIndustriesDashboard.aspx/PealDetailsBind",
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        <h1>PS Industries Dashboard</h1>
                        <ul class="breadcrumb">
                            <li><a href="javscript:void(0)"><i class="fa fa-home"></i></a></li>
                            <li><a>PS Industries Dashboard</a></li>
                        </ul>
                    </div>
                </section>
                <!-- Main content -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Single Window Application Status (<asp:Label ID="lbl1" runat="server" Text=""></asp:Label>)
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Year wise investment (<asp:Label ID="lbl2" runat="server" Text=""></asp:Label>)
                                            <a class="pull-right " data-toggle="tooltip" title="Search" id="investmentfilter"><i
                ...
                <asp:ListItem>--Select--</asp:ListItem> 
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Year wise employment (<asp:Label ID="lbl3" runat="server"></asp:Label>) <a class="pull-right "
                                                data-toggle="tooltip" title="Search" id="employmentfilter"><i class="fa fa-search"></i></a>
                                            </h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                <div class="singlevaluecintainer">
                        ...
                        <%--                                        </asp:TemplateField>
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            ...
                                            <asp:Label ID="lblCIFYr" runat="server" Text="" Style="display: none"></asp:Label><a
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>IDCO POST ALLOTMENT APPLICATIONS (<asp:Label ID="lbl5" runat="server" Text="reerre"></asp:Label>)
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>CSR ACTIVITIES (<asp:Label ID="lbl6" runat="server" Text="reerre"></asp:Label>)
                                            <a class="pull-right spmgfilter" data-toggle="tooltip" title="Search" id="linkCSRActivities">
                                                <i class="fa fa-search"></i></a>
                                            </h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                <ul>
                                                    ...
                                                    <li style="color:blue;font-weight:bold;">Total Project<a href="#csrModal" data-toggle="modal" data-target="#csrModal"
                                                        title="Projects taken up" onclick="ShowCSR();"><span id="SPProject" style="color:blue;font-weight:bold;" runat="server"></span></a></li>
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                ...
                                <h4 class="modal-title">Land Allotment Details in
                                    <asp:Label ID="lbl11" runat="server" Text=""></asp:Label></h4>
                            </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">Department Wise Approvals Details
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">Applications past ORTPSA timelines Details
                                    <asp:Label ID="lblTimeLineYear" runat="server" Text=""></asp:Label></h4>
                            </div>
                            <div class="modal-body">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                ...
                                <h4 class="modal-title">Central Inspection Framework Details
                                    <asp:Label ID="lblCIFYear1" runat="server" Text="" Style="display: none"></asp:Label></h4>
                            </div>
                            <div class="modal-body">
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">Central Inspection Framework Details<asp:Label ID="lblCIFYear" runat="server" Text=""
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                ...
                                <h4 class="modal-title">IDCO POST ALLOTMENT APPLICATIONS Details in
                                    <asp:Label ID="lblAPAAYear" runat="server" Text=""></asp:Label></h4>
                            </div>
                            <div class="modal-body">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                ...
                                <h4 class="modal-title">CSR Details in
                                    <asp:Label ID="lblCSRYear" runat="server" Text=""></asp:Label></h4>
                            </div>
                            <div class="modal-body">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                ...
                                <h4 class="modal-title">State Project Monitoring Group Details in
                                    <asp:Label ID="lblSPMGYear" runat="server" Text=""></asp:Label></h4>
                            </div>
                            <div class="modal-body">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                ...
                                <h4 class="modal-title">Incentive Details in
                                    <asp:Label ID="lbl12" runat="server" Text=""></asp:Label></h4>
                            </div>
                            <div class="modal-body">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                ...
                                <h4 class="modal-title">Single Window Application Status Details in
                                    <asp:Label ID="lblPealYear1" runat="server" Text=""></asp:Label>
                                </h4>
                            </div>
                            <div class="modal-body">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">Single Window Application Status Details in
                                    <asp:Label ID="lblPealYear" runat="server" Text=""></asp:Label>
                                </h4>
                            </div>
                            <div class="modal-body">
