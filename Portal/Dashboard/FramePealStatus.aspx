<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FramePealStatus.aspx.cs"
    Inherits="Portal_FramePealStatus" EnableEventValidation="false" %>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" AutoPostBack="True"
                            ...
                            <asp:ListItem Text="Statewise" Value="1"></asp:ListItem>
                            <asp:ListItem Text="Districtwise" Value="2"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <asp:GridView ID="gvPeal" runat="server" CssClass="table table-bordered" AllowPaging="true"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Capital Investment(In Lakhs)" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("vchCapitalInvestment") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Employment" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("vchEmployement") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Count Of Days" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
