...
public partial class Portal_Dashboard_EnergyApprovalTimelineDashboard : SessionCheck
{
    ...
    private void BindExceedService()
    {
        ...
        try
        {
            ...
            //    {
            //        objDashboard.strAction = "EUCDP"; //// Detailed Utility Count
            //    }
            //    else
            //    {
            ...
            //    objDashboard.strAction = "DP";
            //}
            objDashboard.strAction = "EUCDP";
            objDashboard.intUserid = Convert.ToInt32(Session["Userid"]);
            try
            {
                if (Request.QueryString["Dept"] != "undefined")
                {
    ...
    //        if (Request.QueryString["ServiceStatus"].ToString() != "")
    //        {
    //            dvDayDiff.Visible = false;
    //        }
    //        else
    //        {
    //            dvDayDiff.Visible = true;
    //        }
    //    }
    //}
