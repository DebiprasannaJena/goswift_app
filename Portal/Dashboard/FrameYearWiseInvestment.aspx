<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrameYearWiseInvestment.aspx.cs"
    Inherits="Portal_Dashboard_FrameYearWiseInvestment" EnableEventValidation="false" %>
    ...
    <div class="table-responsive" id="viewTable" runat="server">
     <table style="width: 210px" runat="server" id="tbldv">
        ...
        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False"
            EmptyDataText="No Record(s) Found" GridLines="None" OnRowDataBound="GridView1_RowDataBound"  ShowFooter="true" FooterStyle-Font-Bold="true">
            <AlternatingRowStyle />
            <Columns>
                ...
                <asp:BoundField DataField="strDistrictName" HeaderText="District Name" NullDisplayText="--"
                    HeaderStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="intEmployeement1" HeaderText="Amount in Cr" 
