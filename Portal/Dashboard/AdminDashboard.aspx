<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="AdminDashboard.aspx.cs" Inherits="Portal_Dashboard_AdminDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script>
        function pageLoad() {
            ...
            $('#ContentPlaceHolder1_lblDet3').html(yr5);
        ...
        function openpoupwin(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "AdminDashboard.aspx/PealDetailsBind",
        ...
        function openpoupwinEmploeement(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "AdminDashboard.aspx/EmployeementPealDetailsBind",
        ...
        function openpoupwincapiatal(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "AdminDashboard.aspx/EmployeementCapitalPealDetailsBind",
            ...
            <div class="content-wrapper">
                            ...
                            <div class="grphs-sec">
                                ...
                                <div class="row">
                                                ...
                                                <div class="scroll-prtlet">
                                                    <table class="table table-bordered">
                                                        <tr>
                                                            ...
                                                            <th width="260px" style="text-align: center!important;" colspan="2">Special Single Window
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <a title="Total Proposed Investment" href="#investmentModal" data-toggle="modal"
                                                            ...
                                                            <h3>
                                                                <i class="fa fa-inr"></i><span>
                                                                    <asp:Label ID="lblEmpInvestment" runat="server" Text=""></asp:Label></span><medium style="color:blue;font-weight:bold;"> Cr.</medium>
                                    ...
                                    <%--<div class="col-sm-6  col-md-8">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Agenda Monitoring System <a class="pull-right spmgfilter" data-toggle="tooltip" title="Search"
                                                ...
                                                <div class="scroll-prtlet">
                                                    <div class="table-responsive">
                                                        <asp:GridView ID="gvAMS" runat="server" CssClass="table table-bordered" AllowPaging="false"
                                                            OnPreRender="gvAMS_PreRender" AutoGenerateColumns="False" OnPageIndexChanging="gvAMS_PageIndexChanging"
                                                            EmptyDataText="No Record(s) Found" GridLines="None" OnRowDataBound="gvAMS_RowDataBound">
                                                            <AlternatingRowStyle />
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Sl#" HeaderStyle-Width="5%"></asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Nodal Person" HeaderStyle-Width="25%">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("strNodalPersonName") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Pending Since(Days)" HeaderStyle-Width="13%">
                                                                    <ItemTemplate>
                                            ...
                                            <div class="portletsearch" id="AMSsearch">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <asp:DropDownList CssClass="form-control" ID="ddlAMS" runat="server">
                                                                ...
                                                                <asp:ListItem Value="4" Text="0-2 days"></asp:ListItem>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-8 col-sm-offset-4">
                                                            <asp:Button ID="btnAmsSubmit" CssClass="btn btn-success" runat="server" Text="Submit"
                                                                OnClick="btnAmsSubmit_Click"></asp:Button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="scroll-prtlet">
                                                    <table class="table table-bordered" style="height: 215px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                <a title="Issues Resolved" href="#SPMGModal" data-toggle="modal" data-target="#SPMGModal"
                                                                    onclick="ShowSPMG('resolved');">
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>IDCO POST ALLOTMENT APPLICATIONS (<asp:Label ID="lbl6" runat="server" Text=""></asp:Label>)
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>CSR ACTIVITIES (<asp:Label ID="lbl7" runat="server" Text=""></asp:Label>) <a class="pull-right spmgfilter"
                                                data-toggle="tooltip" title="Search" id="linkCSRActivities"><i class="fa fa-search"></i></a>
                                            </h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                <ul>
                                                    <li style="color:dodgerblue;font-weight:bold;">No. of recommended CSR Projects undertaken by corporates<span id="SPUudTknProj" runat="server"></span></li>
                                                    <li style="color:blue;font-weight:bold;">Total Project<a href="#csrModal" data-toggle="modal" data-target="#csrModal"
                                                        title="Projects taken up" onclick="ShowCSR();" style="color:blue;font-weight:bold;"><span id="SPProject" runat="server"></span></a></li>
                ...
                <asp:ListItem Text="Q4" Value="4"></asp:ListItem>--%>
                                    ...
                                    <div class="col-sm-6  col-md-4" style="display: none;">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Single Window Application Status<a class="pull-right ppfilter" data-toggle="tooltip"
                                                title="Search" id="ppfilter"><i class="fa fa-search"></i></a></h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <ul>
                                                    <li>
                        ...
                        <li>Queries Responded<span  id="spTotalQueryResponse" runat="server"></span></li>
                         ...
                         <li><a href="#QueryModal" data-toggle="modal" data-target="#QueryModal" onclick="ShowQuery();"  title="Response Pending">Response Pending<span class="bgdisbursed" id="spTotalQueryPendings" runat="server"></span></a></li>
                           <li>Average Time  Taken to Raise Query<span  id="spAvgTimeTaken" runat="server"></span></li>
                                    ...
                                    <%-- For Agenda monitoring --%>
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec">
                                            <h4>New SWP Agenda Request<a class="pull-right amsfilter" data-toggle="tooltip" title="Search"
                                                id="a1" style="display: none"><i class="fa fa-search"></i></a>
                                            </h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                <asp:GridView ID="grdForwardProj" runat="server" Width="100%" AllowPaging="true"
                                                    ...
                                                    OnRowCommand="grdForwardProj_RowCommand">
                                                    <Columns>
                                                ...
                                                <asp:Label ID="lblMessage1" style="color:goldenrod;font-weight:bold;" runat="server" Text="No SWP Agenda For You!!!" Visible="false"
                                                    CssClass="lblmsg" />
                                            </div>
                                        </div>
                                                </div>
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                ...
                                <h4 class="modal-title">Single Window Application Status Details in
                                    <asp:Label ID="lbldet1" runat="server" Text=""></asp:Label>
                                </h4>
                            </div>
                            <div class="modal-body">
