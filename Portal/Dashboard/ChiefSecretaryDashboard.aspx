<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="ChiefSecretaryDashboard.aspx.cs" Inherits="Portal_Dashboard_ChiefSecretaryDashboard"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function pageLoad() {
            ...
            //added by nibedita behera on 02-11-2017 for multiple district
        ...
        function openpoupwin(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "ChiefSecretaryDashboard.aspx/PealDetailsBind",
        ...
        function openpoupwinEmploeement(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "ChiefSecretaryDashboard.aspx/EmployeementPealDetailsBind",
        ...
        function openpoupwincapiatal(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "ChiefSecretaryDashboard.aspx/EmployeementCapitalPealDetailsBind",
            ...
            <div class="content-wrapper">
                        ...
                        <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                                            ...
                                            <div class="width33">
                                                <p>Application Approved <span id="lblProposalapproved" runat="server"></span></p>
                                            </div>
                                            <div class="width33 margin-right0">
                                                <p>Application Pending <span id="lblTrackerEvalution" runat="server"></span></p>
                                            </div>
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec" >
                                            <h4>Investment </h4>
                                            <p >Total Proposed Investment<span><i class="fa fa-rupee"></i>&nbsp;<asp:Literal ID="lblmastinv" runat="server"></asp:Literal>&nbsp;<small>Cr.</small></span></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                                            <h4>Employment</h4>
                                            <p>Total Proposed Employment<span id="SPEmpGen" runat="server"></span></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                                            <h4>Incentive Details</h4>
                                            <p>Pending incentives <span id="spIncPending" runat="server"></span></p>
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                                            ...
                                            <p>Pending inspections
                                                <asp:Label ID="SPcicgpending" runat="server"></asp:Label></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                                            ...
                                            <p>Pending issues 
                                                <asp:Label ID="spAPAAPending" runat="server"></asp:Label></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                            ...
                            <div class="grphs-sec">
                                <div class="text-left text-red">
                                    <h4>For detailed information, select search option <i class="fa fa-search"></i>shown in the menu bar for each field</h4>
                                </div>
                                <div class="row">
                                    <%-- PEAL FORM STATUS--%>
                                    <div class="col-md-8 col-sm-8">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Single Window Application Status (<asp:Label ID="lbl1" runat="server" Text="reerre"></asp:Label>)<a class="pull-right spmgfilter" data-toggle="tooltip"
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <th width="130px" colspan="1">IT</th>
                                                            <th width="130px" colspan="1">Tourism</th>
                                                        </tr>
                                                        <tr>
                                                            <td><span class="text-primary" style="font-weight:bold;">Applied</span> 
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td><span class="text-success" style="font-weight:bold;">Approved</span>
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td><span class="text-danger" style="font-weight:bold;">Rejected</span> 
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td><span style="color:violet;font-weight:bold;"> Deferred</span>
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td><span class="text-info" style="font-weight:bold;">Query In Progress</span>
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td><span style="font-weight:bold;"> Under Evalution</span>
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td><span style="color:Orange;font-weight:bold;"> Application pending since last 30 days</span> 
                                                            </td>
                                                            <td align="right">
                                                                <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Under Evalution" onclick="ShowPealstatewise(9);">
                                                                    <asp:Label ID="Lbl_Peal_ORTPSA_State" runat="server" Text=""></asp:Label></a>
                                                            </td>
                                                            <td align="right">
                                                                <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Under Evalution" onclick="ShowPealdistwise(9);">
                                                                    <asp:Label ID="Lbl_Peal_ORTPSA_Dist" runat="server" Text=""></asp:Label></a>
                                                            </td>
                                                            <td align="right">
                                                                <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Under Evalution" onclick="ShowITpeal(9);">
                                                                    <asp:Label ID="Lbl_Peal_ORTPSA_IT" runat="server" Text=""></asp:Label></a>
                                                            </td>
                                                            <td align="right">
                                                                <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Under Evalution" onclick="Showtourismpeal(9);">
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Year wise investment (<asp:Label ID="lbl2" runat="server" Text=""></asp:Label>)<a class="pull-right " data-toggle="tooltip" title="Search" id="investmentfilter"><i class="fa fa-search"></i></a></h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                    <div class="singlevaluecintainer">
                                                        ...
                                                        <a href="#investmentModal" data-toggle="modal" data-target="#investmentModal" onclick="ShowWiseInv();" title="Search" style="color:blue;font-weight:bold;">
                                                            <h3><i class="fa fa-inr"></i><span>
                                                                <asp:Label ID="lblEmpInvestment" runat="server" Text=""></asp:Label></span><small style="color:blue;font-weight:bold;">Cr.</small>
                ...
                <asp:ListItem>--Select--</asp:ListItem> 
                                                            ...
                                                            <div class="listcontrol checkbox form-control">
                                                                <asp:CheckBox ID="chkYearwiseHeader" runat="server" Checked="true" onclick="setCBL1(this)" Text="Check All"></asp:CheckBox>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-8 col-sm-offset-4">
                                                            <asp:Button ID="btnPealcapitalsubmit" CssClass="btn btn-success" OnClientClick="return test1();" runat="server"
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Year wise employment (<asp:Label ID="lbl3" runat="server" Text=""></asp:Label>)<a class="pull-right " data-toggle="tooltip" title="Search" id="employmentfilter"><i class="fa fa-search"></i></a></h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                    <div class="singlevaluecintainer">
                                                        ...
                                                        <a href="#EmploymentModal" data-toggle="modal" data-target="#EmploymentModal" onclick="ShowWiseInvdet();" title="" style="color:orange;font-weight:bold;">
                                                            <h3><i class="fa fa-users"></i><span>
                       ...
                       <br />
                                            ...
                                            <div class="portletsearch" id="employmentsearch">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-8 col-sm-offset-4">
                                                            <asp:Button ID="btnPealEmployement" CssClass="btn btn-success test" OnClientClick="return test();" runat="server"
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                               <div class="scroll-prtlet">
                                                <ul>
                                                    <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('R');" title="Application Received"  style="color:blue;font-weight:bold;">Application Received<span  id="hdApplied" runat="server"><asp:Literal ID="ltlServiceApplied" runat="server"></asp:Literal></span></a></li>
                                                    <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('A');" title="Total Approvals Provided" style="color:green;font-weight:bold;">Total Approvals Provided<span id="hdApprove" runat="server"><asp:Literal ID="ltlApprove" runat="server"></asp:Literal></span></a></li>
                                                    <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('PK');" title="Query In Progress" style="color:dodgerblue;font-weight:bold;">Query In Progress<span id="hdnqueryRaised" runat="server"><asp:Literal ID="Literal1" runat="server"></asp:Literal></span></a></li>
                                                    <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('P');" title="Approval Pending" style="color:violet;font-weight:bold;">Approval Pending<span id="hdPending" runat="server"><asp:Literal ID="ltlServicepending" runat="server"></asp:Literal></span></a></li>
                                                    <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('RJ');" title="Total Rejected " style="color:red;font-weight:bold;">Total Rejected <span id="hdReject" runat="server">
                                                        <asp:Literal ID="ltlServiceReject" runat="server"></asp:Literal></span></a></li>
                                                    <li><a href="#DsModal1" data-toggle="modal" data-target="#DsModal1" onclick="ShowService1();" title="Applications past ORTPSA timelines" style="color:orange;font-weight:bold;">Applications past ORTPSA timelines<span class="bgdisbursed" style="color:orange;font-weight:bold;" id="hdExceed" runat="server"></span></a></li>
                                                </ul>
                                                   </div>
                                            </div>
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                <ul>
                                                    <li><a title="Inspections Completed" href="#CIFModal" data-toggle="modal" data-target="#CIFModal" onclick="ShowCICG('C');" style="color:green;font-weight:bold;">Inspections Completed<span id="SPcicgcompleted" runat="server"></span></a></li>
                                                    <li><a title="Inspections Scheduled" href="#CIFModal" data-toggle="modal" data-target="#CIFModal" onclick="ShowCICG('A');" style="color:blue;font-weight:bold;">Inspections Scheduled<span id="SPcicgapplied" runat="server"></span></a></li>

                                                    <li><a title="Unattended InspectionS" href="#CIFModal" data-toggle="modal" data-target="#CIFModal" onclick="ShowCICG('B');" style="color:violet;font-weight:bold;">Unattended Inspections<span id="SPunattInsdash" runat="server"></span></a></li>
                                                    <li><a title="Inspection reports not uploaded within 48 hours" href="#CIFModal1" data-toggle="modal" data-target="#CIFModal1" onclick="ShowCICG1();" style="color:orange;font-weight:bold;">Inspection reports not uploaded within 48 hours<span class="bgdisbursed" id="SPReprtNotUploaded" style="color:orange;font-weight:bold;" runat="server"></span></a></li>
                                                </ul>
                                                    </div>
                                            </div>
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>IDCO POST ALLOTMENT APPLICATIONS (<asp:Label ID="lbl6" runat="server" Text=""></asp:Label>)<a class="pull-right spmgfilter" data-toggle="tooltip" title="Search" id="APAAfilter"><i class="fa fa-search"></i></a></h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                <ul>
                                                    <li><a title="Received" href="#APAAModal" data-toggle="modal" data-target="#APAAModal" onclick="ShowAPAA('A');" style="color:blue;font-weight:bold;">Change requests received<span id="spchngrqstApplied" runat="server"></span></a></li>
                                                    <li><a title="Processed" href="#APAAModal" data-toggle="modal" data-target="#APAAModal" onclick="ShowAPAA('B');" style="color:green;font-weight:bold;">Change requests processed<span id="spchngreqdispose" runat="server"></span></a></li>
                                                    <li><a title="Disposed" href="#APAAModal" data-toggle="modal" data-target="#APAAModal" onclick="ShowAPAA('D');" style="color:dodgerblue;font-weight:bold;">Change requests pending to be disposed<span id="spchngreqPendAtIDCO" runat="server"></span></a></li>
                                                    ...
                                                    <li><a title="Approvals" href="#APAAModal" data-toggle="modal" data-target="#APAAModal" onclick="ShowAPAA('E');" style="color:orange;font-weight:bold;">Change requests which have crossed 30 days<span class="bgdisbursed" style="color:orange;font-weight:bold;" id="spchngReqCrossThirty" runat="server"></span></a></li>
                                                </ul>
                                                    </div>
                                            </div>
                ...
                <a class="pull-right spmgfilter" data-toggle="tooltip" title="Search" id="linkCSRActivities"><i class="fa fa-search"></i></a></h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                <ul>
                                                    <li style="color:blue;font-weight:bold;">Total Project<a href="#csrModal" data-toggle="modal" data-target="#csrModal" title="Projects taken up" onclick="ShowCSR();" ><span id="SPProject" runat="server" style="color:blue;font-weight:bold;"></span></a></li>

                                                    <li style="color:orange;font-weight:bold;">Recommended by Council<span id="SPRecommendedCouncil" runat="server"></span></li>
                                                    <li style="color:green;font-weight:bold;">Total Spending<span><i class="fa fa-rupee"></i>&nbsp;<label id="SPSpent" runat="server"></label>&nbsp; Cr.</span></li>
                                                </ul>
                                                    </div>
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <a href="#IncentiveModal" data-toggle="modal" data-target="#IncentiveModal" title="Sanctioned" onclick="ShowIncentive('D');" style="color:green;font-weight:bold;">Sanctioned<span><asp:Label ID="lblIncsanctioed" runat="server" Text=""></asp:Label></span></a>
                                                    </li>

                                                    <%-- <span  id="ltlincPending" runat="server">Scrutiny</span>--%>


                                                    <li><a href="#IncentiveModal" data-toggle="modal" data-target="#IncentiveModal" title="Scrutiny" onclick="ShowIncentive('E');" style="color:violet;font-weight:bold;">Pending
                       <span>
                           <asp:Label ID="lblIncpending" runat="server" Text=""></asp:Label></span></a>
                                                    ...
                                                    <li><a href="#IncentiveModal" data-toggle="modal" data-target="#IncentiveModal" title="Rejected" onclick="ShowIncentive('F');" style="color:red;font-weight:bold;">Rejected<span><asp:Label ID="lblIncrejected" runat="server" Text=""></asp:Label></span></a>
                                                    ...
                                                    <li><a href="#IncentiveModal" data-toggle="modal" data-target="#IncentiveModal" title="Disbursed" onclick="ShowIncentive('C');" style="color:blue;font-weight:bold;">Disbursed
                       <span>
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                    <table class="table table-bordered" style="height: 215px;">
                                                        ...
                                                        <tr>
                                                            <td><span style="color:blue;font-weight:bold;"> Issues Received</span>  
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td><span style="color:green;font-weight:bold;"> Issues Resolved</span>  
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td><span style="color:violet;font-weight:bold;"> Issues Pending</span>  
                                                            </td>
                                                            <td align="right">
                                                        ...
                                                        <tr>
                                                            <td><span style="color:orange;font-weight:bold;"> Issues Pending > 30 days</span>  
                                                            </td>
                                                            <td align="right">
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="scroll-prtlet">
                                                <ul>
                                                    <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="Land assessments" onclick="ShowLandDetails(1);" style="color:blue;font-weight:bold;">No. of Projects Requiring Land<span id="spLandAssesment" runat="server"></span></a></li>
                                                    <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="proposals sent to IDCO for Land Allotment" onclick="ShowLandDetails(2);" style="color:brown;font-weight:bold;">No. of proposals sent to
                                                        <br />
                                                        IDCO for Land Allotment<span id="spPropIDCO" runat="server"></span></a></li>
                                                    <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="No. of proposal for which land allotted by IDCO" onclick="ShowLandDetails(5);" style="color:green;font-weight:bold;">No. of proposal for
                                                        <br />
                                                        which land allotted by IDCO<span id="spLandAllotByIDCO" runat="server"></span></a></li>
                                                    <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="Land allotted by IDCO (in Acres)" onclick="ShowLandDetails(3);" style="color:dodgerblue;font-weight:bold;">Area of Land allotted
                                                        <br />
                                                        by IDCO (in Acres)<span id="spLandAllot" runat="server"></span></a></li>

                                                    <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="No. of Applications where ORTPSA Timelines have exceeded" onclick="ShowLandDetails(4);" style="color:orange;font-weight:bold;">No. of Applications where ORTPSA
                                                        <br />
                                                ...
                                                <div class="scroll-prtlet">
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tr>
                                                                <td><span style="color:blue;font-weight:bold;"> Queries Raised</span></td>
                                                                <td align="right">
                                                            ...
                                                            <tr>
                                                                <td><span style="color:green;font-weight:bold;">Queries Responded</span>  
                                                                </td>
                                                                <td align="right">
                                                            ...
                                                            <tr>
                                                                <td><span style="color:violet;font-weight:bold;">Response Pending</span>   
                                                                </td>
                                                                <td align="right">
                                                            ...
                                                            <tr>
                                                                <td><span style="color:dodgerblue;font-weight:bold;" >Response not received within Timeline</span>  
                                                                </td>
                                                                <td align="right">
                                                            ...
                                                            <tr>
                                                                <td><span style="color:orange;font-weight:bold;"> Average Day Taken to Raise Query</span>  
                                                                </td>
                                                                <td align="right">
                         ...
                         <li><a href="#QueryModal" data-toggle="modal" data-target="#QueryModal" onclick="ShowQuery();"  title="Response Pending">Response Pending<span class="bgdisbursed" id="spTotalQueryPendings" runat="server"></span></a></li>
                           <li>Average Time  Taken to Raise Query<span  id="spAvgTimeTaken" runat="server"></span></li>
                                    ...
                                    <div class="col-sm-6  col-md-4" style="display: none">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Single Window Application Status <a class="pull-right ppfilter" id="ppfilter"><i class="fa fa-search"></i></a></h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <ul>
                                    ...
                                    <div class="col-sm-6  col-md-4" style="display: none;">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Agenda Management System <a class="pull-right spmgfilter" data-toggle="tooltip" title="Search" id="AMSfilter"><i class="fa fa-search"></i></a></h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <div class="table-responsive">
                                                </div>
                ...
                <div id="investmentModal" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            ...
                            <%--<div style="width: 885px; height: 500px; overflow: auto;" id="xyz" runat="server">
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">CSR Details in
                ...
                <%-- ADDED BY SUROJ FOR INCENTIVE MODAL--%>
