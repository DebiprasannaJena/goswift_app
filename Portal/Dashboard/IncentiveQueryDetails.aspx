<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IncentiveQueryDetails.aspx.cs"
    Inherits="Portal_Dashboard_IncentiveQueryDetails" %>
...
<body class="bg-white" style="background: none;">
    ...
    <div class="table-responsive" id="viewTable" runat="server">
      <table style="width: 210px" runat="server" id="tbldv">
        ...
        <asp:GridView ID="gvIncentive" CssClass="table table-bordered table-responsive" runat="server"
            AutoGenerateColumns="false" AllowPaging="true" Width="100%" EmptyDataText="No Record(s) Found..."
            PageSize="50" onrowdatabound="gvIncentive_RowDataBound" OnPageIndexChanging="gvIncentive_PageIndexChanging" >
            <Columns>
                <asp:TemplateField HeaderText="Sl#"></asp:TemplateField>
                <asp:TemplateField HeaderText="Application No">
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("INTINCUNQUEID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Incentive Name">
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("InctivName") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
