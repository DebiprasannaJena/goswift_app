<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master" AutoEventWireup="true" CodeFile="MISIDCODashboard.aspx.cs" Inherits="Portal_Dashboard_MISIDCODashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script>
        ...
        function openpoupwin(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "CMDIPICOLDashboard.aspx/PealDetailsBind",
        ...
        function openpoupwinEmploeement(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "CMDIPICOLDashboard.aspx/EmployeementPealDetailsBind",
        ...
        function openpoupwincapiatal(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "CMDIPICOLDashboard.aspx/EmployeementCapitalPealDetailsBind",
        ...
        <ContentTemplate>
            ...
            <div class="content-wrapper">
              ...
              <div class="header-icon">
               ...
               <div class="header-title">
                  <h1>CMD (IDCO) Dashboard</h1>
                  <ul class="breadcrumb"><li><a href="javscript:void(0)"><i class="fa fa-home"></i></a></li><li><a>CMD (IDCO) Dashboard</a></li></ul>
               </div>
            </section>
                <!-- Main content -->
            ...
            <div class="row">
             ...
             <div class="masterportletsec">
               <h4>Single Window Approval Status</h4>
             <div class="width33">
          ...
          <div class="width33"> <p>Application Approved <span id="lblProposalapproved" runat="server"></span></p></div>
           <div class="width33 margin-right0">  <p>Application Pending <span id="lblTrackerEvalution" runat="server"></span></p></div>   
             ...
             <div class="masterportletsec">
             <h4>Investment </h4>
             <p>Total Proposed Investment<span><i class="fa fa-inr"></i>&nbsp;<asp:Literal ID="lblmastinv" runat="server"></asp:Literal><medium>Cr.</medium></span></p>
             </div>
             </div>
              <div class="col-sm-6  col-md-4" style="display:none">
             <div class="masterportletsec">
             ...
             <p>Pending issues <span id="spAPAAPending" runat="server"></span></p>
              ...
              <div class="col-sm-6  col-md-4" style="display:none">
             <div class="masterportletsec">
            <h4>State Project Monitoring Group </h4>
                 ...
                 <%-- PEAL FORM STATUS--%>
                   <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="portletcontainer cmdashbordportlet"><div class="scroll-prtlet">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowPealstatewise(2);">
                                                                <asp:Label ID="lblPealApproved" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                        <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowPealdistwise(2);">
                                                                <asp:Label ID="lblPealdistApproved" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                         <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowITpeal(2);">
                                                                <asp:Label ID="lblPealITApproved" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                         <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="Showtourismpeal(2);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowPealstatewise(3);">
                                                                <asp:Label ID="lblPealRejected" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                        <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowPealdistwise(3);">
                                                                <asp:Label ID="lblPealdistRejected" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                         <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowITpeal(3);">
                                                                <asp:Label ID="lblPealITRejected" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                         <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="Showtourismpeal(3);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowPealstatewise(7);">
                                                                <asp:Label ID="lblPealDeferred" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                        <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowPealdistwise(7);">
                                                                <asp:Label ID="lblPealdistDeferred" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                         <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowITpeal(7);">
                                                                <asp:Label ID="lblPealITDeferred" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                         <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="Showtourismpeal(7);">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowPealstatewise(6);">
                                                                <asp:Label ID="lblPealUnderEvalution" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                        <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowPealdistwise(6);">
                                                                <asp:Label ID="lblPealdistUnderEvalution" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                         <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="ShowITpeal(6);">
                                                                <asp:Label ID="lblPealITUnderEvalution" runat="server" Text=""></asp:Label></a>
                                                        </td>
                                                         <td align="right">
                                                            <a href="#Div1" data-toggle="modal" data-target="#Div1" title="Applied" onclick="Showtourismpeal(6);">
                     ...
                     <div class="col-sm-6  col-md-3" style="display:none">
                       <div class="investordashboard-sec incentive-sec ">
                       <h4>Year wise investment <a class="pull-right " data-toggle="tooltip" title="Search" id="investmentfilter"><i class="fa fa-search"></i></a></h4>
                       ...
                       <h3><i class="fa fa-inr"></i><span><asp:Label ID="lblEmpInvestment" runat="server" Text=""></asp:Label></span><medium> Cr.</medium> 
                        <asp:HiddenField ID="HiddenField4" Value="3" runat="server" />
                       </h3>
                    Total Proposed Investment<br />
                     <small>(For the Year <asp:Label ID="lblYearInvestment" runat="server" Text=""></asp:Label>) </small>
                       </a>
                    </div>
                     </div>
            ...
            <asp:HiddenField ID="hdnFinacial" runat="server"></asp:HiddenField>
                 ...
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="btnPealcapitalsubmit" CssClass="btn btn-success" runat="server"  OnClientClick="return test1();" 
                       ...
                       <%--Year wise employment--%>
                          <div class="col-sm-6  col-md-3" style="display:none">
                       <div class="investordashboard-sec incentive-sec ">
                       <h4>Year wise employment<a class="pull-right " data-toggle="tooltip" title="Search" id="employmentfilter"><i class="fa fa-search"></i></a></h4>
                       <div class="portletcontainer cmdashbordportlet">
                       <div  class="singlevaluecintainer">
                      ...
                      Total Proposed Employment
                       <br /><small>(For the Year <asp:Label ID="lblYearEmployement" runat="server" Text=""></asp:Label>) </small>
                       </a>
                    </div>
                     </div>
                 ...
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="btnPealEmployement" CssClass="btn btn-success" runat="server"  OnClientClick="return test();"
                    ...
                    <tr><td>Mr./Ms. ABC</td><td>0</td></tr>
                       ...
                       <asp:GridView ID="gvAMS" runat="server" CssClass="table table-bordered" AllowPaging="false"
             ...
             <PagerStyle CssClass="pagination-grid no-print" HorizontalAlign="Right" /> 
                ...
                <asp:ListItem Value="4" Text="0-3 days"></asp:ListItem>
                <asp:ListItem Value="5" Text="3-7 days"></asp:ListItem>
                <asp:ListItem Value="6" Text=">7 days"></asp:ListItem>
                </asp:DropDownList>
                  </div>
                  </div>
                  </div>
                  ...
                  <div class="row">
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="btnAmsSubmit" CssClass="btn btn-success" runat="server" Text="Submit"></asp:Button>
                  </div>
                         ...
                         <div class="col-sm-6  col-md-4" style="display:none">
                         <div class="investordashboard-sec incentive-sec ">
                       <h4>STATE PROJECT MONITORING GROUP <a class="pull-right spmgfilter" data-toggle="tooltip" title="Search"  id="linkSpmg"><i class="fa fa-search"></i></a></h4>
                       <div class="portletcontainer cmdashbordportlet">
                 <ul>
                      <li><a title="Issues Received" href="#SPMGModal" data-toggle="modal" data-target="#SPMGModal" onclick="ShowSPMG('received');">Issues Received<span  id="spmgraised" runat="server"></span></a></li>
                      <li><a title="Issues Resolved" href="#SPMGModal" data-toggle="modal" data-target="#SPMGModal" onclick="ShowSPMG('resolved');">Issues Resolved<span   id="spmgresolved" runat="server"></span></a></li>
                      <li><a title="Issues Pending" href="#SPMGModal" data-toggle="modal" data-target="#SPMGModal" onclick="ShowSPMG('pending');">Issues Pending<span   id="spmgpending" runat="server"></span></a></li>
                      <li><a title="Issues Pending > 30 days" href="#SPMGModal" data-toggle="modal" data-target="#SPMGModal" onclick="ShowSPMG('delayed');">Issues Pending > 30 days <span  id="spmg30pending" runat="server" ></span></a></li>
                     </ul>
               <div class="portletsearch" id="SpmgContent" style="top: -5px;">
                 ...
                 <div class="col-sm-8 col-sm-offset-4">
                  ...
                  <div class="col-sm-6  col-md-4" style="display:none">
                     ...
                     <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('R');"  title="Application Received">Application Received<span  id="hdApplied" runat="server"><asp:Literal ID="ltlServiceApplied" runat="server"></asp:Literal></span></a></li>
                      ...
                      <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('P');"  title="Approval Pending">Approval Pending<span  id="hdPending" runat="server"><asp:Literal ID="ltlServicepending" runat="server"></asp:Literal></span></a></li>
                      <li><a href="#DsModal" data-toggle="modal" data-target="#DsModal" onclick="ShowService('RJ');"  title="Total Rejected ">Total Rejected <span  id="hdReject" runat="server"><asp:Literal ID="ltlServiceReject" runat="server"></asp:Literal></span></a></li>
                      <li><a href="#DsModal1" data-toggle="modal" data-target="#DsModal1" onclick="ShowService1();"  title="Applications past ORTPSA timelines">Applications past ORTPSA timelines<span class="bgdisbursed" id="hdExceed" runat="server"></span></a></li>
                      </ul>
                     </div>
                ...
                <asp:ListItem Value="0">--Select--</asp:ListItem>
                  ...
                  <div class="row">
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="btnCICGStatus" CssClass="btn btn-success" runat="server" Text="Submit" ></asp:Button>
                  </div>
                  </div>
                  </div>
                  </div>
                       ...
                       <%--IDCO POST ALLOTMENT APPLICATIONS--%>
                          <div class="col-sm-6  col-md-4">
                       <div class="investordashboard-sec incentive-sec ">
                       <h4>IDCO POST ALLOTMENT APPLICATIONS<a class="pull-right spmgfilter" data-toggle="tooltip" title="Search"  id="APAAfilter"><i class="fa fa-search"></i></a></h4>
                       <div class="portletcontainer cmdashbordportlet">
                     <ul>
                     <li><a title="Received" href="#APAAModal" data-toggle="modal" data-target="#APAAModal" onclick="ShowAPAA('A');">Change requests received<span  id="spchngrqstApplied" runat="server"></span></a></li>
                     <li><a title="Processed" href="#APAAModal" data-toggle="modal" data-target="#APAAModal" onclick="ShowAPAA('B');">Change requests processed<span  id="spchngreqdispose" runat="server"></span></a></li>
                     <li><a title="Disposed" href="#APAAModal" data-toggle="modal" data-target="#APAAModal" onclick="ShowAPAA('D');">Change requests pending to be disposed<span   id="spchngreqPendAtIDCO" runat="server"></span></a></li>
                     ...
                     <li><a title="Approvals" href="#APAAModal" data-toggle="modal" data-target="#APAAModal" onclick="ShowAPAA('E');">Change requests which have crossed 30 days<span class="bgdisbursed" id="spchngReqCrossThirty" runat="server"></span></a></li>
                     </ul>
                     </div>
                ...
                <asp:ListItem Value="0">--Select--</asp:ListItem>
                  ...
                  <div class="row">
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="btnCSRStatus" CssClass="btn btn-success" runat="server" Text="Submit" OnClientClick="return CSRDist();" ></asp:Button>
                  </div>
                  </div>
                  </div>
                  </div>
                   ...
                   <div class="col-sm-6  col-md-4" style="display:none">
                       <div class="investordashboard-sec incentive-sec ">
                       <h4>Incentive Details<a class="pull-right spmgfilter" data-toggle="tooltip" title="Search" id="INCENTIVEfilter"><i class="fa fa-search"></i></a> </h4>
                       <div class="portletcontainer cmdashbordportlet">
                    <ul>
                        <li>                             
               ...
               <%-- <asp:ListItem Text="Q1" Value="1"></asp:ListItem>
                ...
                <asp:ListItem Text="--Select--" Value="0"></asp:ListItem>
                  ...
                  <div class="row">
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="btnIncentiveSubmit" CssClass="btn btn-success" runat="server" Text="Submit" ></asp:Button>
                  </div>
                 ...
                 <div class="col-sm-6  col-md-4" style="display:none;">
                       <div class="investordashboard-sec incentive-sec ">
                       <h4>Project Proposals <a class="pull-right ppfilter" data-toggle="tooltip" title="Search" id="ppfilter"><i class="fa fa-search"></i></a></h4>
                       <div class="portletcontainer cmdashbordportlet">
                     <ul>
                ...
                <asp:ListItem>--Select--</asp:ListItem> <asp:ListItem> < 50 crore</asp:ListItem><asp:ListItem> > 50 crore </asp:ListItem>
                 ...
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="Button1" CssClass="btn btn-success" runat="server" Text="Submit"></asp:Button>
                       ...
                       <div class="col-sm-6  col-md-4" style="display:none">
                         <div class="investordashboard-sec incentive-sec ">
                       <h4>Land Allotment Details <a class="pull-right landfilter" data-toggle="tooltip" title="Search"  id="landFilter"><i class="fa fa-search"></i></a></h4>
                       <div class="portletcontainer cmdashbordportlet">
                     <ul>
                      <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="Land assessments" onclick="ShowLandDetails(1);">No. of Land assessments<span  id="spLandAssesment" runat="server"></span></a></li>
                      <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="proposals sent to IDCO for Land Allotment" onclick="ShowLandDetails(2);">No. of proposals sent to IDCO for Land Allotment<span   id="spPropIDCO" runat="server"></span></a></li>
                      <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="Land allotted by IDCO (in Acres)" onclick="ShowLandDetails(3);">Area of Land allotted by IDCO (in Acres)<span   id="spLandAllot" runat="server"></span></a></li>
                      <li><a href="#LandModal" data-toggle="modal" data-target="#LandModal" title="No. of Applications where ORTPSA Timelines have exceeded" onclick="ShowLandDetails(4);">No. of Applications where ORTPSA Timelines have exceeded<span  id="spORTPSALAnd" runat="server" ></span></a></li>
                     </ul>
               <div class="portletsearch" id="landSearch" style="top: -5px;">
                ...
                <asp:DropDownList CssClass="form-control" ID="ddlLandFinYear" runat="server">
                  ...
                  <div class="row">
                 <div class="col-sm-8 col-sm-offset-4">
                  <asp:Button ID="btnLandSubmit" CssClass="btn btn-success" runat="server" Text="Submit"></asp:Button>
                  </div>
                  </div>
                  </div>
                  </div>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content modal-primary ">
                    ...
                    <div class="modal-body">
                        <iframe name="SPMGIframe" id="SPMGIframe" width="100%" style="height: 298px"
                                    runat="server"></iframe>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">
    ...
    <script>
        ...
        function ShowAPAA(APAAStatus) {
            ...
            var year = $('#ContentPlaceHolder1_ddlAppaYear option:selected').text();
        ...
        function ShowSPMG(SPMGStatus) {
            ...
            document.getElementById('ContentPlaceHolder1_SPMGIframe').src = "SPMGGridStatus.aspx?Year=" + Year + "&SPMGStatus=" + SPMGStatus;
        }
