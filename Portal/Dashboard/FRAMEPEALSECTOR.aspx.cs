...
using System.Web.UI;
#endregion
public partial class Portal_Dashboard_FRAMEPEALSECTOR :SessionCheck
{
    ...
    public void Fillgrid()
    {
        ...
        if (Convert.ToInt32(Session["Userid"]) == 167 || Convert.ToInt32(Session["Userid"]) == 1196 || Request.QueryString["PealSectorUser"].ToString() == "1")
        {
            objSWP.intSecId = itSectorId;
        }
        else if (Convert.ToInt32(Session["Userid"]) == 166 || Convert.ToInt32(Session["Userid"]) == 1197 || Request.QueryString["PealSectorUser"].ToString()=="2")
        {
