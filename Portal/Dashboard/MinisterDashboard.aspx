<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="MinisterDashboard.aspx.cs" Inherits="Portal_Dashboard_MinisterDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function openpoupwin(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "MinisterDashboard.aspx/PealDetailsBind",
        ...
        function openpoupwinEmploeement(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "MinisterDashboard.aspx/EmployeementPealDetailsBind",
        ...
        function openpoupwincapiatal(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "MinisterDashboard.aspx/EmployeementCapitalPealDetailsBind",
        ...
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                                            ...
                                            <p>
                                                Total Proposed Investment<span><i class="fa fa-rupee"></i>&nbsp;<asp:Literal ID="lblmastinv"
                                    ...
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                                            ...
                                            <p>
                                                Pending inspections
                                            <asp:Label ID="SPcicgpending" runat="server"></asp:Label>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                                            ...
                                            <p>
                                                Pending issues
                                            <asp:Label ID="spAPAAPending" runat="server"></asp:Label>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6  col-md-4">
                                        <div class="masterportletsec">
                                            ...
                                            <p>
                                                Issues pending
                                            <span id="spSpmgpnd" runat="server"></span>
                                            </p>
                                        </div>
                                    </div>
                ...
                <asp:ListItem>--Select--</asp:ListItem> 
                                    ...
                                    <%--Post Allotment Applications to IDCO status--%>
                                    <div class="col-sm-6  col-md-4">
                                        <div class="investordashboard-sec incentive-sec ">
                ...
                <asp:ListItem Text="Q4" Value="4"></asp:ListItem>--%>
                                    ...
                                    <div class="col-sm-6  col-md-4" style="display: none">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Land Allotment Details <a class="pull-right landfilter" data-toggle="tooltip" title="Search"
                                                id="landFilter" style="display: none"><i class="fa fa-search"></i></a>
                                            </h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <ul>
                                                    <li>No. of Land assessments<span id="spLandAssesment" runat="server" style="text-decoration: none"></span></li>
                                                    <li>No. of proposals sent to IDCO for Land Allotment<span id="spPropIDCO" runat="server"></span></li>
                                                    <li>Area of Land allotted by IDCO (in Acres)<span id="spLandAllot" runat="server"></span></li>
                                                    <li>No. of Applications where ORTPSA Timelines have exceeded<span id="spORTPSALAnd"
                                                        runat="server"></span></li>
                                                </ul>
                                                <div class="portletsearch" id="landSearch" style="top: -5px; display: none;">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label class="col-sm-4">
                                                                Year</label>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">State Project Monitoring Group Portal Details</h4>
                            </div>
                            <div class="modal-body">
