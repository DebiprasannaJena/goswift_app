<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="CmDashboard.aspx.cs" Inherits="Portal_Dashboard_CmDashboard"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function Show(Status) {
            ...
            document.getElementById('ContentPlaceHolder1_myIframe').src = "FramePealStatus.aspx?Status=" + Status + "&PealType=" + PealType + "&Pealdistrict=" + Pealdistrict + "&PealYear=" + Pealyear + "&PealQuarter=" + Pealyear;
        }
        ...
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                ...
                <asp:ListItem Text="Q4" Value="4"></asp:ListItem>--%>
                                    ...
                                    <div class="col-sm-6  col-md-4" style="display: none">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Project Proposals <a class="pull-right ppfilter" id="ppfilter"><i class="fa fa-search"></i></a>
                                            </h4>
                                            <div class="portletcontainer cmdashbordportlet">
                                                <ul>
                                                    <li>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">APAA Details Details in
