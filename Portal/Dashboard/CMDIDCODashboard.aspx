<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="CMDIDCODashboard.aspx.cs" Inherits="Portal_Dashboard_CMDIDCODashboard" %>
        ...
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                                        ...
                                        <div class="masterportletsec">
                                            ...
                                            <p>
                                                Total Proposed Investment<span><i class="fa fa-inr"></i>&nbsp;<asp:Literal ID="lblmastinv"
                                                    runat="server"></asp:Literal><medium>Cr.</medium></span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6  col-md-4">
                ...
                <asp:ListItem>--Select--</asp:ListItem> 
                                            ...
                                            <div class="portletcontainer cmdashbordportlet">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a title="Disposed" href="#APAAModal" data-toggle="modal" data-target="#APAAModal"
                                                        onclick="ShowAPAA('D');" style="color:violet;font-weight:bold;">Change requests pending at IDCO<span id="spchngreqPendAtIDCO"
                                                            runat="server"></span></a></li>
                                                    <li><a title="Disposed" href="#APAAModal" data-toggle="modal" data-target="#APAAModal"
                                                        onclick="ShowAPAA('C');" style="color:dodgerblue;font-weight:bold;">Change requests pending at Industry <span id="spnPendingatUnit"
                                                            runat="server"></span></a></li>
                                    ...
                                    <div class="col-sm-6  col-md-4" style="display: none">
                                        <div class="investordashboard-sec incentive-sec ">
                                            <h4>Incentive Details<a class="pull-right spmgfilter" data-toggle="tooltip" title="Search"
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content modal-primary ">
                            <div class="modal-header bg-red">
                                <button type="button" class="close" data-dismiss="modal">
                                    &times;</button>
                                <h4 class="modal-title">Incentive Details</h4>
                            </div>
                            <div class="modal-body">
