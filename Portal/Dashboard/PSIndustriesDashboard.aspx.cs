...
public partial class Portal_Dashboard_PSIndustriesDashboard : SessionCheck
{
    ...
    private void ViewCICGData() //view CENTRAL INSPECTION FRAMEWORK on normal platfrom
    {
        ...
        try
        {
            ...
            {
                SPcicgapplied.InnerText = objServiceStatus[0].INT_INS_SCHEDULED.ToString();
                SPcicgcompleted.InnerText = objServiceStatus[0].INT_INS_COMPLETED.ToString();
                SPunattInsdash.InnerText = objServiceStatus[0].INT_UNATTENDED_INS.ToString();
                SPReprtNotUploaded.InnerText = objServiceStatus[0].INT_REPORTNOT_UPLOADED.ToString();

            }
            else
            {
                SPcicgapplied.InnerText = "0";
                SPcicgcompleted.InnerText = "0";
                SPunattInsdash.InnerText = "0";
                SPReprtNotUploaded.InnerText = "0";
