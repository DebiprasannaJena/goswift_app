...
public partial class Portal_Report_ApplicationStatus_report : System.Web.UI.Page
{
    ...
    public void fillGridview()
    {
        try
        {
            ...
            objProp.vchType = Request.QueryString["AID"].ToString();
            objProp.strAction = Request.QueryString["AID"].ToString();
            ...
            //objProp.INT_STATUS = Request.QueryString["AID"].ToString();




            objProjList = objdata.ApplicationStatus_Report(objProp).ToList();
