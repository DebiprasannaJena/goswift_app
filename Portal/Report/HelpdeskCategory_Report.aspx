<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master" AutoEventWireup="true" CodeFile="HelpdeskCategory_Report.aspx.cs" Inherits="Portal_Report_HelpdeskCategory_Report" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Helpdesk Category Wise Report</h1>
                        ...
                        <div class="panel-body">
                            ...
                            <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Category Name">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hyCate" runat="server" Text='<%#Eval("CategoryName")%>'></asp:HyperLink>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Discard">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hydis" runat="server" Text='<%#Eval("Discard")%>'></asp:HyperLink>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:TemplateField>
                            </Columns>
