<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master" AutoEventWireup="true" CodeFile="Application_report.aspx.cs" Inherits="Portal_Report_Application_report" %>
                       ...
                       <li><a  href="javascript:history.back()" data-tooltip="Back" data-toggle="tooltip" data-title="Back" ><i class="panel-control-icon fa  fa-chevron-circle-left"></i></a></li>
                        ...
                        <div class="panel-body">
                            ...
                            <Columns>
                                  ...
                                  <%-- <asp:BoundField HeaderText="Application No." DataField="VCH_APPLICATION_UNQ_KEY" NullDisplayText="--"  />--%>
