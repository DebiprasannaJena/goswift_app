...
public partial class Portal_Service_ViewServiceTakeActionBYDimAuth : SessionCheck
{
    ...
    protected void gvService_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            hyRcvd.NavigateUrl = "ApplicationDetails.aspx?UnqKey=" + gvService.DataKeys[e.Row.RowIndex].Values[1];
            ...
            {
                hplnkCertificate.NavigateUrl = "../ApprovalDocs/" + gvService.DataKeys[e.Row.RowIndex].Values[4].ToString();
                hplnkCertificate.Visible = true;
            }
            else
            {
                hplnkCertificate.Visible = false;
            }
