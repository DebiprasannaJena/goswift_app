<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewServiceTakeActionBYDimAuth.aspx.cs" MasterPageFile="~/MasterPage/Application.master" Inherits="Portal_Service_ViewServiceTakeActionBYDimAuth" %>
                ...
                <Columns>
                      ...
                      <asp:TemplateField  ItemStyle-HorizontalAlign="Left">
                       ...
                       <HeaderTemplate>
                                        ...
                                        <ItemTemplate>
                                         <asp:HyperLink ID="hplnkCertificate" NavigateUrl='<%#Eval("strReferenceFilename") %>' runat="server" Target="_blank" ToolTip="Download Certificate">
