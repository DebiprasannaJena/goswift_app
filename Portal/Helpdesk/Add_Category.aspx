<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master" AutoEventWireup="true" CodeFile="Add_Category.aspx.cs" Inherits="Portal_HelpDesk_Add_Category" %>
  ...
  <script src="../js/jquery.min.js" type="text/javascript"></script>
    <script type="text/javascript" language="javascript">
        ...
        function validation() {
            ...
            if ($('#ContentPlaceHolder1_ddlType').val() == 0) {
                jAlert('Please Select Type !');
                $('#ContentPlaceHolder1_ddlType').focus()
                return false;
            }
            if ($('#ContentPlaceHolder1_txtCategory').val() == '') {
                jAlert('Please Select Category Name !');
                $('#ContentPlaceHolder1_txtCategory').focus()
                return false;
            }
                ...
                <div class="panel-heading">
                    ...
                    <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   ...
                                   <label class="col-sm-2">Category Name <span class="text-red">*</span></label>
                                <div class="col-sm-3">
                                        <span class="colon">:</span>
                                      
                                    <asp:TextBox ID="txtCategory" MaxLength="100"  CssClass="form-control" runat="server"
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                                     ...
                                                     <asp:Button ID="btnSave" 
                                                             ...
                                                             CssClass="btn btn btn-warning" runat="server" Text="Cancel" onclick="btnCancel_Click"  
                                                             ></asp:Button>
