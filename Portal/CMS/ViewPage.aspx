<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master" AutoEventWireup="true" CodeFile="ViewPage.aspx.cs" Inherits="Portal_CMS_ViewPage" %>
                     ...
                     <div class="panel panel-bd lobidisable">
                        <div class="panel-heading">
                           <div class="btn-group buttonlist" > 
                              <a class="btn btn-add " href="DynamicContent.aspx?linkm=<%=Request.QueryString["linkm"]%>&linkn=<%= Request.QueryString["linkn"]%>&btn=<%=Request.QueryString["btn"]%> &tab=<%=Request.QueryString["tab"]%> <%=Request.QueryString["index"]%> "> 
                         ...
                         <div class="col-md-3 col-sm-3"><span class="colon">:</span>                        
                          ...
                          <div class="col-md-2 col-sm-2">
                            ...
                            <div class="table-responsive">
                                ...
                                DataKeyNames="Templateid,pagename" onrowdatabound="GrdViewData_RowDataBound" 
                              ...
                              <%--  <asp:BoundField HeaderText="Layout Name" DataField="Template" />--%>
                                ...
                                <asp:BoundField HeaderText="Created On" DataField="dtmCreatedOn" ItemStyle-Width="20%" />
