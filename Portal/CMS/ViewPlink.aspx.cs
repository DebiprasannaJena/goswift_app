...
public partial class Portal_CMS_ViewPlink : System.Web.UI.Page
{
    ...
    private void FillGlink()
    {
        ...
        {
            obj.actioncode = "I";
            newlist = objbusiness.GlinkList(obj);
    ...
    protected void FILLGRID()
    {
        ...
        {
            obj.actioncode = "R";
            obj.pagename = txtPageName.Text.TrimEnd();
            obj.Plink = txtplink.Text.TrimEnd();
            obj.Glinkid = Convert.ToInt32(ddlGlink.SelectedValue);
            newlist = objbusiness.ViewPlinkDetails(obj);
    ...
    protected void GrdViewData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "delete")
            {
                ...
                obj.actioncode = "T";
                obj.Plinkid = Convert.ToInt32(GrdViewData.DataKeys[gvr.RowIndex].Values["Plinkid"].ToString());
                str_Retvalue = objbusiness.AddPlinkDetails(obj);
                if (str_Retvalue == "3")
                {
    ...
    protected void GrdViewData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hypEdit.NavigateUrl = "addPlink.aspx?ID=" + GrdViewData.DataKeys[e.Row.RowIndex].Value;
