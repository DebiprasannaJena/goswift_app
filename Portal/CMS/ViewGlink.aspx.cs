...
public partial class Portal_CMS_ViewGlink : System.Web.UI.Page
{
    ...
    protected void FILLGRID()
    {
        ...
        {
            obj.actioncode = "AA";
            obj.Glink = txtGlink.Text.TrimEnd();
            newlist = objbusiness.ViewGlinkDetails(obj);
    ...
    protected void GrdViewData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "delete")
            {
                ...
                obj.actioncode = "AD";
                obj.Glinkid = Convert.ToInt32(GrdViewData.DataKeys[gvr.RowIndex].Values["Glinkid"].ToString());
                str_Retvalue = objbusiness.AddGlinkDetails(obj);
                if (str_Retvalue == "3")
                {
    ...
    protected void GrdViewData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hypEdit.NavigateUrl = "AddGlink.aspx?ID=" + GrdViewData.DataKeys[e.Row.RowIndex].Value;
