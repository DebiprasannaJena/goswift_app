<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ForwardProjectAdd.aspx.cs"
    Inherits="SingleWindow_ForwardProjectAdd" %>
           ...
           <div class="row">
                ...
                <div class="panel-heading">
                    <div class="btn-group buttonlist">
                        <a class="btn btn-add active" href="ForwardProjectAdd.aspx"><i class="fa fa-plus"></i>Add
                             </a>
                    </div>
                    <div class="btn-group buttonlist">
                        <a class="btn btn-add " href="ForwardProjectView.aspx"><i class="fa fa-file"></i>View
                             </a>
                    </div>
                </div>                           
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="viewTable" id="viewTable">
                                        <asp:GridView ID="grdProjmst" runat="server" Width="100%" AllowPaging="True"
                                            AutoGenerateColumns="False" DataKeyNames="ProposalId,DetailsId,FinanceId,INTSTATUS,INTPROJCTID,Feedback,NOOFMEMBER,NOOFDAYS,FinanceDoc,REOPENSTATUS"
                                            OnRowCommand="grdProjmst_RowCommand"  class="table table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Details">
                                                    <ItemTemplate>
                                                        <a href="ProjectDetails.aspx?ID=<%# Eval("INTPROJCTID") %>" id="Dtls" title="Details" target="_blank"><i
                                                            class="fa fa-list-alt"></i></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Forward To <br />SLFC Member">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnSLFC" runat="server" Text="Forward" CommandName="SLFC" class="btn btn-sm btn-danger"  OnClientClick="return confirm(' Are you sure want to forward?')" />
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Forward To <br />GM(SLNA)">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnGM" runat="server" Text="Forward" CommandName="GM" class="btn btn-sm btn-danger"  OnClientClick="return confirm(' Are you sure want to forward?')" />
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="10%" />
                                                </asp:TemplateField>
                                            </Columns>
