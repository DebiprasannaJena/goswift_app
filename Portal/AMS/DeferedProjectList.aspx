<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeferedProjectList.aspx.cs" Inherits="SingleWindow_DeferedProjectList" %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="panel-heading">
                    ...
                    <div class="btn-group buttonlist">
                        <a class="btn btn-add active" href="DeferedProjectList.aspx"><i class="fa fa-file"></i>Reject
                        </a>
                    </div>
                </div>
                            ...
                            <asp:UpdatePanel ID="updPanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="viewTable" id="viewTable">
                                        ...
                                        AutoGenerateColumns="False" OnPageIndexChanging="grdProjmst_PageIndexChanging"
                                         DataKeyNames="INTPROJCTID"  class="table table-bordered table-hover">
                                            <Columns>
