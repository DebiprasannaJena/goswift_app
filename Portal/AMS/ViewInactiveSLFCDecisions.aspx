<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewInactiveSLFCDecisions.aspx.cs"
    Inherits="SingleWindow_ViewInactiveSLFCDecisions" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Validation() {
            if (!ConfirmAction('btnSubmit', 'Are you sure want to Active ?')) {
                return false;
            }
        }
            ...
            <section class="content">
               <div class="row">
                ...
                <div class="panel-heading">
                    ...
                    <div class="btn-group buttonlist">
                        <a class="btn btn-add " href="ViewSLFCDecisionMaster.aspx"><i class="fa fa-file"></i>
                            Active </a>
                    </div>
                    <div class="btn-group buttonlist">
                        <a class="btn btn-add active" href="ViewInactiveSLFCDecisions.aspx"><i class="fa fa-file">
                        </i>Inactive </a>
                    </div>
                </div>
                                                    ...
                                                    <div class="table-responsive" id="printArea">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                                ...
                                                                <td>
                                                                    <div class="viewTable" id="viewTable">
                                                                        <asp:GridView ID="grdViwComments" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                            AllowSorting="true" PageIndex="10"
                                                                               class="table table-bordered table-hover"  DataKeyNames="bitDeletedFlag,ChecklistId">
                                                                            <RowStyle CssClass="tdData2" />
                                                                            <Columns>
                                                                                <asp:TemplateField ItemStyle-CssClass="NOPRINT" HeaderStyle-CssClass="NOPRINT" ItemStyle-Width="10px">
                                                                                    <HeaderTemplate>
                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0" class="addTable">
                                                                <tr>
                                                                    <td align="center">
                                                                        <asp:Button ID="btnSubmit" runat="server" Text="Make Active" CssClass="btn btn-primary"
