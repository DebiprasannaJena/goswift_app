...
public partial class SingleWindow_ProjectDetails : System.Web.UI.Page
{
    ...
    private void GetDetails()
    {
        ...
        try
        {
            ...
            if ((ds.Tables[8].Rows.Count > 0) && (Convert.ToInt32(ds.Tables[8].Rows[0]["intType"]) == 2))
            {
                feedback.Visible = true;
                lblfeedback.Text = Convert.ToString(ds.Tables[8].Rows[0]["VCHCOMMENT"]);
            }
            else
            { 
