...
function page_content_onresize() {
    ...
    if (content.height() < $(document).height() - content_minus - 20) {
        content.height($(document).height() - content_minus - 20);
    }
    ...
    if ($(window).width() > 1024) {
        ...
        if ($(".content-frame-body").height() < $(document).height() - 50) {
            $(".content-frame-body,.content-frame-right,.content-frame-left").height($(document).height() - 50);
        } else {
        ...
        $(".content-frame-body").height($(".content-frame").height() - 20);
