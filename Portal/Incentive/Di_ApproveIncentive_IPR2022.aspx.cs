...
public partial class Portal_Incentive_Di_ApproveIncentive_IPR2022 : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (str_Retvalue == "1")
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "OnClick", "<script> jAlert('<strong>Data Saved Successfully !', '" + Messages.TitleOfProject + "', function () {location.href = './Di_View_Inct_Application_IPR2022.aspx';}); </script>", false);
                return;
            }
        }
        catch (Exception ex)
