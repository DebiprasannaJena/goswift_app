<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="IRForm.aspx.cs" Inherits="Portal_Incentive_IRForm" %>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <asp:TextBox ID="txtOwnerName" MaxLength="100" CssClass="form-control" runat="server"
                                                    Style="width: 65%; margin-right: 10px; float: left;"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <div class="row">
                                                    <div class="col-sm-12  margin-bottom10">
                                                        <table class="table table-bordered" id="tblPlantMachinery" runat="server">
                                                            <tr>
                                                                <th style="width: 15%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtAmt" runat="server" MaxLength="10" Width="50%" CssClass="form-control"
                                                                        onkeypress="return FloatOnly(event, this);" onblur="isNumberBlur(event, this, 2);"></asp:TextBox>
                                                                    <cc1:FilteredTextBoxExtender ID="fteAmt" TargetControlID="txtAmt" runat="server"
                                                                        FilterType="Custom,Numbers" ValidChars=".">
                                                                    </cc1:FilteredTextBoxExtender>
                                                                </td>
                                                                <td>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <table id="tblOther" runat="server" class="table table-bordered">
                                                            <tr>
                                                                <th style="width: 20%;">
                                                                    Unit Name
                                                                </th>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:TextBox ID="txtUnit" MaxLength="100" CssClass="form-control" runat="server"></asp:TextBox>
                                                                    <cc1:FilteredTextBoxExtender ID="fteUnit" runat="server" FilterMode="InvalidChars"
                                                                        InvalidChars=":&quot;1234567890~!@#$%^&amp;*()?&gt;&lt;,{}+=[];',/|\_-~`" TargetControlID="txtUnit">
                                                                    </cc1:FilteredTextBoxExtender>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtProduct" MaxLength="100" CssClass="form-control" runat="server"></asp:TextBox>
                                                                    <cc1:FilteredTextBoxExtender ID="fteProduct" runat="server" FilterMode="InvalidChars"
                                                                        InvalidChars=":&quot;1234567890~!@#$%^&amp;*()?&gt;&lt;,{}+=[];',/|\_-~`" TargetControlID="txtProduct">
                                                                    </cc1:FilteredTextBoxExtender>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtCapacity" CssClass="form-control" runat="server" MaxLength="6"></asp:TextBox>
                                                                    <cc1:FilteredTextBoxExtender ID="fteCapacity" TargetControlID="txtCapacity" runat="server"
                                                                        FilterType="Numbers">
                                                                    </cc1:FilteredTextBoxExtender>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkOthersAdd" CssClass="btn btn-success btn-sm" runat="server"
                                                                        CommandName="add" OnClick="lnkAdd_Click"><i class="fa fa-plus-square" ></i></asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                        </table>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <table id="tblApplied" runat="server" class="table table-bordered">
                                                            <tr>
                                                                <th rowspan="2" style="width: 35%;">
                                                                    Incentive Type
                                                                </th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtQuantam" runat="server" CssClass="form-control exp" MaxLength="13"
                                                                        onkeypress="return FloatOnly(event, this);" onblur="isNumberBlur(event, this, 2);"></asp:TextBox>
                                                                    <cc1:FilteredTextBoxExtender ID="fteQuantam" TargetControlID="txtQuantam" runat="server"
                                                                        FilterType="Custom,Numbers" ValidChars=".">
                                                                    </cc1:FilteredTextBoxExtender>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkAppliedAdd" CssClass="btn btn-success btn-sm" runat="server"
                                                                        CommandName="add" OnClick="lnkAdd_Click"><i class="fa fa-plus-square" ></i></asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <asp:TemplateField HeaderText="Remarks">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <small>&nbsp;(Maximum&nbsp;
                                                                            ...
                                                                            &nbsp; characters allowed)</small>
                                                                        <cc1:FilteredTextBoxExtender ID="fteProblems" runat="server" FilterMode="InvalidChars"
                                                                            InvalidChars=":&quot;~!@#$%^&amp;*()?&gt;&lt;{}+=[];'|\~`" TargetControlID="txtProblems">
                                                                        </cc1:FilteredTextBoxExtender>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <small>&nbsp;(Maximum&nbsp;
                                                            ...
                                                            &nbsp; characters allowed)</small>
                                                        <cc1:FilteredTextBoxExtender ID="fteRemarks" runat="server" FilterMode="InvalidChars"
                                                            InvalidChars=":&quot;~!@#$%^&amp;*()?&gt;&lt;{}+=[];'|\~`" TargetControlID="txtRemarks">
                                                        </cc1:FilteredTextBoxExtender>
                                                    </div>
                                                    <label class="col-sm-2">
                                                        Suggestions/Views
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <small>&nbsp;(Maximum&nbsp;
                                                            ...
                                                            &nbsp; characters allowed)</small>
                                                        <cc1:FilteredTextBoxExtender ID="fteSuggestions" runat="server" FilterMode="InvalidChars"
                                                            InvalidChars=":&quot;~!@#$%^&amp;*()?&gt;&lt;{}+=[];'|\~`" TargetControlID="txtSuggestions">
                                                        </cc1:FilteredTextBoxExtender>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <ContentTemplate>
                    <div class="form-group">
                        <div class="row" id="divSignatureUpload" runat="server">
                            <label class="col-sm-4">
                                Signature & designation of Inspecting Officer of RIC/ DIC/ DI, Odisha,<asp:Label
                                    ID="lblDist" runat="server" Text="Label"></asp:Label>
                                with Date</label>
                            <div id="dvsig" class="col-sm-6">
                                <div class="input-group">
                                    <span class="colon">:</span>
                            ...
                            <div id="dvSign" class="col-sm-6" runat="server">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <asp:Button ID="btnConfirm" runat="server" Text="Submit" CssClass="btn btn-success"
                            CommandArgument="s" OnClick="btnConfirm_Click" OnClientClick="return ValidatePage(this);" />
