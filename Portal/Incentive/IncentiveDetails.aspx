<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="IncentiveDetails.aspx.cs" Inherits="Portal_Incentive_IncentiveDetails" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-sm-2">
                                        Code(Code may be entered as per NIC 2008)
                                    </label>
                                    <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <asp:UpdatePanel ID="up3" runat="server">
                                    <ContentTemplate>
                                        <div class="row">
                                            <div class="col-sm-12  margin-bottom10">
                                                <table class="table table-bordered" id="tblProducts" runat="server" visible="false">
                                                    <tr>
                                                        <th>
                                                            Item Product
                                                        </th>
