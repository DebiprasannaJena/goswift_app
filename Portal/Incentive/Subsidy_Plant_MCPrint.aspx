                                                                ...
                                                                <div class="col-sm-12">
                                                                    <table class="table table-bordered">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:Label runat="server" ID="lblLoading" Text="Loading, On-Loading, Transportation , Duties,Tax,INCTC"></asp:Label>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                -
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:Label ID="lblIDCOShed" Text="IDCO Shed" runat="server"></asp:Label>
                                                                            </td>
                                                                            <td class="text-right">
                                                                                -
                                                                            </td>
