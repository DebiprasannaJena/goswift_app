/*
 * File name : IRForm.aspx.cs
 * Created By : Ritika Lath
 * Description : TO show the IR Details
 */
...
public partial class Portal_Incentive_IRForm : SessionCheck
{
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                if (Request.QueryString["type"] != null)
                {
                    ...
                    tblPlantMachinery.Visible = false;
    ...
    protected void btnApprove_click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            int Retval = objBuisnessLayer.Incentive_PcDetails_Approve(objMaster);
            if (Retval == 1)
            {
                //  SMSEmailContent();
