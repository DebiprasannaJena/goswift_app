...
public partial class Portal_Incentive_PcPrint : SessionCheck
{
    ...
    private void GetApplicationDetails()
    {
        ...
        if (Request.QueryString["type"] != null) //if redirected from generate pc page
        {
            ...
            {
                Response.Redirect(string.Format("ProductionCertificate.aspx?ID={0}&linkm={1}&linkn={2}&btn={3}&tab={4}&ranNum={5}&pcupstat={6}';", Request.QueryString["ID"], Request.QueryString["linkm"], Request.QueryString["linkn"], Request.QueryString["btn"], Request.QueryString["tab"], Session["RandomNo"], 5), false);
            }
        }
    }
