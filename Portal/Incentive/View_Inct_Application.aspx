...
'   <CR no.>                          <Date>                <Modified by>        <Modification Summary>                   <Instructed By>                                                     
        1                           14th Sept 2017          Sushant Kumar Jena      Coding Started
        2                           10th Oct 2017           Pranay Kumar            Implementation of Query Management 
'   *********************************************************************************************************************--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="View_Inct_Application.aspx.cs" Inherits="Portal_Incentive_View_Inct_Application" %>
                        ...
                        <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            <asp:DropDownList ID="DrpDwn_Status" CssClass="form-control" runat="server">
                                                ...
                                                <asp:ListItem Value="4">Provisional Pending</asp:ListItem>
                                                <asp:ListItem Value="5">Provisional Approved</asp:ListItem>
                                                <asp:ListItem Value="3">Rejected</asp:ListItem>
                                                <asp:ListItem Value="7">Approved & Disbursed</asp:ListItem>
                                                <%-- <asp:ListItem Value="1">Scrutiny in Progress</asp:ListItem>--%>
                                                <%-- <asp:ListItem Value="4">Query Raised</asp:ListItem>
                                                        <asp:ListItem Value="5">Scrutiny not Initiated</asp:ListItem>--%>
                                            </asp:DropDownList>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="Grd_Application" runat="server" AutoGenerateColumns="false" class="table table-bordered table-hover"
                                    OnRowCommand="Grd_Application_RowCommand" OnRowDataBound="Grd_Application_RowDataBound"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Application No." ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="LnkBtn_View_Application" runat="server" Text='<%# Eval("strApplicationNum") %>'
                                                ...
                                                <asp:HiddenField ID="hdnEmpowerStatus" runat="server" Value='<%# Eval("intEmpowerment") %>' />
                                        ...
                                        <asp:TemplateField HeaderText="Applied On">
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdnProvisional" runat="server" Value='<%#Eval("IsProvisional")%>'>
                                                </asp:HiddenField>
                                                <asp:HiddenField ID="hdnAppStatus" runat="server" Value='<%#Eval("INTSTATUS")%>'>
                                                </asp:HiddenField>
                                                <asp:HiddenField ID="hdnDisburseStatus" runat="server" Value='<%#Eval("intDisburseStatus")%>'>
                                                </asp:HiddenField>
                                                <asp:HiddenField ID="hdnDisburseType" runat="server" Value='<%#Eval("intDisburseType")%>'>
                                                </asp:HiddenField>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Action" HeaderStyle-CssClass="noPrint" FooterStyle-CssClass="noPrint">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="lbtnDisbursedDtls" runat="server" class="btn btn-success btn-sm"
                                                    data-toggle="modal" data-target='<%# "#D" +Eval("INTINCUNQUEID")%>'></asp:LinkButton>
