<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IRPrint_large.aspx.cs" Inherits="Portal_Incentive_IRPrint_large" %>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <span class="colon">:</span>
                                                        <asp:TextBox ID="txtEin" runat="server" MaxLength="9" CssClass="form-control" Onkeypress="return inputLimiter(event,'a')"
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <span class="colon">:</span>
                                                        <asp:TextBox ID="txtUan" runat="server" MaxLength="9" CssClass="form-control" Onkeypress="return inputLimiter(event,'Numbers')"
                                                            Enabled="false"></asp:TextBox>
                                                    </div>
                                                    <label class="col-sm-2">
                                                        GSTIN
                                                    ...
                                                    <div class="col-sm-4">
                                                        <span class="colon">:</span>
                                                        <asp:TextBox ID="txtGST" runat="server" MaxLength="15" CssClass="form-control" Onkeypress="return inputLimiter(event,'NameCharactersAndNumbers')"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <span class="colon">:</span>
                                                        <asp:TextBox ID="txtGeneral" runat="server" CssClass="form-control" Onkeypress="return
                inputLimiter(event,'Numbers')" MaxLength="4" Text="0" ClientIDMode="Static"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <span class="colon">:</span>
                                                        <asp:TextBox ID="txtTotalSc" runat="server" CssClass="form-control" Onkeypress="return
                inputLimiter(event,'Numbers')" MaxLength="4" Text="0" ClientIDMode="Static"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <asp:TextBox ID="txtUnskilled" MaxLength="4" CssClass="form-control" runat="server"
                                                            Onkeypress="return
                inputLimiter(event,'Numbers')" ClientIDMode="Static"></asp:TextBox>
                                                    </div>
                                                    <label class="col-sm-2">
                                                        Total Women</label>
                                                    <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <span class="colon">:</span>
                                                        <asp:TextBox ID="txtPhd" MaxLength="4" CssClass="form-control" runat="server" Onkeypress="return
                inputLimiter(event,'Numbers')" ClientIDMode="Static"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <asp:TemplateField HeaderText="As per DPR">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtAsPerDpr" runat="server" CssClass="form-control dpr" MaxLength="13"
                                                                            ...
                                                                            onblur="isNumberBlur(event,
                this, 2);" Text='<%#Eval("decAsPerDpr") %>'></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <span class="spDpr"></span>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <%--    <asp:TemplateField HeaderText="Original expenditure incurred) (prior to E/M/D)">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtOriginalExpIncuured" runat="server" CssClass="form-control exps"
                                                                    MaxLength="13" Onkeypress="return inputLimiter(event,'Decimal')" onkeydown="return isNumberDecimalKey(event,
                this, 2);" onblur="isNumberBlur(event, this, 2);" Text='<%#Eval("decActualExp")
                %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <span class="spExps"></span>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>--%>
                ...
                incurred">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtActualExpIncuured" runat="server" CssClass="form-control exp"
                                                                            ...
                                                                            onblur="isNumberBlur(event,
                this, 2);" Text='<%#Eval("decActualExp") %>'></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="table-fixedh">
                                                                    <asp:GridView ID="grdTermLoan" runat="server" AutoGenerateColumns="false" EmptyDataText="No
                Records Found" CssClass="table table-bordered" OnRowCreated="grdTermLoan_RowCreated" OnRowDataBound="grdTermLoan_RowDataBound" OnRowCommand="grdCommon_RowCommand"
                                                                        DataKeyNames="id">
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Sl#" ItemStyle-Width="2%">
                                                                                <ItemTemplate>
                                                                ...
                                                                <div class="table-fixedh">
                                                                    <asp:GridView ID="grdWorkingCapital" runat="server" AutoGenerateColumns="false" EmptyDataText="No Records Found"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField HeaderText="Sanction
                Date" DataField="SanctionDate" ItemStyle-Width="15%" />
                                                                            <asp:BoundField HeaderText="Availed
                Amount" DataField="AvailedAmt" ItemStyle-Width="15%" />
                                                                            <asp:BoundField HeaderText="Availed
                Date" DataField="AvailedDate" ItemStyle-Width="15%" />
                                                                            <asp:TemplateField HeaderText="Action" ItemStyle-Width="5%">
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton ID="lnkDelete" CssClass="btn
                btn-warning btn-sm" runat="server" CommandArgument="<%#Container.DataItemIndex%>" CommandName="D"><i class="fa fa-trash" ></i></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                        </Columns>
                                                                    </asp:GridView>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="table-fixedh">
                                                                    <asp:GridView ID="grdApproval" runat="server" AutoGenerateColumns="false" EmptyDataText="No Records
                Found" CssClass="table table-bordered" OnRowCommand="grdCommon_RowCommand" OnRowDataBound="grdApproval_RowDataBound" DataKeyNames="id">
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Sl#" ItemStyle-Width="2%">
                                                                                <ItemTemplate>
                                                                                    <%#Container.DataItemIndex+1 %>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Supporting Document" ItemStyle-Width="30%">
                                                                                <ItemTemplate>
                                                                                    <asp:HyperLink CssClass="input-group-addon bg-blue" ID="hypViewProductFile" Visible="false"
                                                                                        runat="server" Target="_blank" Style="background: #31b0d5 !important; color: #FFF
                !important;"> <i class="fa fa-download"></i></asp:HyperLink>
                                                                                    </div>
