<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgotpass.aspx.cs" Inherits="Portal_forgotpass" %>
...
<body>
 ...
 <div>
    ...
    <p class="forgot"><a href="Default.aspx" id="forgotPwdLink">Back to login </a> 
        ...
        <asp:Button class="button button-block" ID="btnSubmit" runat="server" Text="Submit" 
                                             />
