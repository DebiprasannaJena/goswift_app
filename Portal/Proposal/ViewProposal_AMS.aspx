<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="ViewProposal_AMS.aspx.cs" Inherits="Mastermodule_ViewProposal_AMS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        /*added by Ritika Lath on 23rd Feb 2018*/
        function ValidateAMS() {
            if (!DropDownValidation("ContentPlaceHolder1_drpNodalOffcr", '0', 'Nodal Officer', 'GO-SWIFT')) {
                $("#popup_ok").click(function () { $("#ContentPlaceHolder1_drpNodalOffcr").focus(); });
                return false;
            }
            else {
                if (confirm("Are you sure you want to forward the Proposal?")) {
                    return true;
                }
                else {
                    return false;
        ...
        $(document).ready(function () {
            ...
            var txtgmComments = $("#ContentPlaceHolder1_txtGmComments").val();
            if (txtgmComments != null && txtgmComments != undefined && txtgmComments != '') {
                CheckLengthKeyUp('ContentPlaceHolder1_txtGmComments', 'ContentPlaceHolder1_lblGmComments', 500);
            }
        });
        ...
        function setvaluesOfrowAMS(flu) {
            ...
            document.getElementById('ContentPlaceHolder1_hdnNodalOfficer').value = document.getElementById('ContentPlaceHolder1_gvService_hdnNodalOfficerId_' + rows).value;
            var nodalOfficerId = document.getElementById('ContentPlaceHolder1_hdnNodalOfficer').value;
            if (nodalOfficerId != null && nodalOfficerId != undefined && nodalOfficerId != '') {
                if (nodalOfficerId > 0) {
                    $("#ContentPlaceHolder1_drpNodalOffcr").attr("disabled", "disabled");
                    $("#ContentPlaceHolder1_drpNodalOffcr").val(nodalOfficerId);
                }
            }
            var AmsQueryStatus = document.getElementById('ContentPlaceHolder1_gvService_hdnAmsQueryStatus_' + rows).value;
            if (AmsQueryStatus != null && AmsQueryStatus != undefined && AmsQueryStatus != '') {
                if (AmsQueryStatus == "1" || AmsQueryStatus == "0") {
                    $("#ContentPlaceHolder1_btnForwardToNodal").css("display", "none");
                    $("#ContentPlaceHolder1_btnClarification").css("display", "none");
                }
                else if (AmsQueryStatus == "2") {
                    $("#ContentPlaceHolder1_btnSubmitAMS").css("display", "none");
                    $("#ContentPlaceHolder1_btnForwardToNodal").css("display", "none");
                    $("#ContentPlaceHolder1_btnClarification").css("display", "inline");
                }
                else if (AmsQueryStatus == "3" || AmsQueryStatus == "5") {
                    $("#ContentPlaceHolder1_btnSubmitAMS").css("display", "none");
                    $("#ContentPlaceHolder1_btnForwardToNodal").css("display", "inline");
                    $("#ContentPlaceHolder1_btnClarification").css("display", "none");
                }
            }
            clear();
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvService" class="table table-bordered table-hover" runat="server"
                                    ...
                                    Width="100%" EmptyDataText="No Record(s) Found..." DataKeyNames="intProposalId,intActionToBeTakenBy,strFileName,intQueryStatus,strQueryStatus,intStatus,strStatus,intidcoCnt,decRecomendLand,intFowardAMS,intForwardIDCO,strDeptMailContent"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdnAmsQueryStatus" runat="server" Value='<%# Eval("intAmsQueryStatus")%>' />
                                                <asp:HiddenField ID="hdnNodalOfficerId" runat="server" Value='<%# Eval("intNodalOfficerId")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <div class="panel panel-bd ">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group" id="Div4">
                                                    <label class="col-md-2">
                                                        Land Required By Investor(in acre)</label>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="form-group" id="Div5">
                                                    <label class="col-md-2">
                                                        Land Recommended By SLFC(in acre)</label>
                                                    <div class="col-md-4">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group" id="Dvlandwee">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:HiddenField ID="hdnNodalOfficer" runat="server"></asp:HiddenField>
                                                    </div>
                                                    <div class="clearfix">
                                                    </div>
                                                </div>
                                                <div class="form-group" id="divGmComments" runat="server">
                                                    <label class="col-md-2">
                                                        Comments:</label>
                                                    <div class="col-md-4">
                                                        <asp:TextBox ID="txtGmComments" runat="server" TextMode="MultiLine" Rows="4" Columns="10"
                                                            MaxLength="500" CssClass="form-control"></asp:TextBox>
                                                        <small>&nbsp;(Maximum&nbsp;
                                                            <asp:Label ID="lblGmComments" runat="server" Text="500" ForeColor="Red"></asp:Label>
                                                ...
                                                <div class="col-md-10 col-sm-offset-2 form-group user-form-group">
                                                    <asp:Button ID="btnSubmitAMS" runat="server" Text="Save" class="btn btn-add btn-sm"
                                                        OnClick="btnSubmitAMS_Click" OnClientClick="return ValidateAMS();" />
                                                    <asp:Button ID="btnForwardToNodal" runat="server" Text="Forward for Agenda" OnClick="btnForwardToNodal_Click"
                                                        class="btn btn-add btn-sm" OnClientClick="return confirm('Are you sure you want to Forward for Agenda?');" />
                                                    <asp:Button ID="btnClarification" runat="server" Text="Forward for Clarification"
                                                        OnClick="btnClarification_Click" class="btn btn-add btn-sm" OnClientClick="return confirm('Are you sure you want to Forward for clarification?');" />
