<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    EnableEventValidation="false" AutoEventWireup="true" CodeFile="ViewProposal.aspx.cs"
    Inherits="Mastermodule_ViewProposal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#txtRemarks').keyup(function () {
                ...
                if (textLength > ml) {
                    ...
                    alert("sorry, you only" + ml + "characters are allowed");
                }
                //                else {
                //                    $("#Label3").text((ml - textLength) + "characters left");
                //                }
            });
        ...
        function setvaluesOfrow(flu) {
            ...
            document.getElementById('ContentPlaceHolder1_lblProposalNoAction').innerText = document.getElementById('ContentPlaceHolder1_gvService_hdnTextVal_' + rows).value;
            document.getElementById('ContentPlaceHolder1_lblIndustryNameAction').innerText = document.getElementById('ContentPlaceHolder1_gvService_hdnIndustryName_' + rows).value;
            ...
            document.getElementById('ContentPlaceHolder1_ddlIDCOName').value = document.getElementById('ContentPlaceHolder1_gvService_hdnIndustrialName_' + rows).value;
            document.getElementById('ContentPlaceHolder1_ddlLandacquiredIDCO').value = document.getElementById('ContentPlaceHolder1_gvService_hdnLandAquiredByidco_' + rows).value;
            document.getElementById('ContentPlaceHolder1_hdnDistValu').value = document.getElementById('ContentPlaceHolder1_gvService_hdnDistId_' + rows).value;

            var k = document.getElementById('ContentPlaceHolder1_lblProposalNoAction').value;
            var s = document.getElementById('ContentPlaceHolder1_lblIndustryNameAction').value;

            $.ajax({
                type: "POST",
                url: "ViewProposal.aspx/FillIndustry",
                data: "{'id':" + document.getElementById('ContentPlaceHolder1_hdnDistValu').value + "}",
                ...
                success: function (r) {
                    ...
                    var SValue = document.getElementById('ContentPlaceHolder1_gvService_hdnIndustrialName_' + rows).value
                    $(".divi").val(SValue);
                }
            });

            clear();
            //            alert(document.getElementById('ContentPlaceHolder1_gvService_hdnIndustrialName_' + rows).value);
            //            document.getElementById('ContentPlaceHolder1_ddlIDCOName').value = document.getElementById('ContentPlaceHolder1_gvService_hdnIndustrialName_' + rows).value;
        }
        ...
        function setvaluesOfrow1(flu) {
            ...
            document.getElementById('ContentPlaceHolder1_lblProposalNoIDCO').innerText = document.getElementById('ContentPlaceHolder1_gvService_hdnTextVal_' + rows).value;
            document.getElementById('ContentPlaceHolder1_lblIndustryNameIDCO').innerText = document.getElementById('ContentPlaceHolder1_gvService_hdnIndustryName_' + rows).value;

            var k = document.getElementById('ContentPlaceHolder1_lblProposalNoIDCO').value;
            var s = document.getElementById('ContentPlaceHolder1_lblIndustryNameIDCO').value;
        ...
        function setvaluesOfrowAMS(flu) {
            ...
            document.getElementById('ContentPlaceHolder1_lblProposalNoAMS').innerText = document.getElementById('ContentPlaceHolder1_gvService_hdnTextVal_' + rows).value;
            document.getElementById('ContentPlaceHolder1_lblIndustryNameAMS').innerText = document.getElementById('ContentPlaceHolder1_gvService_hdnIndustryName_' + rows).value;

            var k = document.getElementById('ContentPlaceHolder1_lblProposalNoAMS').value;
            var s = document.getElementById('ContentPlaceHolder1_lblIndustryNameAMS').value;
        ...
        function validateFile(e, allowSize) {
            var ids = e.id;
            ...
            if ($.inArray($("#" + ids).val().split('.').pop().toLowerCase(), fileExtension) == -1) {
                ...
                if ((e.files[0].size > parseInt(allowSize * 1024 * 1024)) && ($("#" + ids).val() != '')) {
                    var alertMsg = '<strong>File size must be less than ' + allowSize + ' MB !</strong>';
                    jAlert(alertMsg, projname);
                    $("#" + ids).val(null);
                    //e.preventDefault();
                    return false;
                }
        ...
        function valid() {
            ...
            if (document.getElementById('ContentPlaceHolder1_txtActionDate').value == '') {
                jAlert('<strong>Date can not be left blank !</strong>', projname);
                document.getElementById('ContentPlaceHolder1_txtActionDate').focus();
                return false;
            }

            if (Date.parse(document.getElementById('ContentPlaceHolder1_txtActionDate').value) > new Date()) {
                jAlert('<strong>Approval / Reject / Deferred date can not be greater than current date !</strong>', projname);
                document.getElementById('ContentPlaceHolder1_txtActionDate').focus();
                return false;
            }
        ...
        function valid1() {
            ...
            if (document.getElementById('ContentPlaceHolder1_docIdcoDoc').value == '') {
                jAlert('<strong>Please upload Document !</strong>', projname);
                document.getElementById('ContentPlaceHolder1_docIdcoDoc').focus();
                return false;
            }
            var r = confirm("Are you sure you want to submit!");
            if (r == true) {
        ...
        function clear() {
            ...
            document.getElementById('ContentPlaceHolder1_drpStatus').value = "0";
            $('input[name=count]').val('1000');            
        }
        ...
        function Queryvalid(obj) {
            ...
            if ($('#ContentPlaceHolder1_gvService_FileUpload1_' + arr[3]).val() != "") {
                if (!DocValidCerti('#ContentPlaceHolder1_gvService_FileUpload1_' + arr[3])) { return false; }
            }
        }
        ...
        <div class="content-header">
            ...
            <div class="header-title">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a>Proposal</a></li>
                    <li><a>View And Take Action</a></li>
                </ul>
            </div>
        </div>
        <!-- Main content -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvService" class="table table-bordered table-hover" runat="server"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="Sl No." ItemStyle-Width="4%" />
                                        ...
                                        <%--
                                         <asp:BoundField  HeaderText="Applied District/Block" />
                                          <asp:BoundField  HeaderText="Recommended District/Block" />--%>
                                        <asp:BoundField DataField="dtmCreatedOn" HeaderText="Application Date" />
                                        <%-- <asp:BoundField DataField="strActionToBeTakenBY" HeaderText="Action To Be Taken By" />--%>
                                        <%-- <asp:BoundField DataField="strActionTakenBY" HeaderText="Action Taking Authority" />--%>
                                       ...
                                       <%-- <asp:TemplateField>
                                           <%-- <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hdnTextValAMS" runat="server" Value='<%# Eval("strFileName")%>'></asp:HiddenField>
                                                ...
                                                <asp:HiddenField ID="hdnCretedByAMS" Value='<%# Eval("intCreatedBy")%>' runat="server"></asp:HiddenField>
                                            </ItemTemplate>--%>
                                       <%-- </asp:TemplateField>--%>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdnTextVal" runat="server" Value='<%# Eval("strFileName")%>'></asp:HiddenField>
                                                <asp:HiddenField ID="hdnLandReq" runat="server" Value='<%# Eval("decExtendLand")%>'></asp:HiddenField>
                                                <asp:HiddenField ID="hdnIndustryName" runat="server" Value='<%# Eval("strRemarks")%>'></asp:HiddenField>
                                                <asp:LinkButton ID="LinkButton1" Text="Take Action" OnClientClick="setvaluesOfrow(this);"
                                                    runat="server" class="label-warning label label-default" data-toggle="modal"
                                                    data-target="#customer1"></asp:LinkButton>
                                                <asp:HiddenField ID="hdnCretedBy" Value='<%# Eval("intCreatedBy")%>' runat="server"></asp:HiddenField>
                                                <asp:HiddenField ID="hdnIndustrialName" Value='<%# Eval("vchIndustryCode")%>' runat="server"></asp:HiddenField>
                                                <asp:HiddenField ID="hdnLandAquiredByidco" Value='<%# Eval("intLandReqd")%>' runat="server"></asp:HiddenField>
                                                <asp:HiddenField ID="hdnDistId" Value='<%# Eval("intDist")%>' runat="server"></asp:HiddenField>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <%--<asp:HiddenField ID="hdnLandUnit" Value='<%# Eval("strLandUnit")%>' runat="server" />--%>
                                                                            ...
                                                                            <div class="panel-body">
                                                                                ...
                                                                                <div id="Div2" class="form-group" runat="server">
                                                                                    ...
                                                                                    <div class="col-md-4">
                                                                                        ...
                                                                                        <div>
                                                                                            <i>Maximum <span id="charsQueryLeft" class="mandatoryspan">1000</span> characters left</i>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="clearfix">
                                                                                    </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            <asp:Label ID="lblProposalNoAction" CssClass="datalabel" runat="server" ForeColor="Red"></asp:Label>
                                                        </div>
                                                        <div class="clearfix">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-5">
                                                            <span class="colon">:</span>
                                                            <asp:Label ID="lblIndustryNameAction" CssClass="datalabel" runat="server" Font-Bold="true"></asp:Label>
                                                        </div>
                                                        <div class="clearfix">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-5">
                                                            <span class="colon">:</span>
                                                            <asp:TextBox ID="txtRemarks" onkeyup="limitText(this,this.form.count,1000);" onkeydown="limitText(this,this.form.count,1000);" MaxLength="1000" TextMode="MultiLine"
                                                                Rows="3" CssClass="form-control" Onkeypress="return inputLimiter(event,'Address')"
                                                                runat="server"></asp:TextBox>
                                                            <span class="mandetory">*</span> <span class="mandatory" style="color: red"><small>Maximum
                                                    <input name="count" class="inputCss" readonly="readonly" style="font-weight: bold; color: red; width: 36px;"
                                                        type="text" value="1000" tabindex="-1" />
                                                                Characters Left</small></span>
                                                            <%--<span class="mandetory">*</span> <span class="text-danger"><i>Maximum <span id="charsLeft"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-5">
                                                            <span class="colon">:</span>
                                                            <asp:FileUpload ID="docUpload" CssClass="form-control" runat="server" onchange="return validateFile(this,4);" />
                                                            <div style="float: left">
                                                                <small class="text-danger">(Only .pdf file is allowed and Max file size is 4 MB)</small>
                                                    ...
                                                    <div class="form-group" id="dvPEALCerti" runat="server">
                                                        ...
                                                        <div class="col-md-5">
                                                            <span class="colon">:</span>
                                                            <asp:FileUpload ID="docPEALCerti" CssClass="form-control" runat="server" onchange="return validateFile(this,4);" />
                                                            <div style="float: left">
                                                                <small class="text-danger">(Only .pdf file is allowed and Max file size is 4 MB)</small>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group" id="dvscore" runat="server">
                                                        ...
                                                        <div class="col-md-5">
                                                            <span class="colon">:</span>
                                                            <asp:FileUpload ID="docScoreCard" CssClass="form-control" runat="server" onchange="return validateFile(this,4);" />
                                                            <div style="float: left">
                                                                <small class="text-danger">(Only .pdf file is allowed and Max file size is 4 MB)</small>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4">
                                                            Approval / Reject / Deferred Date</label>
                                                        <div class="col-md-5">
                                                            <span class="colon">:</span>
                                                            <div class=" input-group date datePicker">
                                                                <asp:TextBox runat="server" class="form-control" ID="txtActionDate" name="txtActionDate"></asp:TextBox>
                                                    ...
                                                    <div class="form-group" id="Div6" runat="server">
                                                        ...
                                                        <div class="col-md-5">
                                                            <span class="colon">:</span>
                                                            <asp:DropDownList ID="ddlIDCOName" runat="server" CssClass="form-control divi" TabIndex="6">
                                                            </asp:DropDownList>
                                                            <asp:HiddenField ID="hdnDistValu" runat="server"></asp:HiddenField>
                                                        </div>
                                                        <div class="clearfix">
                                                        </div>
                                                    </div>
                                                    <div class="form-group" id="Div7" runat="server">
                                                        ...
                                                        <div class="col-md-5">
                                                            <span class="colon">:</span>
                                                            <asp:DropDownList ID="ddlLandacquiredIDCO" runat="server" CssClass="form-control"
                                                                TabIndex="7">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-5">
                                                            <asp:Button ID="btnSubmit" runat="server" Text="Save" OnClick="btnSubmit_Click" OnClientClick="return valid();"
                                                                class="btn btn-add" />
                                                            <button type="btnCancel" class="btn btn-danger" onclientclick="clear();" onclick="btnCancel_Click"
                                                                data-dismiss="modal">
                                                                Cancel</button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="panel panel-bd ">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5">
                                                        <span class="colon">:</span>
                                                        <asp:Label ID="lblProposalNoIDCO" CssClass="datalabel" runat="server" ForeColor="Red"></asp:Label>
                                                    </div>
                                                    <div class="clearfix">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5">
                                                        <span class="colon">:</span>
                                                        <asp:Label ID="lblIndustryNameIDCO" CssClass="datalabel" runat="server" Font-Bold="true"></asp:Label>
                                                    </div>
                                                    <div class="clearfix">
                                                    </div>
                                                </div>
                                                <div class="form-group" id="Div4">
                                                    <label class="col-md-4">
                                                        Land Required By Investor (In Acre)
                                                        <%--<asp:Label ID="LblLandUnit1" runat="server"></asp:Label>--%>
                                                    </label>
                                                    <div class="col-md-5">
                                                        <span class="colon">:</span>
                                                ...
                                                <div class="form-group" id="Div5">
                                                    <label class="col-md-4">
                                                        Land Recommended By SLFC (In Acre)
                                                        <%--<asp:Label ID="LblLandUnit2" runat="server"></asp:Label>--%>
                                                    </label>
                                                    <div class="col-md-5">
                                                        <span class="colon">:</span>
                                                ...
                                                <div class="form-group" id="dvPEALCerti1" runat="server">
                                                    ...
                                                    <div class="col-md-5">
                                                        <span class="colon">:</span>
                                                        <asp:FileUpload ID="docIdcoDoc" CssClass="form-control" runat="server" />
                                        ...
                                        <div class="panel panel-bd ">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <span class="colon">:</span>
                                                        <asp:Label ID="lblProposalNoAMS" CssClass="datalabel" runat="server" ForeColor="Red"></asp:Label>
                                                    </div>
                                                    <div class="clearfix">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <span class="colon">:</span>
                                                        <asp:Label ID="lblIndustryNameAMS" CssClass="datalabel" runat="server" Font-Bold="true"></asp:Label>
                                                    </div>
                                                    <div class="clearfix">
                                                    </div>
                                                </div>
