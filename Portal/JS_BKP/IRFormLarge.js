...
function pageLoad() {
    ...
    $("#" + appendId + "lnkSupDocAdd").on('click', function () {
        ...
        if (!DropDownValidation(appendId + 'drpApprovalAuthority', '0', 'Approval Authority', 'GO-SWIFT')) {
            $("#popup_ok").click(function () { $(drpApprovalAuthority).focus(); });
            return false;
        }
...
function ValidatePage() {
    ...
    //    if (dateOfinspection > new Date()) {
    //        jAlert('<strong>Date of Inspection cannot be greater than current date</strong>', 'GO-SWIFT');
    //        $("#popup_ok").click(function () { $("#" + appendId + "txtDateOfInspection").focus(); });
    //        return false;
    //    }
...
function alertredirectno(msg) {
    ...
    jAlert(msg, 'GO-SWIFT', function (r) {
        ...
        if (r) {
            ...
            location.href = 'IRFormLarge.aspx?id=' + hdnAppno;
            return true;
        }
        else {
            return false;
