...
var todayDate = new Date; 
var todayMon	=	new Number(document.form1.selMonth.value);
var todayYr		=	new Number(document.form1.selYear.value);

todayDate.setDate(1);
todayDate.setMonth(todayMon-1);
todayDate.setYear(todayYr);
...
function Calendar(whatMonth,whatYear) {
    ...
    var startMonth;
    var startYear;
	var Mon	=	document.form1.selMonth.options[document.form1.selMonth.selectedIndex].text;
    ...
    output += '<td class="cal-HeadCell" align="center" width="100%"><a href="javascript:hideCalendar();"><img name="calbtn2" src="./jscript48/btn_close_small.gif" border="0" width="12" height="10"></a>  &nbsp;&nbsp;&nbsp;'+ Mon;
    /*for (month=0; month<12; month++) {
        if (month == whatMonth) output += '<OPTION VALUE="' + month + '" SELECTED>' + names[month] + '<\/OPTION>';
        else                output += '<OPTION VALUE="' + month + '">'          + names[month] + '<\/OPTION>';
    }
    output += '<\/SELECT><SELECT class="cal-TextBox" NAME="cboYear" disabled onChange="changeYear();">';
    for (year=minYearList; year<maxYearList; year++) {
        if (year == whatYear) output += '<OPTION VALUE="' + year + '" SELECTED>' + year + '<\/OPTION>';
        else              output += '<OPTION VALUE="' + year + '">'          + year + '<\/OPTION>';
    }*/
    output += '&nbsp;&nbsp;'+document.form1.selYear.value+'&nbsp;&nbsp;&nbsp; <a href="javascript:hideCalendar();"><img name="calbtn2" src="./jscript48/btn_close_small.gif" border="0" width="12" height="10"></a><\/td><\/tr><tr><td width="100%" align="center">';
