...
public partial class Portal_Grievance_MisViewGrievanceDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                {
                    Util.LogError(ex, "MISGrievanceDetails");
                }
            }
        }
    }
    ...
    private void fillAppDetails(string strGrivId)
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                Lbl_Industry_Type.Text = Convert.ToString(ds.Tables[0].Rows[0]["intIndustryCategory"]);
