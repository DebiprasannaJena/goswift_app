...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Application.master"
    AutoEventWireup="true" CodeFile="User_Approval.aspx.cs" Inherits="Portal_PAN_Operation_User_Approval" %>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <asp:HiddenField ID="Hid_Email_Id_Reject" runat="server" />
                                        <asp:HiddenField ID="Hid_Mobile_No_Reject" runat="server" />
                                    </div>
                                    <label class="col-sm-2">
                                        User Id</label>
                                    <div class="col-sm-4">
