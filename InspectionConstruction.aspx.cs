...
public partial class InspectionConstruction : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                string straction = "S";
                DataTable dtnew = objService.BindServiceData(straction, Convert.ToInt32(Session["deptid"].ToString()));
                if (Session["deptid"].ToString() == "8")
                {
                    dtnew.Rows.RemoveAt(1);

                }
                else if (Session["deptid"].ToString() == "659")
                {
                ...
                else if (Session["deptid"].ToString() == "12")
                {
                    DataRow dr = dtnew.NewRow();
                    dr["INT_SERVICEID"] = "29";
                ...
                else if (Session["deptid"].ToString() == "877")
                {
                    DataRow dr = dtnew.NewRow();
                    dr["INT_SERVICEID"] = "51";
                    dr["VCH_SERVICENAME"] = "Road cutting request form";
                ...
                else if (Session["deptid"].ToString() == "878")
                {
                    DataRow dr = dtnew.NewRow();
                    dr["INT_SERVICEID"] = "51";
                    dr["VCH_SERVICENAME"] = "Road cutting request form";
                ...
                else if (Session["deptid"].ToString() == "5")
                {
                    DataRow dr = dtnew.NewRow();
                    dr["INT_SERVICEID"] = "51";
                    dr["VCH_SERVICENAME"] = "Road cutting request form";
