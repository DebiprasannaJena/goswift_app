<%@ Page Title="" Language="C#" MasterPageFile="~/Template1.master" AutoEventWireup="true" CodeFile="TemplatePage_7.aspx.cs" Inherits="TemplatePage_7" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>TestPage by Temp8</title><meta name="author" content="TestPage by Temp8"/><meta name="description" content="TestPage by Temp8"/><meta name="keywords" content="TestPage by Temp8"/>
</asp:Content>
...
<%--<div class="content-form-section row">
             ...
             <div class="col-sm-3" >
                        <div class="pbox" id="divId1" runat="server">
               <%-- <h2 class="hstyle1">Title Here</h2>
                ...
                <div class="pince">
                   ...
                   --%>
                    ...
                    <div class="ncard" id="divId3" runat="server">
                    <%--    <div class="box">
                            <div class="img">
