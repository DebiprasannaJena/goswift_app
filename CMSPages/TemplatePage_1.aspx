<%@ Page Title="" Language="C#" MasterPageFile="~/Template1.master" AutoEventWireup="true" CodeFile="TemplatePage_1.aspx.cs" Inherits="TemplatePage_1" %>
...
<%-- <div class="content-form-section row">--%>
                    <div class="col-md-3" >
                    <div class="abt-sec br" id="divId1" runat="server" >
				       <%-- <h3 class="hstyle1">Title</h3>
				        <img src="images/dd.jpg" alt="timing">
				        <h1>Heading 1</h1>
				        <h2>Sub Heading</h2><h4>0.00 A.M to 0.00 P.M</h4>
				
				        <h1>Heading 2</h1>
				        <h2>Sub Heading</h2><h4>0.00 A.M to 0.00 P.M</h4>
				
				        <p><marquee>Scrolled Text Should Go Here</marquee></p>--%>
			        </div>
                    
                    </div>
            
                    <div class="col-sm-9" id="divId2" runat="server">
