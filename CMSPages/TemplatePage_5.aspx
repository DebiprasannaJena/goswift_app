<%@ Page Title="" Language="C#" MasterPageFile="~/Template1.master" AutoEventWireup="true" CodeFile="TemplatePage_5.aspx.cs" Inherits="TemplatePage_5" %>
...
<%--<div class="content-form-section row">--%>
                    ...
                    <div class="col-sm-6" >
                <div class="aboutcontent-sec" id="divId1" runat="server">
             ...
             <div class="col-sm-3" >
               ...
               <%-- <h2 class="hstyle1">Title Here</h2>
                ...
                <div class="pince">
                    ...
                    <div class="serviceBox" id="divId3" runat="server">
