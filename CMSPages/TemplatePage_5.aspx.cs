...
public partial class TemplatePage_5 : System.Web.UI.Page
{
    ...
    public void ContentFill(string strId)
    {
        ...
        if (newlist.Count > 0)
        {
            ...
            divId1.InnerHtml = newlist[0].strContent2;
            divId2.InnerHtml = newlist[0].strContent3;
            divId3.InnerHtml = newlist[0].strContent4;
        }
    }
}