<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ServiceInstructionExternal.aspx.cs"
    Inherits="ServiceInstructionExternal" %>
                    ...
                    <div class="form-sec">
                        ...
                        <div class="col-sm-12 text-center margin-top10">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:Button ID="BtnProceed" runat="server" Text="Proceed" CssClass="btn btn-success"
