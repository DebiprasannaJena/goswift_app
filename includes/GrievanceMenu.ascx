<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GrievanceMenu.ascx.cs" Inherits="includes_GrievanceMenu" %>
<script>
    $(function () {
...
<ul class="nav nav-pills">   
    ...
    <li class="menumanage othermenuli" runat="server" id="managemenu"><a href="javascript:void(0);">
        <i class="fa fa-money"></i>Manage</a>
