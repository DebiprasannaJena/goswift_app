<%@ Control Language="C#" AutoEventWireup="true" CodeFile="pealwebheader.ascx.cs"
...
<div class="show-table"> 
  ...
  <%--<div class="investorheader">--%>
   ...
   <span class="username"><asp:Label ID="lblUserName" runat="server">Sandeep Sharma</asp:Label></span>
   </div>
   </div>
