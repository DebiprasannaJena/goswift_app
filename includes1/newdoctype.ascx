<%@ Control Language="C#" AutoEventWireup="true" CodeFile="newdoctype.ascx.cs" Inherits="Application_includes_doctype" %>
<meta charset="UTF-8" />
...
<link href="newcss/animate.css" rel="stylesheet" type="text/css" />
<%-- Styles --%>
<%-- Scripts --%>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-109292204-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag() { dataLayer.push(arguments); }
    gtag('js', new Date());

    gtag('config', 'UA-109292204-1');
</script>
