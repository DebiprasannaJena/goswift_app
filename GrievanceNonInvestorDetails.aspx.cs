...
public partial class GrievanceNonInvestorDetails : System.Web.UI.Page
{
    ...
    protected void grdGRVDtl_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if ((DataControlRowType)e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            HypLnk_Griv_Id.NavigateUrl = "~/GRIEVANCE/GrievanceDetailsNonIndustry.aspx?StrGrievanceNo=" + grdGRVDtl.DataKeys[e.Row.RowIndex].Values["vchGrivId"];
        }
    }
