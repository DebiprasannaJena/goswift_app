...
$(document).ready(function () {
    ...
    var PremisesAttached = $('input:radio[name=PremisesAttached]:checked').val();  
    var PremisesLicensed = $('input:radio[name=PremisesLicensed]:checked').val();  
    var ApplicantConviction = $('input:radio[name=ApplicantConviction]:checked').val();  
    var LicenceCancelled = $('input:radio[name=LicenceCancelled]:checked').val();  

    if (PremisesAttached === "Yes") {
        $("#div_txt_1419").show();
        $("#txt_14").addClass("req rset");
    }
    else {
