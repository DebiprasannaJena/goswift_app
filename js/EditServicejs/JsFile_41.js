...
$(document).ready(function () {
    ...
    $('input:radio[name=ExistingCategory]').attr('RepeatDirection', 'Vertical');
    ...
    if (ProposalId !== "" && ProposalId !== "0" && ProposalId !== null) {
    ...
    //else {
    //    fillBlockDataAutowithouproposal($('#sel_2').val(), $('#sel_3').attr("EditData"));
    //}

    $("#sel_2").attr("enable", "enable");//Distric enable
    $("#sel_3").attr("enable", "enable");//Block enable
    fillBlockDataAutowithouproposal($('#sel_2').val(), $('#sel_3').attr("EditData"));// For Bind Block
    ...
    CheckAmount(FormId, ProposalId);

    var Value = $('input:radio[name=ApplicationType]:checked').val();
    if (Value === "Existing") {
    ...
    /*-------------------------------------------------------------------------------------*/
    var Value1 = $('input:radio[name=ExistingQuantityIndented]:checked').val();
    if (Value1 === "Ground") {
        $("#div_sel_1126").hide();
        $("#div_txt_1147").hide();
        $("#div_fil_2215").show();
    ...
    /*-------------------------------------------------------------------------------------*/
    var Value2 = $('input:radio[name=QuantityIndented2]:checked').val();
    if (Value2 === "Ground") {
        $("#div_fil_139").show();
        $("#div_sel_1010").hide();
        $("#div_txt_9011").hide();
    ...
    /*-------------------------------------------------------------------------------------*/
    var Value3 = $('input:radio[name=QuantityIndented]:checked').val();
    if (Value3 === "Ground") {
        $("#div_fil_141").show();
        $("#div_sel_52").hide();
        $("#div_txt_813").hide();
...
/*-------------------------------------------------------------------------------------*/
//FILL BLOCK WITH OUR PROPOSAL
function fillBlockDataAutowithouproposal(selValue, setVal) {
    var dtSource = "M_ADM_LocationDetails";
    var dtValue = "intLevelDetailId";
    var dtText = "nvchLevelName";
    var dtLevel = "3";
...
function CheckAmount(FormId, ProposalId) {
    FuncWithCondition(FormId, ProposalId);
}
