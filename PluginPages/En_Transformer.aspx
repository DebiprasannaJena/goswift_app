<%@ Page Language="C#" AutoEventWireup="true" CodeFile="En_Transformer.aspx.cs" Inherits="PluginPages_En_Transformer" %>
      ...
      <asp:GridView ID="grvAddmore" runat="server" ShowFooter="True" AutoGenerateColumns="False" CssClass="table table-bordered"
                                                ...
                                                <Columns>
                                                   <asp:BoundField HeaderText="Item No."/>
                                                    ...
                                                    <asp:TemplateField HeaderText="Primary Voltage Winding">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtPrimaryVoltage" CssClass="form-control" runat="server" onBlur="JsonStringData();"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Primary Protection">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtPrimaryProtection" CssClass="form-control" runat="server" onBlur="JsonStringData();"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Secondary Voltage Winding">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtSecondaryVoltage" CssClass="form-control" runat="server" onBlur="JsonStringData();"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="Secondary Protection">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtSecondaryProtection" CssClass="form-control" runat="server" onBlur="JsonStringData();"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField >
            ...
            $("[id*=grvAddmore] >tbody > tr").each(function () {
                ...
                if (parentId != undefined && parentId != 'undefined') {
                    rows.push({
                        ...
                        PrimaryVoltage: $row.closest('tr').find('[id*=txtPrimaryVoltage]').val(),
                        PrimaryProtection: $row.closest('tr').find('[id*=txtPrimaryProtection]').val(),
                        SecondaryVoltage: $row.closest('tr').find('[id*=txtSecondaryVoltage]').val(),
                        SecondaryProtection: $row.closest('tr').find('[id*=txtSecondaryProtection]').val()
