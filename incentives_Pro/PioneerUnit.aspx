                    ...
                    <div class="form-sec">
                     <div class="innertabs">
                        ...
                        <div class="form-header">
                            ...
                            <h2>
                               Application For Pioneer Units Under IPR 2015</h2>
                        </div>
                        <div class="form-body">
  ...
  <h4 class="h4-header">
                                  ...
                                  <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="Div2">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                                href="#IndustryDetails3" aria-expanded="false" aria-controls="collapseThree"><i class="more-less fa  fa-plus">
                                                </i>Investment Details </a>
                                        </h4>
                                    </div>
                                    <div id="IndustryDetails3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                        <div class="panel-body">
                                         <p class="text-red text-right"> All Amouts to be Entered in INR(Exact Amount)</p>
                                            <div class="form-group">
                                                <div class="row">
      ...
      <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <label for="Iname" class="col-sm-3 ">
                                                        <small class="text-gray">Assessment report (lndustrial units set up without financial assistance from Public Financial lnstitutions and or Banks will be required to be assessed by the appropriate agency as envisaged under Para- h - of IPR-20105).</small></label>
                                                    <div class="col-sm-3">
                                                        <span class="colon">:</span>
                                                    ...
                                                    <div class="col-sm-12">
                                                      <table class="table table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="LinkButton28" CssClass="btn btn-success btn-sm" runat="server"><i class="fa fa-plus-square"></i></asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                             ...
                                             <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <span class="colon">:</span>
                                                      <label class="radio-inline">
      <input type="radio" name="Certificateoptradio">Yes
    </label>
    <label class="radio-inline">
      <input type="radio" name="Certificateoptradio">No
    </label>
    <label class="radio-inline">
      <input type="radio" name="Certificateoptradio">Applied
    </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <label for="Iname" class="col-sm-3 ">
                                                        <small class="text-gray">Priority Sector Certificate under Odisha
lndustrial Policy Resolution -2015</small></label>
                                                    <div class="col-sm-3">
                                                        <span class="colon">:</span>
                                   ...
                                   <div class="form-group Acknowledgementdetails">
                                                <div class="row">
                                                    ...
                                                    <label for="Iname" class="col-sm-3 ">
                                                        <small class="text-gray">Copy of Application Acknowledgement</small></label>
                                                    <div class="col-sm-3">
                                                        <span class="colon">:</span>
	...
	<tbody><tr>
		<td><input id="CheckBoxList1_0" type="checkbox" name="CheckBoxList1$0" value="OSPCB-NOC"><label for="CheckBoxList1_0">OSPCB-NOC</label></td>
	</tr><tr>
		<td><input id="CheckBoxList1_1" type="checkbox" name="CheckBoxList1$1" value="OSPCB-Consent to Operate"><label for="CheckBoxList1_1">OSPCB-Consent to Operate</label></td>
	</tr><tr>
		<td><input id="CheckBoxList1_2" type="checkbox" name="CheckBoxList1$2" value="Central Excise-Clearence"><label for="CheckBoxList1_2">Central Excise-Clearence</label></td>
	</tr><tr>
		<td><input id="CheckBoxList1_3" type="checkbox" name="CheckBoxList1$3" value="Odisha FSHGSCD-Clearence"><label for="CheckBoxList1_3">Odisha FSHGSCD-Clearence</label></td>
	</tr><tr>
		<td><input id="CheckBoxList1_4" type="checkbox" name="CheckBoxList1$4" value="Expolsive Control-NOC"><label for="CheckBoxList1_4">Expolsive Control-NOC</label></td>
	</tr>
</tbody></table>
                </div>
            </div>
            ...
            <div class="row">
                <label for="Iname" class="col-sm-3">
                     <small class="text-gray">Statutory clearances/approval by an authorities including OSPCB</small></label>
                <div class="col-sm-4">
                    <span class="colon">:</span>
                     <a id="LinkButton16" class="btn btn-success " data-toggle="tooltip" title="" href="javascript:__doPostBack('LinkButton16','')" data-original-title="View file"><i class="fa fa-file-pdf-o"></i></a>
                                                        <a id="A2" class="btn btn-warning" data-toggle="tooltip" title="" href="javascript:__doPostBack('LinkButton17','')" data-original-title="Update File"><i class="fa fa-pencil-square"></i></a>
                                                        <a id="LinkButton180" class="btn btn-danger" data-toggle="tooltip" title="" href="javascript:__doPostBack('LinkButton180','')" data-original-title="Upload"><i class="fa fa-cloud-upload"></i></a>
                </div>
            </div>
        </div> 
