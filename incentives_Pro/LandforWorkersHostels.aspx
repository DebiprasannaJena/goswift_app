<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LandforWorkersHostels.aspx.cs"
                ...
                <div class="tab-pane active" id="1a">
                    <div class="form-sec">
                        ...
                        <div class="form-header">
                            ...
                            <h2>
                                Application For Land For Workers Hostels</h2>
                        </div>
                        <div class="form-body">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <div class="row">
                                                    <label for="Iname" class="col-sm-12 text-center ">
                                                        <span class="text-red ">No Form Inside the O.G. </span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
