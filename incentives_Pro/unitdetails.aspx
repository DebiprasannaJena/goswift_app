<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unitdetails.aspx.cs" Inherits="incentives_incentiveoffered" %>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <span class="colon">:</span>
                                                                    <asp:Label ID="Label10" CssClass="dataspan" runat="server" Text="Label">29-12-2016</asp:Label>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-6">
                                                                    Date (or Proposed Date) of Commnecement of Production
                                                                </label>
                                                                <div class="col-sm-6">
                                                                    <span class="colon">:</span>
                                                                   <asp:Label ID="Label11" CssClass="dataspan" runat="server" Text="Label">03-01-2017</asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <span class="colon">:</span>
                                                                    <asp:Label ID="Label3" CssClass="dataspan" runat="server" Text="Label">Apparel</asp:Label>
                                            ...
                                            <table class="table table-bordered bg-white">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                      <a href="javascript:void(0);" class="uploadlink" title="Download PDF"><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                      ...
                                                      <input id="File1" class="filupload" type="file"/>
                                                       <a id="LinkButton4" class="uploadlink"  data-toggle="tooltip" title="" href="javascript:void(0)" data-original-title="Upload"><i class="fa fa-cloud-upload"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                      ...
                                                      <a id="A1" class="uploadlink" data-toggle="tooltip" title="" href="javascript:void(0)" data-original-title="Upload"><input id="upload" class="filupload" type="file"/><i class="fa fa-cloud-upload"></i></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
    ...
    <div id="undertakingMSME" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="appliedlistwithdetails.aspx" class="btn btn-success" title="Submit">Submit</a>
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close</button>
                </div>
            </div>
