<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmploymentRating.aspx.cs" Inherits="incentives_EmploymentRating" %>
                    ...
                    <div class="form-sec">
                     <div class="innertabs">
                        ...
                        <div class="form-header">
                            ...
                            <h2>
                                Application For Reimbursement of employment rating based incentives under industrial policy resolution 2015 </h2>
                        </div>
                        <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <span class="colon">:</span>
                                                        ...
                                                        <div class="col-sm-4 padding-right-0 padding-left-0">
                                                            <asp:TextBox ID="TextBox367" CssClass="form-control" placeholder="1234" runat="server"></asp:TextBox></div>
                                                             <div class="col-sm-4 padding-right-0">
                                                            <asp:TextBox ID="TextBox4765" CssClass="form-control" placeholder="1234" runat="server"></asp:TextBox></div>
                                                             <div class="col-sm-4 padding-right-0">
                                                            <asp:TextBox ID="TextBox5657" CssClass="form-control"  placeholder="1234" runat="server"></asp:TextBox></div>
