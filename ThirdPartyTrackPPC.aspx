<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ThirdPartyTrackPPC.aspx.cs" Inherits="ThirdPartyTrackPPC" %>
            ...
            <div class="col-sm-12">
                <div class="aboutcontent-sec">
                    ...
                    <h2 class=" margin-bottom15">
                        Third Party Provisional Priority Certificate Verification
                    </h2>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Track Provisional Priority Certificate Details</div>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="grdService" class="table table-bordered table-hover" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ApplicationNum" HeaderText="PPC Number" />
                                <asp:BoundField DataField="vchCompName" HeaderText="Company Name" />       
                                  <asp:BoundField DataField="vchInctName" HeaderText="Provisional Priority Certificate Name" />
