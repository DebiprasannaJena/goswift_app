<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Grantprioritysectorsstatus.aspx.cs"
    MaintainScrollPositionOnPostback="true" Inherits="incentives_Grantprioritysectorsstatus" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function FileCheck(e) {
            ...
            if (jQuery.inArray($("#" + ids).val().split('.').pop().toLowerCase(), ar) == -1) {
                jAlert('<strong>Only pdf/zip formats are allowed. </strong>', 'GO-SWIFT');
                $("#" + ids).val('');
                return false;
            }
            else {
                if ((e.files[0].size > parseInt(4 * 1024 * 1024)) && ($("#" + ids).val() != '')) {
                    ...
                    jAlert('<strong>File size must be less then 4 MB !!</strong>', 'GO-SWIFT');
                    $("#" + ids).val('');
                    e.preventDefault();
                    return false;
                }
    ...
    <script type="text/javascript">
        ...
        function AlreadyAvailed() {
            ...
            if (DropDownValidation('ddlIncentiveType', '0', 'Incentive Type', '') == false) {
                return false;
            }
            if (blankFieldValidation('txtQuantum', 'Quantum/Value', '') == false) {
                return false;
            }
            if (blankFieldValidation('txtTimeschedulefrom', ' Start Date', '') == false) {
                return false;
            }
            if (blankFieldValidation('txtTimescheduleTo', 'Period Date', '') == false) {
                return false;
            }
            if (DropDownValidation('ddlApplicability', '0', 'IPR Applicability', '') == false) {
                return false;
            }
            ...
            if ((Date.parse(startDate) >= Date.parse(endDate))) {
                jAlert('<strong>End date should be greater than Start date</strong>', 'GO-SWIFT');
        ...
        function CheckValidation() {
            ...
            if ($("#hdnUploadApplAcknow").val().length == 0) {
                if ($("#fldUploadApplAcknow").val().length == 0) {
                    jAlert('<strong>Please upload Undertaking in context of that Industrial units  !</strong>', 'GO-SWIFT');
                    return false;
                }
            }
            if ($("#HiddenField1").val().length == 0) {
                if ($("#FileUpload1").val().length == 0) {
                    jAlert('<strong>Please upload Document / certificate in support of Category fall   !</strong>', 'GO-SWIFT');
                    return false;
                }
            }
        ...
        function TocheckPrior() {
            jAlert('<strong>You are not eligible</strong>', 'GO-SWIFT');
        ...
        function listboxitems() {
            ...
            $('#ddlSpecificActivity_old :selected').each(function (i, selected) {
            ...
            for (var i = 0; i < selectedVal.length; i++) {
                //alert(selectedVal[i]);
                $('<option value="' + selectedVal[i] + '">' + selectedText[i] + '</option>').appendTo('#ddlSpecificActivity');
            }
        }
    ...
    <div class="container">
                                                        ...
                                                        <div class="col-sm-3 ">
                                                            <label for="Iname">
                                                                <small>Migrated industrial unit treated as new industrial unit under Priority Sector
                                                                    ...
                                                                    <asp:RadioButtonList ID="rdbldocs" runat="server" Visible="false">
                                                                        <asp:ListItem Value="1">Migrated industrial unit treated as new industrial unit under Priority Sector</asp:ListItem>
                                                                        <asp:ListItem Value="2">Rehabilitated sick industrial unit treated at par with new industrial unit under Priority sector</asp:ListItem>
                                                                        <asp:ListItem Value="3">lndustrial unit seized under Section 29 of the State Financial Corporation Act, 1951</asp:ListItem>
                                                                        <asp:ListItem Value="4">SARFAESI Act, 2002 and thereafter sold to a new entrepreneur on sale of assets basis and treated as new industrial unit for the purpose of this IPR under Priority Sector</asp:ListItem>
                                                                    </asp:RadioButtonList>
                                                                </small><a data-toggle="tooltip" class="fieldinfo2" style="padding-left: 10px" title="Migrated industrial unit treated as new industrial unit under Priority Sector / Rehabilitated sick
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <asp:LinkButton ID="lknDelCertificate" runat="server" CssClass="input-group-addon bg-red"
                                                                    data-toggle="tooltip" OnClick="lnkOrgDocumentDelete_Click" Visible="false" ToolTip="Delete file"><i class="fa fa-trash-o" aria-hidden="true"></i></asp:LinkButton>
                                                                <asp:HyperLink ID="hlkViewCertificate" runat="server" CssClass="input-group-addon bg-blue"
                                                                    data-toggle="tooltip" title="View file" OnClientClick="JavaScript: return false;"
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group" style="display: none;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <span class="colon">:</span>
                                                            <asp:TextBox ID="txtDLSWCALandCost" runat="server" Text="0" CssClass="form-control"></asp:TextBox>
                                                    ...
                                                    <div class="row">
                                                        <label for="Iname" class="col-sm-5">
                                                            Sector Relevant Document <a data-toggle="tooltip" class="fieldinfo2" title="1. FSSAI/Food License- For food processing unit 
                                                             ...
                                                             3. BIS Certification -For Packaged drinking water "><i class="fa fa-question-circle"
                                                                 aria-hidden="true"></i></a>
                                                        </label>
                                                        <div class="col-sm-6">
                                                            <span class="colon">:</span>
        ...
        <div class="staicmodal" runat="server" id="pnldet" visible="false">
            <div class="modalcontenter">
                ...
                <div class="mod-con">
                    <p>
                        <asp:Label ID="lblelgmsg" runat="server"></asp:Label></p>
                </div>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function pageLoad() {
                ...
                if (hdn != null && hdn != undefined && hdn != '') {
                    $("#collapseOne, #ProductionEmploymentDetails, #IndustryDetails, #divInvestment, #IncentiveavailedDetails, #DLSWCA, #InterestSubsidyDetails, #DivDocCheck").removeClass('in');
                    $(hdn).addClass("in");
                }
