<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CapitalgranttosupportQinf.aspx.cs" Inherits="incentives_EmploymentRating" %>
                    ...
                    <div class="form-sec">
                     <div class="innertabs">
                        ...
                        <div class="form-header">
                            ...
                            <h2>
                               Application For Capital Grant To Support Quality Infrastructure</h2>
                        </div>
                        <div class="form-body">
                                        ...
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                                                href="#ConstractionDetails" aria-expanded="false" aria-controls="collapseTwo"><i
                                                    class="more-less fa  fa-plus"></i>Construction Details </a>
                                        </h4>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <label for="Iname" class="col-sm-3 ">
                                                        <small class="text-gray">Signature of Officers of IPICOL & Dl / Dl required</small></label>
                                                    <div class="col-sm-3">
                                                        <span class="colon">:</span>
