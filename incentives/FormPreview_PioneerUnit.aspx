<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormPreview_PioneerUnit.aspx.cs"
    Inherits="incentives_FormPreview_PioneerUnit" %>
                            ...
                            <div class="form-body">
                                <div class="incentivepreiview">
                                    <div class="preiviewheader text-center">
                                        <h4>
                                            <asp:Label ID="lblTitleH" runat="server"></asp:Label>
                                        </h4>
                                        <p>
                                    ...
                                    <div class="prieviewdatasec">
                                        ...
                                        <div class="padding-left-20">
                                            <p>
                                                Application for issue of Pioneer Unit certificate under Industrial Policy Resolution
                                                2015.
                                            </p>
                                        </div>
                                        <h4>
                                        ...
                                        <div class="padding-left-20">
                                            <p>
                                                In accordance with the provisions laid down in the Industrial Policy Resolution
                                                2015 and its operational guidelines for Grant of Pioneer Unit Certificate, I submit
                                    ...
                                    <div class="prievewdynamicdata">
                                        <div class="panel-group padding-20" id="accordion" role="tablist" aria-multiselectable="true">
                                            ...
                                            <div class="panel panel-default" runat="server" visible="false">
                                                ...
                                                <div id="Div3" class="panel-collapsein" role="tabpanel" aria-labelledby="headingThree">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label for="Iname" class="col-sm-6 ">
                                                                    Date of Power Supply for Production</small></label>
                                                                <div class="col-sm-3">
                                                                    <span class="colon">:</span>
                                                                    <asp:Label ID="lblelecdat" CssClass="dataspan" runat="server"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label for="Iname" class="col-sm-6 ">
                                                                    Consumer no of the lndustry</small></label>
                                                                <div class="col-sm-3">
                                                                    <span class="colon">:</span>
                                                                    <asp:Label ID="lblcons" CssClass="dataspan" runat="server"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label for="Iname" class="col-sm-6
        ">
                                                                    Connected Load / Contract Demand ( In KVA)</small></label>
                                                                <div class="col-sm-3">
                                                                    <span class="colon">:</span>
                                                                    <asp:Label ID="lblconnected" CssClass="dataspan" runat="server"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <table class="table table-bordered">
                                                                        <tr>
                                                                            <td colspan="8">
                                                                                <asp:GridView ID="grdelectric" runat="server" CssClass="table
        table-bordered" ShowHeader="true" AutoGenerateColumns="false" Width="100%">
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="dcamtclaim" HeaderText="Amount Claimed" />
                                                                                        <asp:BoundField DataField="dcmfininst" HeaderText="Financial Institution" />
                                                                                    </Columns>
                                                                                </asp:GridView>
                                                                            </td>
                                                                        </tr>
                                                ...
                                                <div class="panel-body ss">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="lknViewApplAcknow" data-toggle="View Document" title="View
        Document" Target="_blank" runat="server">View
        Document</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="lknUpladView" data-toggle="View
        Document" title="View Document" Target="_blank" runat="server">View Document</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                            ...
                            <div class="form-footer">
                                ...
                                <%--<div class="row"> <div
    class="col-sm-12 text-right"> <div id="myModal2" class="modal fade" role="dialog">
    <div class="modal-dialog modal-md"> <!-- Modal content--> <div class="modal-content">
    <div class="modal-body text-center"> <div class="form-group"> <h4 class="text-success">
    Thanks for submiting your application </h4> <p>Your Application no. : <b>App1234567</b></p>
    <p>Expected First response time : <b>7 Days </b></p> <p>Maximum eligible incentive
    : <b><i class="fa fa-inr"></i> 75,000/-</b></p> <p class="text-red"><i> * This is
    an indicative value Disbursement amount may be lesser depending upon application
    details scrutiny.</i></p> <a class="btn btn-success" href="ViewApplicationStatus.aspx">OK</a>
    </div> </div> </div> </div> </div> <a class="btn btn-warning">Save as Draft</a>
    <a class="btn btn-success" data-toggle="modal" data-target="#myModal2">Apply</a>
    </div> </div>--%>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('.datePicker').datepicker({ dateFormat: 'dd:mm:yyyy',
                separator: ' @ ', minDate: new Date(), autoclose: true
            });
        });
