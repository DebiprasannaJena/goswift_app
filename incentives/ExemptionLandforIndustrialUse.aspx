<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExemptionLandforIndustrialUse.aspx.cs" Inherits="incentives_ExemptionLandforIndustrialUse" %>
                                                                                    ...
                                                                                    <div class="col-sm-12  margin-bottom10">
                                                                                                ...
                                                                                                <td>
                                                                                                  ...
                                                                                                  <td>
                                                                                                    <asp:TextBox ID="Txt_Present_Kisam" runat="server" CssClass="form-control" MaxLength="10"
                                                                                                        onkeypress="return FloatOnly(event, this);" ToolTip="Enter Present Kisam Here !!"></asp:TextBox>
                                                                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender9" runat="server" TargetControlID="Txt_Present_Kisam"
                                                                                                        FilterType="Numbers,Custom" ValidChars=".">
                                                                                                    </cc1:FilteredTextBoxExtender>
                                                                                                </td>
                                                                                                <td>
                                                                                        ...
                                                                                        <asp:GridView ID="Grd_Land" runat="server" CssClass="table table-bordered"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateField>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="Lbl_Mouza" runat="server" Text='<%# Eval("vchProductName") %>'></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="Lbl_Khata_No" runat="server" Text='<%# Eval("intQuantity") %>'></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                    <ItemStyle Width="15%"></ItemStyle>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="Lbl_Plot_No" runat="server" Text='<%# Eval("vchUnit") %>'></asp:Label>
                                                                                                        <%--<asp:HiddenField ID="Hid_Unit_Before" runat="server" Value='<%# Eval("intUnit") %>' />--%>
                                                                                                    </ItemTemplate>
                                                                                                    <ItemStyle Width="10%"></ItemStyle>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="Lbl_Area" runat="server" Text='<%# Eval("vchOtherUnit") %>'></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                    <ItemStyle Width="10%"></ItemStyle>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField>
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="Lbl_Prsent_Kisam" runat="server" Text='<%# Eval("decValue") %>'></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                    <ItemStyle Width="20%"></ItemStyle>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField>
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="input-group">
                                                                <asp:FileUpload ID="flAppprovedproj" CssClass="form-control" runat="server"
                                                                    onchange="return FileCheck(this);" />
                                                                <asp:HiddenField ID="hdnAppprovedproj_code" runat="server" Value="D313" />
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="input-group">
                                                                <asp:FileUpload ID="flLanddocument" CssClass="form-control" runat="server"
                                                                    onchange="return FileCheck(this);" />
                                                                <asp:HiddenField ID="hdnLanddocument_code" runat="server" Value="D313" />
