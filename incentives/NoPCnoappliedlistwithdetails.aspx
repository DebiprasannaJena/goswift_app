<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoPCnoappliedlistwithdetails.aspx.cs"
                                            ...
                                            <h4>Criteria Provided</h4>
                                             <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <span class="colon">:</span>
                                                        <asp:Label ID="Label3" runat="server" CssClass="dataspan" Text="Label">Tourism</asp:Label>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <p class="text-red">You dont't have a valid a Production Certificate. You can apply for the below Pre-Production Incentives only</p>
                                                        <table class="table table-bordered">
                                                            <tr>
                                                            <th width="30px"></th>
                                                                <th>
                                                            ...
                                                            <td><input type="radio" ></td>
                                                             ...
                                                             <td><input type="radio" ></td>
                                                                <td >
                                                                 ...
                                                                 <td>
                                                                     <a target="_blank" href="../images/industrialpol-2015.pdf">Tourism</a>
                                                                </td>
                                                                <td>
                                                                    New
                                                                </td>
