<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatentRegistrationPreview.aspx.cs"
    Inherits="incentives_PatentRegistrationPreview" %>
...
<body>
                    ...
                    <div class="tab-pane active" id="1a">
                        <div class="form-sec">
                            ...
                            <div class="form-header">
                                <div class="iconsdiv" style="text-align: center">
                                ...
                                <div class="incentivepreiview">
                                    ...
                                    <div class="prieviewdatasec">
                                        ...
                                        <div class="padding-left-20">
                                            ...
                                            <p>
                                                Addres :<asp:Label ID="lblAddress" runat="server"></asp:Label></p>
                                            <p>
                                                Dist. :
                                        ...
                                        <div class="padding-left-20">
                                            <p>
                                                Sanction of Assistance on Patent & Intellectual Property Rights Under Provisions
                                                of Industrial Policy Resolution 2015
                                            </p>
                                        </div>
                                        <h4>
                                            Sir,</h4>
                                        <div class="padding-left-20">
                                            <p>
                                                ...
                                                and operational guidelines, the claim of Assistance on Patent & Intellectual Property
                                                is submitted following particulars.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="prievewdynamicdata">
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="headingOne">
                                                <h4 class="panel-title">
                                                    <a>Industrial Unit's Details<span class="text-red pull-right " style="margin-right: 20px;">All
                                                        Amounts in INR Lakh</span></a>
                                                </h4>
                                            </div>
                                            <div class="panel-body">
                                                ...
                                                <div runat="server" id="divbefor">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <asp:Label for="Iname" class="col-sm-4 col-sm-offset-1" Text="PC Insurance Date Before E/M/D"
                                                ...
                                                <div runat="server" id="divafter">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <asp:Label for="Iname" class="col-sm-4 col-sm-offset-1" Text="PC Insurance Date After E/M/D"
                                                            ...
                                                            <div class="col-sm-12">
                                                                <table class="table table-bordered" id="tblEmployement" runat="server">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_Supervisor_Before" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            SC
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="lbl_SC_Before" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_Skilled_Before" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            ST
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="lbl_ST_Before" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_Semi_Skilled_Before" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            Total
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_Unskilled_Before" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            Women
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="lbl_Women_Before" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_PHD_Before" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <table class="table table-bordered" id="Table1" runat="server">
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 15%;">
                                                                            <asp:Label ID="lbl_Managarial_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                        <td style="width: 20%;">
                                                                            General
                                                                        </td>
                                                                        <td style="width: 15%;">
                                                                            <asp:Label ID="lbl_General_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_Supervisor_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            SC
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="lbl_SC_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_Skilled_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            ST
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="lbl_ST_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_Semi_Skilled_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            Total
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_Unskilled_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            Women
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="lbl_Women_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_PHD_After" runat="server" MaxLength="4" Text="0"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="PatentDetails1123" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                                                <div class="panel-body">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label for="Iname" class="col-sm-12 ">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    <asp:GridView ID="grdMeansOfFinancePatent" runat="server" CssClass="table table-bordered"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Amount Availed Date">
                                                                                <ItemTemplate>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="AvailedClaim" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                                                <div class="panel-body">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <span class="colon">:</span>
                                                                <asp:Label runat="server" ID="lblNeverAvailedPrior" CssClass="form-control-static"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group availdetailsec availgroup1" runat="server" id="availgroup1">
                                                        <div class="row">
                                                            <label for="Iname" class="col-sm-12 ">
                                                    ...
                                                    <div class="form-group availgroup1" runat="server" id="availgroup12">
                                                        <div class="row">
                                                            <label for="Iname" class="col-sm-6">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <span class="colon">:</span>
                                                                <asp:Label ID="txtdiffclaimamt" runat="server" onblur="DecimalValidation(this);"
                                                                    CssClass="form-control-static"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group availgroup1" runat="server">
                                                        <div class="row">
                                                            <label for="Iname" class="col-sm-6">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <span class="colon">:</span>
                                                                <asp:Label ID="txtreimamt" runat="server" onblur="DecimalValidation(this);" CssClass="form-control-static"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="panel-body ss">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr runat="server" id="availgroup11">
                                                        ...
                                                        <td>
                                                            <asp:HyperLink ID="Hyp_Asst_Sanc_Doc" runat="server" Target="_blank">View Document</asp:HyperLink>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        function SaveSign() {
            if ($('#flSignature').val() == '') {
                jAlert('Please upload a signature file.', 'SWP');
                return false;
            }
            else
            {
            var fileExtension = ['png', 'jpg', 'jpeg'];
                if ($.inArray($("#flSignature" ).val().split('.').pop().toLowerCase(), fileExtension) == -1) {
                    jAlert('Only png / jpg / jpeg files are allowed.', 'SWP');
                    $("#" + ids).val(null);
                    return false;
                }
            }
