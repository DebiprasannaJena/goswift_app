<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormPreview_Capitalinvestsubsidy.aspx.cs"
                            ...
                            <div class="form-body">
                                <div class="incentivepreiview">
                                    ...
                                    <div class="prieviewdatasec">
                                        ...
                                        <div class="padding-left-20">
                                            <p>
                                                Application for reimbursement of Capital investment Subsidy on Zero Liquid Discharge
                                                Based Treatment Plant under IPR- 2015
                                            </p>
                                        </div>
                                        <h4>
                                            Sir,</h4>
                                        ...
                                        <div class="panel-group padding-20" id="accordion" role="tablist" aria-multiselectable="true">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="Div3">
                                                    <h4 class="panel-title">
                                                        <a>Investment in pollution Control Equipment</a>
                                                    </h4>
                                                </div>
                                                <div id="Div4" class="panel-collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label for="Iname" class="col-sm-5">
                                                                    Date of operationalization of pollution Control Equipment</label>
                                                                <div class="col-sm-4">
                                                                    <span class="colon">:</span>
                                                                    <asp:Label name="txtOperationalization" type="text" ID="txtOperationalization" runat="server"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 ">
                                                                    <asp:GridView ID="gvEquipment" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false"
                                                                        ShowFooter="true" OnRowDataBound="gvEquipment_RowDataBound">
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Slno.">
                                                                                <ItemTemplate>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="Div6" class="panel-collapsein" role="tabpanel" aria-labelledby="headingOne">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <div class="row">
                                                ...
                                                <div class="panel-body ss">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a id="hypOperationalization" target="_blank" data-toggle="View Documen" title="Upload"
                                                                    runat="server">View Document</a>
                                                            </td>
                                                        </tr>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="preiviewfooter padding-20">
                                                    ...
                                                    <p>
                                                        ...
                                                        of IPR-2015 and its operational guidelines.</p>
                                                    <p>
                                                    ...
                                                    <ol>
                                                        ...
                                                        <li>If the industrial unit goes out of production for a period exceeding six months
                                                            ...
                                                            of incentives.</li>
                                                        <li>If any part of Plant & machinery/ Pollution Control Equipment is disposed of and
                                                            not reported which affects the maximum limit of CIS on ZLD in reimbursement during
                                                            the period of incentives.</li>
                                                    </ol>
                                                    <p>
                                                        I hereby certify that this industrial unit has not applied / availed the incentives
                                                        claimed here under any other scheme of the State Govt. or the Central Govt. or any
                                                        Financial institutions.</p>
                                                    <p>
                                                        <p>
                                                            I hereby undertake to furnish its audited financial statements and other periodical
                                                            statements of each financial year to the RIC / DIC / Directorate of industries,
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row" id="divUpload">
                                                                <label class="col-sm-4">
                                                                    Upload Signature of <b>
                                                                        <asp:Label ID="lblauthority" runat="server" Text="Applicant"></asp:Label></b>
                                                                    in full and on behalf of M/ s <b>
                                                                        <asp:Label ID="lblUnitAddr" runat="server"></asp:Label></b></label>
                                                                <div class="col-sm-8">
                                                                    <asp:FileUpload CssClass="form-control" ID="flSignature" runat="server" onchange="readURL(this);" />
                                                                    <small class="text-danger">(.png, .jpg, .jpeg file only and Max file Size 4 MB)</small></div>
