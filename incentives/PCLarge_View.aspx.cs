...
public partial class incentives_PCLarge_View : System.Web.UI.Page
{
    ...
    protected void grdPcApplication_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                HypEdit.NavigateUrl = "PC_Large_Apply.aspx?Id=" + grdPcApplication.DataKeys[e.Row.RowIndex].Values[0].ToString() + "&hdn=" + hdnPgindex.Value + "&pSize=" + ddlNoOfRec.SelectedValue;
            }
