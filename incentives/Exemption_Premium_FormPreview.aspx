                            ...
                            <div class="form-body">
                                <div class="incentivepreiview">
                                    <div class="preiviewheader text-center">
                                        ...
                                        <p>
                                            Application received incomplete in any respect shall be liable for rejection</p>
                                    </div>
                                    <div class="prieviewdatasec">
                                        ...
                                        <div class="padding-left-20">
                                            <p>
                                                Exemption from payment of premium leviable for conversion of land for industrial
                                                use under the provisions of Industrial Policy Resolution, 2015.
                                            </p>
                                        </div>
                                        <h4>
                                            Sir,</h4>
                                        <div class="padding-left-20">
                                            <p>
                                                ...
                                                its operational guidelines notified by Revenue & Disaster Management Department,
                                                Government of Odisha, claim for exemption of premium leviable for conversion of
                                                land for industrial use is submitted with following particulars.
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="panel-group padding-20" id="accordion" role="tablist" aria-multiselectable="true">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <table class="table table-bordered" id="Table1" runat="server">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:Label ID="lbl_Total_Emp_After" runat="server" Text="0"></asp:Label>
                                                                            </td>
                                                                            <td>
                                                                                Differently Abled Persons
                                                                            </td>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="headingThree">
                                                    <h4 class="panel-title">
                                                        <a>Land Details <span class="text-red pull-right " style="margin-right: 20px;">(Area
                                                            in Acres)</span> </a>
                                                    </h4>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label for="Iname" class="col-sm-6 ">
                                                                    Cost of the Project ( New / Existing & E/M/D)
                                                                </label>
                                                                <div class="col-sm-3">
                                                                    <span class="colon">:</span>
                                                                    <asp:Label ID="LblCostofProject" CssClass="form-control-static" runat="server" Text="500000"></asp:Label>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <label for="Iname" class="col-sm-6 ">
                                                                    Area of Land required as per DPR / Project report
                                                                </label>
                                                                <div class="col-sm-3">
                                                                    <span class="colon">:</span>
                                                                    <asp:Label ID="LblLandRequiredAsperRpt" CssClass="form-control-static" runat="server"
                                                                        Text="1500SqrFt"></asp:Label>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <label for="Iname" class="col-sm-6 ">
                                                                    Area of Land acquired</label>
                                                                <div class="col-sm-3">
                                                                    <span class="colon">:</span>
                                                                    <asp:Label ID="LblLandRequired" CssClass="form-control-static" runat="server" Text="03-Jan-2017"></asp:Label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="panel-body ss">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr runat="server" id="divAuthorizing">
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="hypAUTHORIZEDFILE" runat="server" Target="_blank" ToolTip="View File">View Document</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <tr runat="server" id="tr_Org_Doc_Type">
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="Hyp_View_Org_Doc" runat="server" Target="_blank">View Document</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <tr runat="server" id="tr_Prod_Comm_Before" visible="false" style="display: none;">
                                                            <td>
                                                                <asp:Label ID="Lbl_Prod_Comm_Before_Doc_Name" runat="server" Text="Certificate on Date of Commencement of production(Before)"></asp:Label>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr id="Div_Unit_Type_Doc" runat="server">
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="Hyp_View_Unit_Type_Doc" runat="server" Target="_blank">View Document</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="tr_LandDetails" runat="server">
                                                            <td>
                                                                <asp:Label ID="lblLandDetails" runat="server" Text="Land document with land particulars to be converted for industrial use"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:HyperLink ID="hyp_Land_details" runat="server" Target="_blank">View Document</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:HyperLink ID="HypLandUndertaking" runat="server" Target="_blank">View Document</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <tr id="tr_Clearance" runat="server" style="display: none;">
                                                            <td>
                                                                <asp:Label ID="lblClearance" runat="server" Text="OSPCB Consent to Operate"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:HyperLink ID="hyp_Clearance" runat="server" Target="_blank">View Document</asp:HyperLink>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="preiviewfooter padding-20">
                                                    <p>
                                                        ...
                                                        <asp:Label ID="lblAt1" runat="server" Visible="false" Text=""></asp:Label>
                                                        of M/S
                                                    ...
                                                    <p>
                                                        I hereby undertake that the industrial unit shall commence production within stipulated
                                                        time of three years for Micro, Small & Medium Enterprises / five years for Large
                                                        Industries from the date of starting first fixed capital investment
                                                    </p>
                                                    <p>
                                                        I shall repay the amount of exemption allowed with penal interest as decided by
                                                        the authority-</p>
                                                    <ol>
                                                        <li>If the information furnished is found to be false/ incorrect / misleading or misrepresented
                                                            and there has been suppression of facts / materials or allowed in excess of the
                                                            amount actually admissible for whatsoever reason. </li>
                                                        <li>If the industrial unit fails to commence production within three years for three
                                                            years for Micro. Small & Medium Enterprises / five years for Large Industries from
                                                            the date of starting first fixed capital investment. Copies of relevant documents
                                                            in support of information / facts furnished above are enclosed here with. </li>
                                                    </ol>
                                                    <p>
                                                        Enclosure:-</p>
                                                    <div class="col-sm-4 ">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body text-center">
                                                        <div class="form-group">
                                                            ...
                                                            <a class="btn btn-success" href="javascript:void(0)">OK</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <asp:Button ID="btnSave" runat="server" Text="Apply" class="btn btn-success" OnClientClick="return Validation();"
