                                ...
                                <div class="col-md-9 col-sm-12">
                                    <div class="applicationhistory">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-9 ">
                                                <h3>
                                                    Total Applications <span class="counter "><a id="TagTotalApp" runat="server" href="#"
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <div class="innermenulist">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <asp:LinkButton ID="LnkBtn_Stam_Duty_Exeption" runat="server" OnClick="LnkBtn_Stam_Duty_Exeption_Click" ToolTip="Click Here to Apply Stamp Duty Exemption  Certificate !!"
                                                   >Stamp Duty Exemption IPR-2022</asp:LinkButton>
                                            </li>
                                            <li>
                                                <asp:LinkButton ID="LnkBtn_Land_Industrial_Use" runat="server" OnClick="LnkBtn_Land_Industrial_Use_Click" ToolTip="Click Here to Apply Conversion Of Land For Industrial Use  Certificate !!"
                                                   >Conversion Of Land For Industrial Use IPR-2022</asp:LinkButton>
                                            </li>
                                             <li>
                                                <asp:LinkButton ID="LnkBtn_Migrated_Unit" runat="server" OnClick="LnkBtn_Migrated_Unit_Click"  ToolTip="Click Here to Apply Exercising Option by Migrated Industrial Unit  Certificate !!"
                                                   >Exercising Option by Migrated Industrial Unit IPR-2022</asp:LinkButton>
                                            </li>

                                            <li><a title="Priority Certificate">Apply For Incentive <b class="caret pull-right">
                                            </b></a>
                                                <ul class="dropdownlist">
                                                    <li>
                                            ...
                                            <li><a href="View_EC_Application_Status.aspx" title="Click Here to View EC Application Status !!">
                                                View EC Application Status</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    ...
                                                    <p>
                                                        ...
                                                        of Rs.100 crore for development of quality infrastructure</p>
                                                    <div class="show-table">
                                                        <h4>
                                                            <span>
                                    ...
                                    <div class="col-sm-4 ">
                                        <div class="details-section rightcolm">
                                            ...
                                            <p class="subhd">
                                                Incentive Eligibility &amp; Application Status</p>
                                            <ul class="list-item">
                                            ...
                                            <ul class="list-item">
                                                ...
                                                <li><a href="http://www.investodisha.org/apparel-policy" title="Apparel Policy" target="_blank">
                                                    Apparel Policy</a></li>
                                                ...
                                                <li><a href="http://investodisha.org/ICT-policy" title="ICT Policy, 2014" target="_blank">
                                                    ICT Policy, 2014</a></li>
