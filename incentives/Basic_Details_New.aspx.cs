...
public partial class incentives_Basic_Details_New : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (strInctId.Contains('~'))
        {
            ...
            strMode = ret[1].ToString(); ///// 1-ONLINE,2-OFFLINE
        }
        Hid_Inct_Mode.Value = strMode;

        /*----------------------------------------------------------------------*/
        ///// For Allow Enter Key in Address Field
        FilteredTxtExt_Industry_Address.ValidChars = FilteredTxtExt_Industry_Address.ValidChars + "\r\n";
        FilteredTxtExt_Regd_Office_Address.ValidChars = FilteredTxtExt_Regd_Office_Address.ValidChars + "\r\n";

        /*----------------------------------------------------------------------*/
        ///// Make All date fields as Readonly
        ...
        if (!IsPostBack)
        {
            ...
            /*------------------------------------------------*/
            //// In case of Incentive Apply check either PEAL or PC exist
            //// In case of Provisional Priority(10100102),Priority(10100119) and Pioneer(10100103) No need to check PEAL or PC (Take data from Registration if PEAL or PC does not exist)
            ///In case of Provisional Thrust or Priority(11400101)
            /*------------------------------------------------*/
            bool b_Is_Inct_Valid = false;
            bool b_Is_EC_Valid = false;
            if (strInctId == "INCENTIVE")
            {
                b_Is_EC_Valid = validateEC();
                // b_Is_Inct_Valid = validateInctApply();
                b_Is_Inct_Valid = true;
                BtnApply.Text = "Save and Proceed";
            }
            else if (strInctId == "10100102" || strInctId == "10100119" || strInctId == "10100103" || strInctId == "11400101")
            {
                b_Is_EC_Valid = true;
                b_Is_Inct_Valid = true;
                BtnApply.Text = "Next";
            ...
            if (b_Is_Inct_Valid == true && b_Is_EC_Valid == true)
            {
                fillUnitMeasurment();
        ...
        //// Call Enable Disable Function On Each Postback
    ...
    private bool validateInctApply()
    {
        ...
        try
        {
            ...
            string strReturnValue = ObjIMB.Validate_Inct_Apply(objEntity);
            if (strReturnValue == "B")
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "OnClick", "<script>alertredirect('" + message + "');</script>", false);//// for making date field disable   
                b_returnValue = false;
            }
        }
        catch (Exception ex)
    ...
    //// Fill Pre-Populated Data on Page Load
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (strDataSource == "BASIC")
                {
                    ...
                    if (File.Exists(Server.MapPath(strFilePath + Hid_Org_Doc_File_Name.Value)))
                    {
                    ...
                    {
                        Hyp_View_Org_Doc.Visible = false;
                        LnkBtn_Delete_Org_Doc.Visible = false;
                        FU_Org_Doc.Enabled = true;
                        Hid_Org_Doc_File_Name.Value = "";
                    }
                    ...
                    string strUnitType = ds.Tables[1].Rows[0]["intUnitType"].ToString();
                    DrpDwn_Unit_Type.SelectedValue = strUnitType;

                    if (strUnitType == "61" || strUnitType == "62" || strUnitType == "63")
                    {
                        ...
                        if (Hid_Unit_Type_Doc_Code.Value != "")
                        {
                            ...
                            if (File.Exists(Server.MapPath(strFilePath + Hid_Unit_Type_File_Name.Value)))
                            {
                            ...
                            {
                                Hyp_View_Unit_Type_Doc.Visible = false;
                                LnkBtn_Delete_Unit_Type_Doc.Visible = false;
                                FU_Unit_Type.Enabled = true;
                                Hid_Unit_Type_File_Name.Value = "";
                            }
                        }
                        ...
                        {
                            Hid_Unit_Type_Doc_Code.Value = dtUnitType.Rows[0]["vchDocumentType"].ToString();
                    ...
                    string strEINdate = Convert.ToString(ds.Tables[1].Rows[0]["dtmEIN"]);
                    if (strEINdate != "")
                    {
                    ...
                    if (strPcStatus == "Y")
                    {
                        ...
                        if (strIsExistBefore == "Y")
                        {
                            ...
                            Lbl_Text_PC_No.Text = "- E/M/D";
                            Lbl_Text_Prod_Comm.Text = "- E/M/D";
                            Lbl_Text_PC_Issue_Date.Text = "- E/M/D";
                    ...
                    if (Rad_Is_Priority.SelectedValue == "1")
                    {
                        ...
                        if (Hid_Pioneer_Doc_File_Name.Value != "")
                        {
                            ...
                            if (File.Exists(Server.MapPath(strFilePath + Hid_Pioneer_Doc_File_Name.Value)))
                            {
                            ...
                            else
                            {
                                ...
                                Hid_Pioneer_Doc_File_Name.Value = "";
                            }
                        }
                        else
                        {
                    ...
                    if (Rad_Is_Ancillary.SelectedValue == "1")
                    {
                        ...
                        if (File.Exists(Server.MapPath(strFilePath + Hid_Ancillary_Doc_File_Name.Value)))
                        {
                        ...
                        {
                            Hyp_View_Ancillary_Doc.Visible = false;
                            LnkBtn_Delete_Ancillary_Doc.Visible = false;
                            FU_Ancillary_Doc.Enabled = true;
                            Hid_Ancillary_Doc_File_Name.Value = "";
                        }
                    }
                    else
                    {
                    ...
                    if (strIsExistBefore == "Y")
                    {
                        ...
                        Lbl_Header_Prod_Emp.Text = "E/M/D";
                        ...
                        if (ds.Tables[2].Rows[0]["vchEmpDocBefore"].ToString() != "")
                        {
                            ...
                            if (File.Exists(Server.MapPath(strFilePath + Hid_Direct_Emp_Before_File_Name.Value)))
                            {
                            ...
                            else
                            {
                                ...
                                Hid_Direct_Emp_Before_File_Name.Value = "";
                            }
                        }
                        else
                        {
                    ...
                    if (ds.Tables[2].Rows[0]["vchEmpDocAfter"].ToString() != "")
                    {
                        ...
                        if (File.Exists(Server.MapPath(strFilePath + Hid_Direct_Emp_After_File_Name.Value)))
                        {
                        ...
                        else
                        {
                            ...
                            Hid_Direct_Emp_After_File_Name.Value = "";
                        }
                    }
                    else
                    {
                    ...
                    if (strIsExistBefore == "Y")
                    {
                        ...
                        Lbl_Header_Investment.Text = "E/M/D";
                        ...
                        {
                            if (File.Exists(Server.MapPath(strFilePath + Hid_FFCI_Before_File_Name.Value)))
                            {
                            ...
                            {
                                Hyp_View_FFCI_Before_Doc.Visible = false;
                                LnkBtn_Delete_FFCI_Before_Doc.Visible = false;
                                FU_FFCI_Before.Enabled = true;
                                Hid_FFCI_Before_File_Name.Value = "";
                            }
                        }
                        else
                        {
                        ...
                        {
                            if (File.Exists(Server.MapPath(strFilePath + Hid_Approved_DPR_Before_File_Name.Value)))
                            {
                            ...
                            {
                                Hyp_View_Approved_DPR_Before_Doc.Visible = false;
                                LnkBtn_Delete_Approved_DPR_Before_Doc.Visible = false;
                                FU_Approved_DPR_Before.Enabled = true;
                                Hid_Approved_DPR_Before_File_Name.Value = "";
                            }
                        }
                        else
                        {
                    ...
                    if (File.Exists(Server.MapPath(strFilePath + Hid_FFCI_After_File_Name.Value)))
                    {
                    ...
                    {
                        Hyp_View_FFCI_After_Doc.Visible = false;
                        LnkBtn_Delete_FFCI_After_Doc.Visible = false;
                        FU_FFCI_After.Enabled = true;
                        Hid_FFCI_After_File_Name.Value = "";
                    }
                    ...
                    if (File.Exists(Server.MapPath(strFilePath + Hid_Approved_DPR_After_File_Name.Value)))
                    {
                    ...
                    {
                        Hyp_View_Approved_DPR_After_Doc.Visible = false;
                        LnkBtn_Delete_Approved_DPR_After_Doc.Visible = false;
                        FU_Approved_DPR_After.Enabled = true;
                        Hid_Approved_DPR_After_File_Name.Value = "";
                    }
                    ...
                    if (ds.Tables[4].Rows[0]["vchTermLoanDoc"].ToString() != "")
                    {
                        ...
                        if (File.Exists(Server.MapPath(strFilePath + Hid_Term_Loan_File_Name.Value)))
                        {
                ...
                else if (strDataSource == "PC")
                {
                    ...
                    if (strIsExistBefore == "Y")
                    {
                        ...
                        DrpDwn_Gender_Partner.SelectedValue = ds.Tables[1].Rows[0]["intSalutation"].ToString();
                    ...
                    if (strIsExistAfter == "Y")
                    {
                        ...
                        DrpDwn_Gender_Partner.SelectedValue = ds.Tables[intFirstTable].Rows[0]["intSalutation"].ToString();
                        ...
                        string strOrgTypeDoc = ds.Tables[intFirstTable].Rows[0]["vchFileOwnerTypeDocument"].ToString();
                        if (strOrgTypeDoc != "")
                        {
                            DataSet dsOrg = (DataSet)ViewState["dynamic_name_doc"];
                            dsOrg.Tables[0].DefaultView.RowFilter = "slno = '" + DrpDwn_Org_Type.SelectedValue + "'";
                            ...
                            if (File.Exists(Server.MapPath(@"~/incentives/Files/Industry/" + strOrgTypeDoc)))
                            {
                                ...
                                Hyp_View_Org_Doc.NavigateUrl = strFilePath + strOrgTypeDoc;
                                Hid_Org_Doc_File_Name.Value = strOrgTypeDoc;
                                Hyp_View_Org_Doc.Visible = true;
                                LnkBtn_Delete_Org_Doc.Visible = true;
                                FU_Org_Doc.Enabled = false;
                            }
    ...
    private bool validateEC()
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    b_returnValue = false;
                    strMsg = @"<strong>You will be able to apply after your application for condonation of delay has been approved by the Empowered Committee !!</strong>";
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "OnClick", "<script>alertredirect('" + strMsg + "');</script>", false);
                }
                //else if (strStatus == "3")
                //{
                //    b_returnValue = false;
                //    strMsg = @"<strong>Your application has been rejected by the Empowered Committee. Hence, you cannot proceed to apply for incentives. In case of any clarifications contact your concerned DIC !!</strong>";
                //    ScriptManager.RegisterStartupScript(this, this.GetType(), "OnClick", "<script>alertredirect('" + strMsg + "');</script>", false);
                //}               
            }
        }
    ...
    protected void BtnApply_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string strValidUnitCat = IncentiveCommonFunctions.GetUnitCategory(Rad_Nature_Of_Activity.SelectedValue, Txt_Plant_Mach_After.Text == "" ? 0 : Convert.ToDecimal(Txt_Plant_Mach_After.Text));
            ...
            else
            {
                ...
                {
                    Response.Redirect("PostGrantprioritysectorsstatus.aspx?IncentiveNo=" + strInctId + "~" + Hid_Inct_Mode.Value + "", false);
                }
    ...
    protected void Btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (ChkBx_Agree.Checked == true)
            {
                ...
                objEntity.intCreatedBy = Convert.ToInt32(Session["InvestorId"]);
                objEntity.strAction = "C";

                ds = objBAL.Inct_EC_Delay_Reason_VIEW(objEntity);
                if (ds.Tables[0].Rows.Count > 0)
                {
                    string strOutputStatus = ds.Tables[0].Rows[0]["OUTPUT_STATUS"].ToString();

                    if (strOutputStatus == "1") ///// Eligible For Apply
                    {
                        Response.Redirect("appliedlistwithdetails.aspx", false);
                    }
                    else if (strOutputStatus == "2") //// Late
                    {
                        if (DrpDwn_Unit_Cat.SelectedValue == "36" || DrpDwn_Unit_Cat.SelectedValue == "37" || DrpDwn_Unit_Cat.SelectedValue == "38")
                        {
                            Lbl_Dynamic_No.Text = "3";
                        }
                        else if (DrpDwn_Unit_Cat.SelectedValue == "39")
                        {
                            Lbl_Dynamic_No.Text = "5";
                        }

                        ModalPopupExtender2.Show();
                        //Response.Redirect("IncentiveLateReason.aspx", false);
                    }
                    else if (strOutputStatus == "3") //// Late Reason Provided and Application Pending
                    {
        ...
        try
        {
            if (DrpDwn_Unit_After.SelectedIndex > 0)
            {
                if (DrpDwn_Unit_After.SelectedValue == "52")
                {
                    ...
                    Txt_Other_Unit_After.Focus();
                }
                else
                {
                    Txt_Other_Unit_After.Text = "";
                    Txt_Other_Unit_After.Visible = false;
                    Txt_Value_After.Focus();
                }
            }
            else
            {
