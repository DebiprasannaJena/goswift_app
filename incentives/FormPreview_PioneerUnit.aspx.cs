...
public partial class incentives_FormPreview_PioneerUnit : SessionCheck
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillFormDetails();
            lblcurdt.Text = DateTime.Now.Date.ToString("dd-MMM-yyyy");
    ...
    public void FillFormDetails()
    {
        try
        {
            ...
            DataTable dtMainTable = dslive.Tables[3];
            ...
            DataTable dtdynamic = dslive.Tables[4];
    ...
    public void FillAdditionalDoc(DataTable dtAdditionalDoc, DataTable dtAdditionalDocDtl)
    {
        if (dtAdditionalDoc.Rows.Count > 0)
        {
            ...
            {
                HyperLink1.NavigateUrl = "../incentives/Files/AdditionalDocument/" + dtAdditionalDoc.Rows[0]["VCHSTATUTORYCLEARANCE"].ToString();
            }
    ...
    private void SMSEMailContent()
    {
        try
        {
            ...
            string strBody = lblTitleH.Text + " of M/s " + lblMr.Text + " has been submitted successfully. " + PreviewURL;
