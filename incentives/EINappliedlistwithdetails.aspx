<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EINappliedlistwithdetails.aspx.cs"
...
<head runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.incentiveslist tr td a').addClass('not-active');
            ...
            $('.verify').click(function () {
                ...
                if (pcno == "12345") {
                    ...
                    $('#myModal6').modal('show');
                    $('.incentiveslist tr td a').removeClass('not-active');
                }
                else {
                    $('#myModal7').modal('show');
                    $('.incentiveslist tr td a').addClass('not-active');
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="details-section">
                                                        <p class="text-red">
                                                            <strong>You may apply for pre-production incentives & post production incentives.But
                                                                application would only processed after you have obtained your EIN/IEM and Production
                                                                Certificate respectively.</strong></p>
                                                        <div class="form-group">
                                                            <label class="col-sm-3">
                                                                Provide application no. for EIN/IEM</label>
                                                            <div class="col-sm-3">
                                                        ...
                                                        <table class="table table-bordered incentiveslist">
                                                            <tr>
                                                                <th>
                                                                    Incentive
                                                                </th>
                                                           ...
                                                           <%-- <tr>
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td>
                                                                    <a href="HealthCarePromotionPolicy.aspx">Apply</a>
                                                                </td>
                                                            </tr>
                                                              <tr>
                                                                <td>
        ...
        <div class="modal-dialog modal-sm">
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    <div class="form-group">
                        <label>
                            Your EIN/IEM No. was verified . You can Proced.</label>
                        <button type="button" class="btn btn-primary" data-dismiss="modal">
                            Close</button>
                    </div>
                </div>
