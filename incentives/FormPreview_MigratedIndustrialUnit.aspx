<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormPreview_MigratedIndustrialUnit.aspx.cs" Inherits="incentives_FormPreview_MigratedIndustrialUnit" %>
                            ...
                            <div class="form-body">
                                <div class="incentivepreiview">
                                    ...
                                    <div class="prieviewdatasec">
                                        ...
                                        <h4>
                                            Sub: - Exercising option by "Migrated Industrial Unit" to be treated as New Industrial Unit under Odisha Industrial policy Resolution-2022.
                                        </h4>
                                        <h4>
                                            Sir,</h4>
                                        <div class="padding-left-20">
                                            <p>
                                                In accordance with the provisions laid down for Migrated Industrial Unit in Odisha Industrial Policy Resolution-2022 and operational guidelines,option is here by submitted to be treated as New Industrial Unit under Odisha Industrial policy Resolution-2022.
                                            </p>
                                        </div>
                                    </div>
                                                 ...
                                                 <div class="form-group">
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label for="Iname" class="col-sm-4">
                                                               7. EIN/ PC/ IEM/PEAL approval letter No.</label>
                                                            <div class="col-sm-6">
                                                                <span class="colon">:</span>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-4 ">
                                                              13. Details of incentive availed,if any under earlier IPRs
                                                            </label>
                                                            <div class="col-sm-4">
                                                                <span class="colon">:</span>
                                                                <asp:Label ID="lbl_Incentive_Avail" runat="server" CssClass="form-control-static"></asp:Label>
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="form-group row">
                                                            <label class="col-sm-4 ">
                                                             14.Present implementation status
                                                            </label>
                                                            <div class="col-sm-4">
                                                                <span class="colon">:</span>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <span class="colon">:</span>
                                                                <asp:Label ID="lbl_Project_Needs" runat="server" CssClass="form-control-static"></asp:Label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                          ...
                                                          Clearance from pollution control board
                                                            ...
                                                            <div class="col-sm-4">
                                                                <span class="colon">:</span>
                                                                <asp:Label ID="lbl_Clearance_PCB" runat="server" CssClass="form-control-static"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
