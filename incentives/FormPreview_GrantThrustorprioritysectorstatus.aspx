                                        ...
                                        <div class="incentivepreiview">
                                            ...
                                            <div class="prieviewdatasec">
                                                ...
                                                <div class="padding-left-20">
                                                    <p>
                                                        M/s :<asp:Label ID="lblMr" runat="server"></asp:Label>
                                                    </p>
                                                    <p>
                                                        At/PO :<asp:Label ID="lblAddress" runat="server"></asp:Label>
                                                    </p>
                                                    <p>
                                                        Dist.(Location / proposed location of the Industrial Unit) :<asp:Label ID="Label5" runat="server"></asp:Label>
                                                    </p>
                                                </div>
                                                <h4>To</h4>
                                                ...
                                                <h4>Sub: - Application for Grant of (Provisional / Post production)Thrust / Priority Sector status under Industrial
                                                                ...
                                                                <ContentTemplate>
                                                                    <div class="panel-body">
                                                                        <p class="text-red text-right">
                                                                            All Amounts Entered in INR(In Lakhs)
                                                                        </p>
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div id="IndustryDetails123" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                                                            <div class="panel-body">
                                                                                ...
                                                                                <table class="table table-bordered">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th>As per DPR (INR Lakhs)
                                                                                            </th>
                                                                                            <th>Actual expenditure incurred(till date)(Lakhs)
                                                                                            </th>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>1
                                                                                            </td>
                                                                                            <td>Land and Development
                                                                                            </td>
                                                                                            <td class="text-right">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>Building and Civil construction 
                                                                                            </td>
                                                                                            <td class="text-right">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>Electrification and electrical installation
                                                                                            </td>
                                                                                            <td class="text-right">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <label style="color: black;">
                                                                                                    Other fixea assests of permanent nature
                                                                                                </label>
                                                                                            </td>
                                                                                            <td class="text-right">
                                                                ...
                                                                <h4 class="h4-header">Means Of Finance
                                                                </h4>
