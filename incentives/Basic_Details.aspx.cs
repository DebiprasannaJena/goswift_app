//******************************************************************************************************************
// File Name             :   Basic_Details.aspx.cs
...
public partial class incentives_Basic_Details : SessionCheck
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else if (strInctId == "10100102" || strInctId == "10100119" || strInctId == "10100103")
            {
                b_Is_EC_Valid = true;
                b_Is_Inct_Valid = true;
                BtnApply.Text = "Next";
