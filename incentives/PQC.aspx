<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PQC.aspx.cs" Inherits="incentives_PQC100" %>
                            ...
                            <div class="form-body">
                                <div class="incentivepreiview">
                                    ...
                                    <div class="prieviewdatasec">
                                        ...
                                        <div class="padding-left-20">
                                            <p>
                                                Sanction of assistance for quality certification under provisions of Industrial
                                        ...
                                        <div class="padding-left-20">
                                            <p>
                                                ...
                                                and operational guidelines, the claim for assistance for quality certification is
                                                submitted herewith with following particulars.
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="panel-group  padding-20" id="accordion" role="tablist" aria-multiselectable="true">
                                                                        ...
                                                                        <table class="table table-bordered">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label runat="server" ID="Label7" Text="Building"></asp:Label>
                                                                                    </td>
                                                                                    <td class="text-right">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label runat="server" ID="Label8" Text="Plant & Machinery"></asp:Label>
                                                                                    </td>
                                                                                    <td class="text-right">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label runat="server" ID="Label9" Text="Other Fixed Assets"></asp:Label>
                                                                                    </td>
                                                                                    <td class="text-right">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="Div7">
                                                    <h4 class="panel-title">
                                                        <a>Quality Certification Details </a>
                                                    </h4>
                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12 ">
                                                                    <asp:GridView ID="gvdQuality" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false"
                                                                        OnRowDataBound="gvdQuality_RowDataBound">
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Slno.">
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Product/Activity Name" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblstrProductName" runat="server" Text='<%# Eval("strProductName") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Name & address of the Registration Authority" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblstrNameaddressofRA" runat="server" Text='<%# Eval("strNameaddressofRA") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle Width="10%"></ItemStyle>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Certificate No" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblstrCertificateNo" runat="server" Text='<%# Eval("strCertificateNo") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle Width="8%"></ItemStyle>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Certificate Date" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbldtmCertificateDate" runat="server" Text='<%# Eval("dtmCertificateDate") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle Width="12%"></ItemStyle>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Certificate Attachment" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Renewal No" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblintRenewalSlno" runat="server" Text='<%# Eval("intRenewalSlno") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle Width="8%"></ItemStyle>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Renewal Date" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbldtmRenewalDate" runat="server" Text='<%# Eval("dtmRenewalDate") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle Width="12%"></ItemStyle>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Renewal Attachment" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <div class="input-group">
                                                                                        <asp:HyperLink ID="lblstrRenewalDateDOC" runat="server" Target="_blank" CssClass="input-group-addon bg-blue"
                                                                                            ToolTip="Click Here to View Document !!" NavigateUrl='<%# "~/incentives/Files/QualityCertificate/"  +  Eval("strRenewalDateDOC") %>'><i class="fa fa-download"></i></asp:HyperLink>
                                                                                        <asp:HiddenField ID="Hid_Renewal_Doc_File_Name" runat="server" Value='<%# Eval("strRenewalDateDOC") %>' />
                                                                                    </div>
                                                                                </ItemTemplate>
                                                                                <ItemStyle Width="8%"></ItemStyle>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Amount of Expenditure Incurred" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblstrAmountofExpenditure" runat="server" Text='<%# Eval("strAmountofExpenditure") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <ItemStyle Width="8%"></ItemStyle>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="Expenditure Attachment" HeaderStyle-HorizontalAlign="Left">
                                                                                <ItemTemplate>
                                                                                    <div class="input-group">
                                                                                        <asp:HyperLink ID="lblstrExpenditureDetails" runat="server" Target="_blank" CssClass="input-group-addon bg-blue"
                                                                                            ToolTip="Click Here to View Document !!" NavigateUrl='<%# "~/incentives/Files/QualityCertificate/"  +  Eval("strExpenditureDetails") %>'><i class="fa fa-download"></i></asp:HyperLink>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body ss">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr id="authorise" runat="server">
                                                            <td>
                                                                Authorizing letter signed by Authorized Signatory
                                                                <asp:Label ID="Lbl_Org_Doc_Type" runat="server" Style="display: none"></asp:Label>
                                                            </td>
                                                            <td>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="preiviewfooter padding-20">
                                                    ...
                                                    <p>
                                                        ...
                                                        of Odisha Industrial Policy Resolution-2015 and its operational guidelines.</p>
                                                    <p>
                                                    ...
                                                    <ol>
                                                        ...
                                                        <li>lf the Quality Certificate is revoked by the authority within five years of obtaining
                                                            such certificate for any reason. </li>
                                                    </ol>
                                                    <p>
                                                        ...
                                                        Govt. or any financial institutions / Support organization in the country and abroad
                                                        against which the present claim is made.
                                                    </p>
                                                    <div class="col-sm-4 ">
                                                    </div>
                                                    <div class="col-sm-2 ">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <img id="PreviewImage" src="" alt="" style="width: 144px; height: 70px;" runat="server" />
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row" id="divUpload">
                                                                <label class="col-sm-2">
                                                                    Upload</label>
                                                                <div class="col-sm-8">
                                                                    <asp:FileUpload CssClass="form-control" ID="fileSignature" runat="server" onchange="readURL(this);" />
                                                        ...
                                                        in full and behalf of <b>M/s :
                                                            <asp:Label ID="lblUnitAddr" runat="server"></asp:Label></b>
                                                        <br />
                                                        Date: <b>
                            ...
                            <div class="form-footer">
                                <div class="row">
                                    <div class="col-sm-12 text-right">
                                        ...
                                        <asp:Button ID="btnSave" runat="server" Text="Apply" CssClass="btn btn-success" OnClick="btnFinalSave_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
