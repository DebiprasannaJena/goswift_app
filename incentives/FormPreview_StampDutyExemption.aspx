                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <label for="Iname" class="col-sm-4">
                                                                        EIN/ PC/ IEM/PEAL approval letter & Production Certificate / IL Date
                                                                    </label>
                                                                    <div class="col-sm-6">
                                                                        <span class="colon">:</span>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <label for="Iname" class="col-sm-4">
                                                                        Amount of Stamp Duty Exemption availed under any scheme of State Govt / Central Govt (Gol) / Govt. Agencies / Financial institutions
                                                                    </label>
                                                                    <div class="col-sm-6">
                                                                        <span class="colon">:</span>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <label for="Iname" class="col-sm-4">
                                                                        Amount of deferential claim to be exempted
                                                                    </label>
                                                                    <div class="col-sm-6">
                                                                        <span class="colon">:</span>
