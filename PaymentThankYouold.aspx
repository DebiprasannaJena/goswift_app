<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentThankYouold.aspx.cs"
    Inherits="PaymentThankYouold" %>
                                    ...
                                    <div class="payment-sec">
                                        <div>
                                            <div class="col-sm-6 col-sm-offset-3">
                                                ...
                                                <h3>
                                                    <asp:Label ID="lblReference" runat="server"></asp:Label></h3>
