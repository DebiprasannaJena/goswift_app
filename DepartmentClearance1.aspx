<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepartmentClearance1.aspx.cs"
    Inherits="DepartmentClearance1" %>
                    ...
                    <div id="exTab1">
                        ...
                        <div class="form-sec">
                            <div class="form-header">
                                <a href="ApplicationDetails1.aspx" title="Application Details" class="pull-right proposalbtn ">Application Details</a> <a href="DepartmentClearance1.aspx" title="Drafted Proposals"
                                    class="pull-right proposalbtn  active ">Apply Service</a> <a href="DraftedServices1.aspx"
                                        title="Drafted Services" class="pull-right proposalbtn  ">Draft Services</a>
                                <h2>Apply Service
                                </h2>
                            </div>
