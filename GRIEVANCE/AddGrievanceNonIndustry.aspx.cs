...
public partial class GRIEVANCE_AddGrievanceNonIndustry : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AddGrievanceNonIndustry.aspx");
    }
        ...
        try
        {
            ...
            else
            {
                ...
                if (arrResult[0] == "1")
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "OnClick", "<script> jAlert('<strong>Data Saved Successfully !', '" + Messages.TitleOfProject + "', function () {location.href = '../GrievanceNonIndustry.aspx';}); </script>", false);
                    return;
                }
                else
                {
