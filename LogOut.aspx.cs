    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["LogId"] != null)
        {
            if (Session["LogId"].ToString() != "NA")
            {
                ...
                string ExistLog = validate.CheckLog("U", validate.URLEncryption(ConfigurationManager.AppSettings["DWHEncryptionKey"]), Convert.ToInt32(Session["LogId"]));
            }
        }
        ...
        //            String ExistLog = validate.CheckLog("U", validate.URLEncryption(ConfigurationManager.AppSettings["SSOKey"]), Convert.ToInt32(Session["LogId"]));
        //        }
        //        catch (Exception ex)
        //        {
