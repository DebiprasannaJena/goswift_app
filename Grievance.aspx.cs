...
public partial class Grievance : System.Web.UI.Page
{
    ...
    protected void GrdGrivDetails_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            hprlnkgrievance.NavigateUrl = "~/Grievance/GrievanceDetails.aspx?StrGrievanceNo=" + GrdGrivDetails.DataKeys[e.Row.RowIndex].Values["vchGrivId"];
    ...
    {
        Response.Redirect("~/Grievance/AddGrievance.aspx");
    }
}
