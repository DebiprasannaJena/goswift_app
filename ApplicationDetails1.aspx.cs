    ...
    protected void gvApplicationDetails_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    if (Status == "2" && svcid1 != "5" && svcid1 != "6" && svcid1 != "7" && svcid1 != "34" && svcid1 != "35" && svcid1 != "36" && svcid1 != "39" && svcid1 != "40" && svcid1 != "70" && svcid1 != "71" && svcid1 != "72" && svcid1 != "20" && svcid1 != "29" && svcid1 != "62" && svcid1 != "63" && svcid1 != "67" && svcid1 != "68" && svcid1 != "69" && svcid1 != "73")
                    {
                    ...
                    else if ((svcid1 == "5" || svcid1 == "6" || svcid1 == "7" || svcid1 == "34" || svcid1 == "35" || svcid1 == "36" || svcid1 == "39" || svcid1 == "40" || svcid1 == "70" || svcid1 == "71" || svcid1 == "72") && (Status == "2" || Status == "3")) //F&B and Labour Service
                    {
                ...
                if (intenableEsign == 1)
                {
                    if (ESIGNSTATUS == "1")
                    {
                        btnPaymentStatus.NavigateUrl = "ServicePayment1.aspx?ApplicationKey=" + lblApplctionNo.Text.ToString() + "&Amount=" + lblpaymentAmount.Text.ToString() + "&AccountHd=yes&ServiceID=" + svcid1 + "&T=2";
                    }
                    else
                    {
                ...
                {
                    btnPaymentStatus.NavigateUrl = "ServicePayment1.aspx?ApplicationKey=" + lblApplctionNo.Text.ToString() + "&Amount=" + lblpaymentAmount.Text.ToString() + "&AccountHd=yes&ServiceID=" + svcid1 + "&T=2" + "&AppFee=" + Convert.ToString(Hid_App_Fee.Value) + "";
                }
                ...
                if (Convert.ToInt32(lblpaymentStatus.Text) == 0 && Convert.ToDecimal(lblpaymentAmount.Text) > Convert.ToDecimal(0.0))
                {
                    ...
                    if (INT_Chkstatus == 1)
                    {
                        ...
                        else if (svcid1 == "5" || svcid1 == "6" || svcid1 == "7" || svcid1 == "34" || svcid1 == "35" || svcid1 == "36" || svcid1 == "39" || svcid1 == "40" || svcid1 == "70" || svcid1 == "71" || svcid1 == "72") //F&B and Labour Service
                        {
                            CultureInfo culture = new CultureInfo("es-ES");
                            if (DateTime.Parse(lblSubmitedOn.Text, culture).Date > DateTime.Parse("15/01/2021", culture).Date)
                            {
