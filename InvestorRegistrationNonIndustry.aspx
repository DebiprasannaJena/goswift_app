<%--'*******************************************************************************************************************
' File Name         : InvestorRegistrationNonIndustry.aspx
' Description       : Registration of Investor
' Created by        : Anil sahoo
...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvestorRegistrationNonIndustry.aspx.cs" Inherits="InvestorRegistrationNonIndustry" %>
                ...
                <div id="exTab1" class="">
                    ...
                    <div class="wizard">
                        ...
                        <h2 class="pageTittle">
                            ...
                            &nbsp;Non-Industrial User Registration <span class="mandatoryspan pull-right">( * ) Marked fields are mandatory</span></h2>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <asp:TextBox ID="Txt_First_Name" autocomplete="off" CssClass="form-control" runat="server"
                                                                        placeholder="Full name of the applicant" MaxLength="50" ToolTip="Enter full name of the applicant here."></asp:TextBox>
                                                                    <span class="mandetory">*</span>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 col-md-4">
                                                            ...
                                                            <asp:TextBox ID="Txt_Email_Id" autocomplete="off" CssClass="form-control height95"
                                                                MaxLength="250" runat="server" ToolTip="Enter the applicant's email id here."></asp:TextBox><span class="mandetory"> *</span>
                                            ...
                                            <div class="formbodycontent">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <label for="Block" class="col-sm-3 col-md-2 margin-top10">
                                                            Block
                                                        </label>
