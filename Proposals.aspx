...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".clstest").click(function (e) {
                debugger;

                var id = $(this).closest("td").find('.clsService').val();
                var Tid = $(this).closest("td").find('.clsServiceType').val();
        ...
        function validate(obj) {
            ...
            if ($('#gvProposal_FileUpload1_' + arr[2]).val() != "") {
                if (!DocValid('#gvProposal_FileUpload1_' + arr[2])) { return false; }
            }
                    ...
                    $.each(r.d, function () {
                        ...
                        if (r.d.length == 1) {
                            ...
                            if (r.d[1]['strFileName'] != "") {
                                ...
                                if (strarr[0] == "" && strarr[1] == "" && strarr[2] == "") { document.getElementById('divViewFiles1').style = "display:none"; }
                            }
                            else {
                            ...
                            <div class="tab-pane active" id="1a">
                                <div class="form-sec">
                                    <div class="form-header">
                                        <a href="DraftedProposals.aspx" title="Draft Proposals" class="pull-right proposalbtn active">Draft Proposals</a> <a href="ProposalInstruction.aspx" title="Create Proposal (PEAL)"
                                                ...
                                                <asp:GridView ID="gvProposal" runat="server" CssClass="table table-bordered bg-white"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Query" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:HiddenField ID="hdnTextVal" runat="server" Value='<%# Eval("strProposalNo")%>'></asp:HiddenField>
                                                                        ...
                                                                        <div class="modal-content modal-primary ">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close" data-dismiss="modal">
                                                                                    &times;</button>
                                                                                <h4 class="modal-title">Proposal No.<asp:Label ID="lblProposalNo" runat="server" Text=""></asp:Label>
                                                                                    Query Details</h4>
                                                                            </div>
                                                        ...
                                                        <asp:TemplateField HeaderText="Make Payment" HeaderStyle-Width="70px">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HiddenField ID="hdnProposalNo11" runat="server" Value='<%# Eval("strProposalNo")%>'></asp:HiddenField>
                                                                <asp:HiddenField ID="hdnPaymentstatus" runat="server" Value='<%# Eval("intpaymentStatus")%>'></asp:HiddenField>
                                                                                ...
                                                                                <div class="old-querydetails">
                                                                                    <div class="form-group" id="div2">
                                                                                        ...
                                                                                        <p class="text-red text-center">
                                                                                            ...
                                                                                            click on 'Pay Now' button to proceed for Payment</small>
                                                                                        </p>
                                                                                        <div class="row">
                                                                                            <div class="col-sm-12 text-center">
                                                                                                <p>
                                                                                                    You are proceeding to pay
                                                                                                </p>
                                                                                                <h4>
                                                    ...
                                                    <div class="modal-dialog modal-md">
                                                        ...
                                                        <div class="modal-content modal-primary ">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal">
                                                                    &times;</button>
                                                                <h4 class="modal-title">Your Order No For this payment is<asp:Label ID="Label5" runat="server" Text=""></asp:Label>
                                                                    Query Details</h4>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-default" data-dismiss="modal">
