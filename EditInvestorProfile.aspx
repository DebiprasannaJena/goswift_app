                            ...
                            <div class="form-body">
                                <div class="col-sm-12 ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="colon">:</span>
                                            <asp:TextBox ID="Txt_CIN_No" autocomplete="off" CssClass="form-control height95"
                                                MaxLength="21" runat="server" Onkeypress="return inputLimiter(event,'NameCharactersAndNumbers')" ToolTip="Enter CIN number here."></asp:TextBox><span class="mandetory"> *</span>
