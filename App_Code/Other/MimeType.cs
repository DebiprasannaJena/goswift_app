...
public class MimeType
{
    ...
    public static string GetHTMLtext(string strValue)
    {
        string strVal = strValue;

        strVal = strVal.Replace("script", ""); //Regex.Replace(strValue, "<script.*?</script>", "", RegexOptions.Singleline | RegexOptions.IgnoreCase);
        //strVal = Regex.Replace(strValue, "<input.*?</input>", "", RegexOptions.Singleline | RegexOptions.IgnoreCase);
        //strVal = Regex.Replace(strValue, "<button.*?</button>", "", RegexOptions.Singleline | RegexOptions.IgnoreCase);
        strVal = strVal.Replace("<input", "");
        strVal = strVal.Replace("<button", "");
        return strVal;
    }
}